/**
 * bench/async_scheduler_io_read_multi_e2e.c — 双协程并行 read async + scheduler IO wake
 *
 ...
 *
 * 编译：cc -std=c11 -o async_scheduler_io_read_multi_e2e bench/async_scheduler_io_read_multi_e2e.c \
