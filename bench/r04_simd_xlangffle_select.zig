// r04_simd_xlangffle_select.zig — SIMD shuffle/select with @Vector (matches r04_simd_xlangffle_select.x)
// Mirror of r04_simd_shuffle_select for xlang shuffle intrinsic comparison.
