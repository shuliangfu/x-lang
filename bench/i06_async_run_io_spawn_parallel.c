/**
 * bench/i06_async_run_io_spawn_parallel.c — IO-A5 v5 spawn 并行 IO + drain_until_idle
 *
 ...
 *   bench/i06_async_run_io_spawn_parallel.c std/io/io.o std/async/scheduler.o
