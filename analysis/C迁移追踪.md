...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w291 C（w268=.x） | 含 wave291 elf_codegen_forwarders 域 C thin（Darwin L2＠11080392）。下一＝wave292 bootstrap_orchestration 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
