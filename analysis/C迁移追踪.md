...
| `pipeline_asm_emit_spill.c` | ~1962 | asm ELF 7.3 live／Chaitin Cap residual（wave156–177 pure 已抽） | 🟡 wave177 pure：INDEX structural key hash G.7 收敛；余 CAP／VAR／live_at_stmt／interf BSS + thin accessors 仍 host-cc |
