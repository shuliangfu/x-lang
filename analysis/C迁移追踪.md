...
✅ **asm 模块级 dest-SLICE const hoist** ✅ @ **`4e40dec2a`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；host-C 模块级 dest-SLICE ARRAY_LIT；非 main 读模块 const 数组；dest-SLICE 可变 COMMON LEA
