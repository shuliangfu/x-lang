...
| `pipeline_asm_emit_spill.c` | ~1616 | asm ELF 7.3 live／Chaitin Cap residual（wave156–177／207–211 pure 已抽） | 🟡 wave211 pure：try_reload enc；wave210 VAR cache BSS；wave207–209 CAP／stack_spill；余 live_fwd／color／interf BSS 仍 host-cc |
