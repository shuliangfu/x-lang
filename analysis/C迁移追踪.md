...
> **刷新**：2026-09-22 · 状态债 · Win PE egg ✅；B-hybrid ✅；Win L2 **3/5 rv＋hello＋f32** 🟡；opt＝mod.x asm 绿／PE o 可出／**main hang** 🟡；si T001 🟡 · tip `355d80764` · 钉盘 **`ecdb5cc1e`**
...
| Win PE egg pin | ✅ | egg＠`99b008cc1`；默认 asm **3/5**＠`355d80764`；opt＝STRUCT_LIT／PE o 路径 ✅、main hang 🟡；si T001 🟡；三端硬闸仍 🟡 |
...
- 🟡 **11.2.4** Windows／MSYS2 冷底座（g05＋crt0）✅；PE egg＋B-hybrid ✅；默认 asm **rv＋hello** ✅；Win L2 余 3／win32-write ⬜；三端硬闸 ⬜  
