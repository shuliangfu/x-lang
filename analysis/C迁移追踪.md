...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **427／1,956**（v5.19）  
...
2. 🟡 **7.2.1b** B-minus 续（427／1,956；v5.19 exact-ultra_hyper import/struct/try_skip／fn／library／trait-buf 已收；续＝max／apex／parse_into_hyper／simd from_at／peek_kind；**daily→close**）＋ **BC + 8.3**  
