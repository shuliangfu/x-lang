...
| `pipeline_asm_emit_spill.c` | ~2471 | asm ELF 7.3 live／Chaitin Cap residual（wave156–160 pure 已抽） | 🟡 wave160 pure：if/loop live-merge leave；余 binop VAR cache／break-note／Chaitin／index-scratch／apply_expr_effect 仍 host-cc |
