...
1. ✅ **post-delete residual**（wave944–955）— 0-make hub · gate post_ship · docs/help/hint · XXP/BXC catalog bags · XXP ensure ladder 0-make · leaf 机检 quiet · ensure_*_gen / cfg-eval xlang-c shell · run_compiler_tests ensure · regen_lsp_gens_x shell ensure · build_tool/build_via_tool --check post_ship · bootstrap_self catalog BS + --check post_ship（残：其它 thin-call `--check` NEED_POST_SHIP：xlang_x / relink / …）
