...
| `pipeline_asm_emit_spill.c` | ~2358 | asm ELF 7.3 live／Chaitin Cap residual（wave156–171 pure 已抽） | 🟡 wave171 pure：enc push/reload/pop + slot reload；余 minus_pair／subadd3 cache spill helpers 仍 host-cc |
