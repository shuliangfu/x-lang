...
| `pipeline_typeck_region_assign.c` | **~740** | typeck region/escape assign-site 切片（wave244：one_region＋call_struct pure leave + wave243 stamp_let＋read_ptr + wave242 scan tree + … → typeck.x；残 stack_local／ptr_for_addr／store-scan） | 🟡 已抽出；仍 host-cc 入 `pipeline_x` |
