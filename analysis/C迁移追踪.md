...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **519／1,956**（v5.24）  
...
2. 🟡 **7.2.1b** B-minus 续（519／1,956；v5.24 exact-zenith import/struct/try_skip／fn／library／body_skip／control_flow／expr／match／primary／trait-buf 已收；续＝pinnacle／versal／parse_into_hyper／simd from_at／peek_kind；**深链 close only**）＋ **BC + 8.3**  
