...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w276 C（w268=.x） | 含 wave276 value-ABI residual C thin（双端 L2 tip `7c296a0b3`）。下一＝wave277 block 域 Cap residual。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
