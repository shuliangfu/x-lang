...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w277 C（w268=.x） | 含 wave277 block 域 Cap residual C thin（双端 L2 tip `162c48f04`）。下一＝wave278 expr_sidecar 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
