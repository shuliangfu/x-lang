...
✅ **host-C 函数作用域 dest-SLICE 模块 VAR** ✅ @ **`ec28e1f0f`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；函数作用域 `const s:[]T=A`（typeck T001 另层）
