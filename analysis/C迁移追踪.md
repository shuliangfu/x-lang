...
✅ **dest-SLICE 可变 COMMON LEA** ✅ @ **`387d8425b`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；非 main 读模块 const 数组；host-C 函数作用域 dest-SLICE 模块 VAR
