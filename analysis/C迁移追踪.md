...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w287 C（w268=.x） | 含 wave287 parser_result 域 C thin（双端 L2 tip `af8756896`）。下一＝wave288 asm_label_format 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
