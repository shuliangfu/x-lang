...
✅ **host-C nest 18 fat（nest>17 soft 下一层）** ✅ @ **`fdcaec69f`**
  ...
  - 余（勿并本叶）：nest>18 soft（19–20 仍进 256；nest 21 须加宽 scratch）；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；sat 盖 prefer；ARM64 prologue 未存 x19
