...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **477／1,956**（v5.22）  
...
2. 🟡 **7.2.1b** B-minus 续（477／1,956；v5.22 exact-summit import/struct/try_skip／fn／library／body_skip／control_flow／expr／match／primary／trait-buf 已收；续＝peak／parse_into_hyper／simd from_at／peek_kind；**daily→close**）＋ **BC + 8.3**  
