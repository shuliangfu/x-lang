...
> **刷新**：2026-09-22 · 状态债 · Win PE egg ✅；B-hybrid ✅；Win L2 **3/5 rv＋hello＋f32** 🟡；opt ld U／无 PE option.o 🟡；si T001 🟡 · tip `cf467586e` · 钉盘 **`ecdb5cc1e`**
...
| Win PE egg pin | ✅ | egg＠`99b008cc1`；默认 asm **3/5**＠`cf467586e`（rv＋hello＋f32）；opt **ld U**／无 PE `option.o` 🟡；si T001 🟡；三端硬闸仍 🟡 |
