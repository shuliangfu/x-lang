...
> **刷新**：2026-09-22 · 状态债 · **三端 L2 硬闸已启用** ✅；BC present **0**；Class S Win FIELD **进 live** ✅ · 钉盘 **`ecdb5cc1e`**（不升）
...
| Win PE egg pin | ✅ | egg＠`99b008cc1`；默认 asm **5/5**；FIELD override **进 live**（Class S leftover-safe LEGACY g05）；INDEX／DEREF stub 仍开；**三端 L2 硬闸已启用** |
