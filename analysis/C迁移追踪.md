...
🟡 **11.3 residual · prereq 边吞并（wave744 · 非物理删）**
  ...
  - ✅ wave751：**R1 第四族 R1_MAIN_RUNTIME** — 同 body `main-runtime`/`all`；catalog
    ...
    `./xbuild frontend-glue`；其它 R1 residual

🟡 **11.3.1 路径 · 叶 pattern residual（wave746 库存 · wave747 R4 · wave748–750 R1 族 · 非物理删）**
  ...
  - ✅ R1 首族 RT_SEED_SLICE body（wave748）；✅ R1 第二族 CORE_SEED（wave749）；
    ✅ R1 第三族 FRONTEND_GLUE（wave750）；✅ R1 第四族 MAIN_RUNTIME（wave751）；⬜ 其它 R1 叶（extra-cflags / alias …）
