...
| `pipeline_abi` mega pure-asm | 🟡 …＋**w359 top_level_let** PREFER Darwin；**w358 type_alias** PREFER 双端；**w357b type_pool** Darwin PREFER／Ubuntu `-E`；残 class C peers／Ubuntu Type LE ABI | 下一＝class C peers／Ubuntu Type LE。禁盲翻；禁 Darwin mega `-E`（内存）。|
| nest 冻帽 | ✅ 纪律 | **64** |
