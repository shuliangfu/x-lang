...
| `pipeline_asm_emit_spill.c` | ~2130 | asm ELF 7.3 live／Chaitin Cap residual（wave156–175 pure 已抽） | 🟡 wave175 pure：mov/try/farthest/pick；余 CAP BSS + set_spill_slot／off_is_spill_pin／stack_enabled／live／CFG phi helpers 仍 host-cc |
