...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **178／1,956**  
  - [x] ABI＝B-minus（opaque＋lexer-step 桥；RFC §5）  
  - [x] 桥面／P9a／三契约／生成器 v1→v5.1／等价 harness  
...
2. 🟡 **7.2.1b** B-minus 续（178／1,956；厚 buf／trait_impl 二级 cursor；深链首批已收）＋ **BC + 8.3**  
