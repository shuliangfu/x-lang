...
🟡 **11.0.2 产品路径 0-make 验收**（wave714 静态 ✅ · wave715/716 class-G filtered ✅ · 运行时 PATH 探针 ⬜）
...
🟡 **11.0.3 冷启动路径减 make**（wave716–724 🟡）
  ...
  - ⬜ §5b #1/#2 check-abi / pipeline_x FORCE；#8 build-seed-asm-host 半 shell；#10 filtered 已 shell 经薄目标；对象清单变量定义本身迁出 Makefile / 由 xbuild 吞并（更深层；仍 G.7 单权威）
