...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w272 C（w268=.x） | 含 wave272 PipelineDepCtx 域 C thin（双端 L2 tip `21f1195f9`）。下一＝wave273 ELF/Mach-O ctx＋write_o 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
