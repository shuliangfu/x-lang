...
✅ **dest-SLICE return／assign INDEX** ✅ @ **`e681baf93`**
  ...
  - 余（已闭 const INDEX whitelist）：@ **`7a6035edb`**；另层：host-C dest-SLICE const INDEX wrap；nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off
...
✅ **const INDEX whitelist** ✅ @ **`7a6035edb`**
  ...
  - 余（勿并本叶）：host-C dest-SLICE const INDEX wrap（`-E` `s=(a)[1]` 无 fat BLD001）；nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off
