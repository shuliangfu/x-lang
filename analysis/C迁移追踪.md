...
| `pipeline_asm_emit_spill.c` | ~2001 | asm ELF 7.3 live／Chaitin Cap residual（wave156–176 pure 已抽） | 🟡 wave176 pure：linear reverse DF + gen/kill + next_use；余 CAP／VAR／live_at_stmt／interf BSS + thin accessors 仍 host-cc |
