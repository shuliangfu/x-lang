...
| `pipeline_glue_strict_minimal`（seed → 产品链） | ~2546（wave300） | 产品 weak 孪生 | 🟡 仍在链；**wave300**：删 28× dual-export WEAK typeck Cap（STRONG=typeck_x.o）；**8.3.6 退役策略未终**（残 strict_only WEAK／helpers／入口桥） |
