...
> **刷新**：2026-09-22 · 状态债 · Win PE egg ✅；B-hybrid ✅；Win L2 **3/5 rv＋hello＋f32** 🟡；opt＝建链 ✅／**run=-2 ABI** 🟡；si T001 🟡 · tip `6b719f4a2` · 钉盘 **`ecdb5cc1e`**
...
| Win PE egg pin | ✅ | egg＠`99b008cc1`；默认 asm **3/5**＠`6b719f4a2`；opt＝建链 ✅、run=-2 ABI 🟡；si T001 🟡；三端硬闸仍 🟡 |
