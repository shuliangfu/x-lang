...
| `pipeline_asm_emit_spill.c` | ~2453 | asm ELF 7.3 live／Chaitin Cap residual（wave156–162 pure 已抽） | 🟡 wave162 pure：break/continue ELF leave；余 binop VAR cache／note thin／Chaitin／index-scratch 仍 host-cc |
