...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **385／1,956**  
...
2. 🟡 **7.2.1b** B-minus 续（385／1,956；v5.15 exact-apex 分批 mega 已收／soft FP 已尽；续＝补 import·struct·try_skip 链／simd from_at／peek_kind）＋ **BC + 8.3**  
