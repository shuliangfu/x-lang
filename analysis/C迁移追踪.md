...
✅ **import 模块 const FIELD asm（dep-arena INT_LIT＋durable ARRAY_LIT）** ✅ @ **`ba5581e06`**
  ...
  - 余（勿并本叶）：pipeline_abi `nf>0` 闸（consts-only dep 不共编）；nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off
