...
> **2026-08-24 honesty**：tool-scaffold／lint／fmt／vscode＋lang-trait／abi／import 门 DOC→`analysis/archive/{tool,lang}/`＋活 `fmt.x`／`lsp_diag.h`／`typeck.x`／`parser.x`；tip **`75dde7a93`**；钉盘 **`e8176cbe5`** 不升（非 MG residual）。
