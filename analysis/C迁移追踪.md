...
> **刷新**：2026-09-16 · tip **`0782a1ff5`**（P6h one_function_buf header）· 钉盘 **`ecdb5cc1e`**
...
1. **最优真减 host-cc**：P6h one_function_buf header **已开**。下刀＝buf body／append_byte 仍 C；禁 dest-buffer parse_type_ref（P3f）；跳过 glue_tail；禁 FORCE pabi mega；禁升钉。  
