...
| `pipeline_asm_emit_spill.c` | ~2374 | asm ELF 7.3 live／Chaitin Cap residual（wave156–172 pure 已抽） | 🟡 wave172 pure：minus_pair／subadd3 cache spill helpers；余 CAP BSS + binop VAR cache／live thin 仍 host-cc |
