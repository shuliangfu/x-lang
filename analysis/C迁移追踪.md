...
| `pipeline_asm_emit_spill.c` | ~2339 | asm ELF 7.3 live／Chaitin Cap residual（wave156–174 pure 已抽） | 🟡 wave174 pure：spill_reg + evict_rax|rbx；余 CAP BSS + colored/pick/mov thin／Chaitin／live helpers 仍 host-cc |
