...
> **刷新**：2026-09-16 · blkpeel→`.x` thin · 钉盘 **`ecdb5cc1e`**
...
1. **主刀 M2**（[自举效率方法-M2主链.md](自举效率方法-M2主链.md)）：纯 asm／CG002。ttc＋blkpeel→`.x` thin。下刀＝assign；禁 Darwin mega `-E`；禁盲 FORCE mega；禁升钉。双端 L2＝mac push→Ubuntu pull。  
