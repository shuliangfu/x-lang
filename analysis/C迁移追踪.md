...
> **刷新**：2026-09-16 · prefer 默认 PREFER_ASM=1 Darwin L2 5/5 · 钉盘 **`ecdb5cc1e`** · **未提交**
...
| `pipeline_abi` mega pure-asm | 🟡 prefer 默认 asm | mega `.x` thin 10/10 纯 asm。prefer 默认 PREFER_ASM=1。Darwin L2 5/5。**未提交**。C-extract 另刀。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
...
1. **主刀 M2**（[自举效率方法-M2主链.md](自举效率方法-M2主链.md)）：纯 asm／CG002。prefer 默认 PREFER_ASM=1。Darwin L2 5/5。下刀＝点名提交后 Ubuntu pull＋prefer；C-extract 另刀；禁 Darwin mega `-E`；禁盲 FORCE mega；禁升钉。  
