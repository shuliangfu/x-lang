...
> **刷新**：2026-09-16 · tip **`dec63ef9d`**（P3m alloc_vector_type_ref 双端绿）· 钉盘 **`ecdb5cc1e`**
...
1. **最优真减 host-cc**：P3m alloc_vector_type_ref **已开**（符号 `parser_asm_alloc_vector_type_ref_x_into_c`；禁整块 `parse_type_ref_impl`）。P1g／P2d 已开。下刀＝**trait_check dest-SLICE 形状核**（禁当 extra；禁并 P12u）／anonymous-struct alloc／type_ref 其它单片。**跳过 glue_tail**。禁 P4b／pipeline mega／升钉／默 bstrict。pipeline_abi mega pure-asm 仍是已知地雷。  
