...
| `pipeline_asm_emit_spill.c` | ~2486 | asm ELF 7.3 live／Chaitin Cap residual（wave156–158 pure 已抽） | 🟡 wave158 pure：CFG merge/phi + def-offs collect leave；余 binop VAR cache／live／Chaitin／break／index-scratch 仍 host-cc |
