...
| `pipeline_asm_emit_spill.c` | ~2470 | asm ELF 7.3 live／Chaitin Cap residual（wave156–166 pure 已抽） | 🟡 wave166 pure：pressure-evict 三面 + thin；余 cfg interf／index-scratch／note 仍 host-cc |
