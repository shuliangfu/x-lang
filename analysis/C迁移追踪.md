...
| `pipeline_typeck_region_assign.c` | **~1347** | typeck region/escape assign-site 切片（wave239：call_slice pure leave + wave237 allocator + wave236 stack-escape／scope-borrow + wave235 M-3 assign／return → typeck.x；残 with_arena BSS／scan tree） | 🟡 已抽出；仍 host-cc 入 `pipeline_x` |
