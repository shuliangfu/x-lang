...
| `pipeline_typeck_region_assign.c` | **~286** | typeck region/escape assign-site 切片（wave245：ptr_for_addr＋stack_local pure leave + wave244 one_region＋call_struct + … → typeck.x；残 return_slice_in_scope＋thin faces） | 🟡 已抽出；仍 host-cc 入 `pipeline_x` |
