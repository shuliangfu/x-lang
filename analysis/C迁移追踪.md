...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w290 C（w268=.x） | 含 wave290 asm_codegen_mega_body 域 C thin（双端 L2 tip `ed1a883f5`）。下一＝wave291 elf_codegen_forwarders 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
