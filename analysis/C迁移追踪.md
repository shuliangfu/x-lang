...
| `pipeline_asm_emit_spill.c` | ~2547 | asm ELF 7.3 live／Chaitin Cap residual（wave156–167 pure 已抽） | 🟡 wave167 pure：cfg peak+color 两面 + thin；余 cfg simulate walk／index-scratch 仍 host-cc |
