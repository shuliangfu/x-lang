...
✅ **host-C nest 20 fat（nest>19 soft 下一层）** ✅ @ **`0797a8a6c`**
  ...
  - 余（勿并本叶）：nest>20（21 须加宽 `type_to_c_repr` 256／碰 pipeline_abi）；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；sat 盖 prefer；ARM64 prologue 未存 x19
