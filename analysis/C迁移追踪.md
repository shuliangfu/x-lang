...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w212＋w213 asm | 含 wave213 live/interf thin。下一＝wave214 live set。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
...
1. **主刀 M2**（[自举效率方法-M2主链.md](自举效率方法-M2主链.md)）：纯 asm／CG002。ttc…w213 live/interf→`.x` thin。下一叶＝wave214 live set；禁 Darwin mega `-E`；禁盲 FORCE mega；禁升钉。双端 L2＝mac push→Ubuntu pull。  
