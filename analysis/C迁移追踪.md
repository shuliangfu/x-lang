...
✅ **host-C dest-SLICE const INDEX wrap** ✅ @ **`da2cc2b90`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；模块级 dest-SLICE const（C static 另约束）
