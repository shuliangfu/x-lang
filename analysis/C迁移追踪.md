...
✅ **AAPCS64 import METHOD 标量 f32 extras（s0–s7）** ✅ @ **`320a81d0c`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；本地 f32 CALL（s2 fill4＝10／add1 fcvt）
