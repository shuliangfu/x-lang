...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **540／1,956**（v5.25）  
...
2. 🟡 **7.2.1b** B-minus 续（540／1,956；v5.25 exact-pinnacle import/struct/try_skip／fn／library／body_skip／control_flow／expr／match／primary／trait-buf 已收；续＝crown／versal／parse_into_hyper／simd from_at／peek_kind；**深链 close only**）＋ **BC + 8.3**  
