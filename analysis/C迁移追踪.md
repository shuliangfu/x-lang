...
| `pipeline_asm_emit_spill.c` | ~2490 | asm ELF 7.3 live／Chaitin Cap residual（wave156–165 pure 已抽） | 🟡 wave165 pure：linear color-pins + interf thin；余 cfg interf／evict／index-scratch／note 仍 host-cc |
