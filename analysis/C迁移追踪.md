...
✅ **METHOD 向量 assign let-init reuse** ✅ @ **`3f70bd34d`**
  ...
  - 余（勿并本叶）：import extras=2 CALL emit 值绿；nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；sat 盖 prefer；ARM64 prologue 未存 x19
