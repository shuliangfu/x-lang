...
🟡 **12.2.3 产品默认后端**（2026-08-12 · 去 import→C + seed APPLE 收敛后）
  ...
  - 下一刀候选：①sat 盖 prefer（须点名＋双端 L4）· ②pipeline_abi mega 仍硬禁 · ③ALLOW ensure 再瘦／Stage12 COMPILE residual 其它叶
