...
> **刷新**：2026-09-22 · 状态债 · Win PE egg ✅；B-hybrid ✅；Win L2 **2/5 rv＋hello** 🟡；win32-write 🟡 · tip `725c94ce6` · 钉盘 **`ecdb5cc1e`**
...
| Win PE egg pin | ✅ | egg＠`99b008cc1`；默认 asm **rv＋hello**＠`725c94ce6`；Win L2 **2/5**；T001／f32／win32 🟡；三端硬闸仍 🟡 |
