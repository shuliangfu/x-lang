...
| `pipeline_asm_emit_spill.c` | ~2485 | asm ELF 7.3 live／Chaitin Cap residual（wave156–169 pure 已抽） | 🟡 wave169 pure：index-scratch cleanup/invalidate/push + thin；余 enc/reload／cache spill helpers 仍 host-cc |
