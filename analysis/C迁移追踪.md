...
✅ **4.2.3 体 const nested slice parse** ✅ @ **`05069be34`**（parser.x **`adde4a343`**）
  ...
  - 余（已闭 parse＋asm fat＋const whitelist＋asm 聚合 emit）：`[lit] as T` @ **`6767ea638`**；另层：host-C 多 const 声明；`[][2]i32` INDEX 发射
