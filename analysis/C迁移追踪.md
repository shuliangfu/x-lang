...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w288 C（w268=.x） | 含 wave288 asm_label_format 域 C thin（双端 L2 tip `b1f8c6bfb`）。下一＝wave289 codegen_outbuf 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
