...
> **创建**：2026-07-29  
> **状态刷新**：2026-08-04（对照 tip residual：glue ~3.4k／ast_pool ~9.7k／ELF write + ELF ctx + type-to-c + skip/force + struct emit 域抽出；**只改勾选与事实 LOC**，无波次流水）  
