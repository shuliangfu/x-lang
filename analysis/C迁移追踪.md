...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **380／1,956**  
...
2. 🟡 **7.2.1b** B-minus 续（380／1,956；v5.14 exact-max 分批 mega 已收；续＝补 import·struct·try_skip 链／simd from_at／peek_kind／可控 apex）＋ **BC + 8.3**  
