...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **417／1,956**（v5.18）  
...
2. 🟡 **7.2.1b** B-minus 续（417／1,956；v5.18 exact-hyper import/struct/try_skip／library／trait-buf 已收；续＝ultra_hyper+／simd from_at／peek_kind；**日常 delta eq**）＋ **BC + 8.3**  
