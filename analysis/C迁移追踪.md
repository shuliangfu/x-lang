...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w291 C＋w292 elf_fwd `.x`（w268=.x） | Class E Cap residual ALWAYS C-thin 收＠w291；w292＝elf_fwd C→.x（orch 已 seed-only）。下一＝wave293 bare alias 核验／下一 C→.x。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
