...
✅ **host-C 模块级 dest-SLICE const wrap** ✅ @ **`8e64e35b5`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；asm 模块级 dest-SLICE const CG002
