...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w270 C（w268=.x） | 含 wave270 type_pool 域 C thin（双端 L2 tip `235ece2a0`）。下一＝wave271 GrowVec 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
