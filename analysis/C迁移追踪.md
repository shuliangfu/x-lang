...
| **非 gen 产品 C（glue/ast 池）** | 🟡 | 阶段 8.3：`pipeline_glue` ~22.2k + `ast_pool` ~12.9k；8.3.1 二十八刀（+asm_emit_spill）+ 8.3.2 …+top_level residual 已切；8.3.9 ✅；其余 ⬜ |
...
🟡 **8.3.2 `ast_pool.c` → .x / 已有 ast.x 权威收敛**
  ...
  - ⬜ 下一域候选：eff_addr_scaled／leaf residual 或 8.3.3 field_access／soa
...
2. 🟡 **BC + 阶段 8.3**（库存 ✅ · 8.3.1 二十八刀（+spill）✅ · **8.3.2 …+top_level residual ✅** · 8.3.9 ✅ · **当前：eff_addr_scaled／leaf residual 或 8.3.3 field_access／soa**）  
