...
| `pipeline_asm_emit_spill.c` | ~2360 | asm ELF 7.3 live／Chaitin Cap residual（wave156–173 pure 已抽） | 🟡 wave173 pure：left_assoc + live_fwd before/apply；余 CAP BSS + spill_reg_to_spill／evict／Chaitin thin 仍 host-cc |
