...
| `pipeline_typeck_region_assign.c` | **~1595** | typeck region/escape assign-site 切片（wave235：M-3 assign／return pure leave → typeck.x；残 scope／stack-escape／with_arena／call_slice） | 🟡 已抽出；仍 host-cc 入 `pipeline_x` |
