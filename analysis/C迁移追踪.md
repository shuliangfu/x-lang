...
✅ **非 main 读模块 const 数组** ✅ @ **`c06f206ef`**
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；host-C 函数作用域 dest-SLICE 模块 VAR
