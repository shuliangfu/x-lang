...
> **刷新**：2026-09-22 · 状态债 · Win PE egg ✅；B-hybrid ✅；Win L2 **1/5 rv** 🟡；win32-write 🟡 · tip `26868b6cc` · 钉盘 **`ecdb5cc1e`**
...
| Win PE egg pin | ✅ | egg＠`99b008cc1`；B-hybrid＋默认 asm **rv42**＠`26868b6cc`；Win L2 **1/5**；win32-write／余 4 件 🟡；三端硬闸仍 🟡 |
...
- 🟡 **11.2.4** Windows／MSYS2 冷底座（g05＋crt0）✅；PE egg＋B-hybrid ✅；默认 asm **rv** ✅；Win L2 余 4／win32-write ⬜；三端硬闸 ⬜  
