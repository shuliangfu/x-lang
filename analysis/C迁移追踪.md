...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w271 C（w268=.x） | 含 wave271 GrowVec 域 C thin（双端 L2 tip `5cff62810`）。下一＝wave272 PipelineDepCtx 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
