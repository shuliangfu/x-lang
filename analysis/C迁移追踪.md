...
| `pipeline_asm_emit_spill.c` | ~1643 | asm ELF 7.3 live／Chaitin Cap residual（wave156–177／207–210 pure 已抽） | 🟡 wave210 pure：VAR slot cache BSS＋thin；wave207–209 CAP／stack_spill；余 live_fwd／color／interf BSS + try_reload enc 仍 host-cc |
