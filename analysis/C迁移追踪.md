...
2. 🟡 **7.2.1b** B-minus 续（681／1,956；v5.33 preamble／ultra／ultra2／diag_super→transcendent ABI＋parse_into super→transcendent；续＝infinite／versal／infinite／versal／simd；**深链分批 smoke／deep_off=0**）＋ **BC + 8.3** 
