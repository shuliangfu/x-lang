...
1. **最优真减 host-cc**：P4bl suffix_loop LT rewind **已开**（mega `-E` typeck 墙关）。P4bk BREAK/CONTINUE **已开**。P3n builtin scalar **已开**。P4bj anonymous-struct alloc 已开。下刀＝type_ref IDENT named／dyn／impl peel。**跳过 glue_tail**。禁 dest-buffer IDENT generic type-arg。禁升钉／默 bstrict。禁 FORCE 整 mega 产品默认。  
