...
✅ **dest-in-rbx INDEX 整元素 `*p = arr[i]`** ✅ @ **`b96a7f9bf`**
  ...
  - 余（勿并本叶）：nest>20（21 须加宽 scratch）；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；sat 盖 prefer；ARM64 prologue 未存 x19
