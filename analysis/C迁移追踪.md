...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w279 C（w268=.x） | 含 wave279 lifecycle 域 C thin（双端 L2 tip `7bb7b0b04`）。下一＝wave280 module_func 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
