...
> **创建**：2026-07-29  
> **状态刷新**：2026-08-17 · 钉盘 **`f7424ae47`** · nest 64 冻帽 · dest leftover 族 **已尽** · g05／ensure parser 冷路径 **pin-first**（`XLANG_PARSER_FROM_X` 默认 0；禁缺 o 时 tip assemble）· 4.2.4 leave-off 诚实 T001 · **4.2.5 multi mono 闭**（标量 `id__i32` + struct `id_s__A`／`id_s__B`；须匿名 lit `{ fields }`）· 4.2.7 dual／nest same-call 已绿 · TYPE_DYN／vtable 后期 · 只改勾选与事实，无波次流水  
