...
✅ **import METHOD 标量 f32 xmm extras** ✅
  ...
  - 余（勿并本叶）：nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；AAPCS64 s0–s7
