...
> **刷新**：2026-09-16 · tip **`824a4131b`**（P12v SHAPE 两片齐／ret_shape 双端绿）· 钉盘 **`ecdb5cc1e`**
...
1. **最优真减 host-cc**：P12v SHAPE **两片齐**（param_shape＋ret_shape；符号 `…_param_shape_…`／`xlang_skip_trait_check_ret_shape_x_into_c`；禁并 P12u）。P3m／P1g／P2d 已开。下刀＝**anonymous-struct alloc**（禁 dest-buffer 整块乱扩）／type_ref 其它单片。**跳过 glue_tail**。禁 P4b／pipeline mega／升钉／默 bstrict。pipeline_abi mega pure-asm 仍是已知地雷。  
