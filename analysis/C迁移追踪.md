...
| `pipeline_asm_emit_spill.c` | ~2474 | asm ELF 7.3 live／Chaitin Cap residual（wave156–161 pure 已抽） | 🟡 wave161 pure：apply_expr_effect leave；余 binop VAR cache／break-note／Chaitin／index-scratch 仍 host-cc |
