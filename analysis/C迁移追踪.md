...
✅ **host-C dest-SLICE 行 wrap** ✅ @ **`75119a170`**
  ...
  - 余（勿并本叶）：asm CALL 行 `[][]i32=[mk()]` 134（`glue_emit_slice_from_array_let_init` 只认 ARRAY_LIT／VAR／FIELD）；nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off
