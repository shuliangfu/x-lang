...
✅ **dest-in-rbx ARRAY_LIT `*p = [w]`** ✅ @ **`2046f5a15`**
  ...
  - 余（勿并本叶）：匿名 match 模式；nest>20（21 须加宽 scratch）；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；sat 盖 prefer；ARM64 prologue 未存 x19
