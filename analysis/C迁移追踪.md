...
| `pipeline_typeck_method_call.c` | **~2812** | typeck method_call + generic UFCS mono（wave248：overload pick／resolve → typeck.x；wave247 call-resolve／import thin；残 generic UFCS／fixup／method_call_c） | 🟡 已抽出；仍 host-cc 入 `pipeline_x` |
