...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w278 C（w268=.x） | 含 wave278 expr_sidecar 域 C thin（双端 L2 tip `6a511f7b7`）。下一＝wave279 lifecycle 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
