...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **456／1,956**（v5.21）  
...
2. 🟡 **7.2.1b** B-minus 续（456／1,956；v5.21 exact-apex import/struct/try_skip／fn／library／body_skip／control_flow／expr／trait-buf 已收；续＝summit／parse_into_hyper／simd from_at／peek_kind；**daily→close**）＋ **BC + 8.3**  
