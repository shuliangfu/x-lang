...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w283 C（w268=.x） | 含 wave283 ast_forwarders 域 C thin（双端 L2 tip `ad07b1348`）。下一＝wave284 parse_orch 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
