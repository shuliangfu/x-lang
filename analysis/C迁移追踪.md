...
| 2026-08-07 | **feat(bc)** typeck_assign domain pure leave (wave225) | **代码** · **不升钉** · **mac L2**。B′ G.7 assign+diag-fmt residual→typeck.x thin；Cap residual～108；present **56**。tip 待填。下刀：check_block／coerce／ctfe／region／method_call／elf／ast_pool／pipeline_x mega。PLATFORM: SHARED freestanding typeck. |
