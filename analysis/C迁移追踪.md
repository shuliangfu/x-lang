...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **440／1,956**（v5.20）  
...
2. 🟡 **7.2.1b** B-minus 续（440／1,956；v5.20 exact-max import/struct/try_skip／fn／library／body_skip／trait-buf 已收；续＝apex／parse_into_hyper／simd from_at／peek_kind；**daily→close**）＋ **BC + 8.3**  
