...
| `pipeline_asm_emit_spill.c` | ~2392 | asm ELF 7.3 live／Chaitin Cap residual（wave156–170 pure 已抽） | 🟡 wave170 pure：try_reload + stack_try_reload thin；余 enc/reload／cache spill helpers 仍 host-cc |
