...
| `pipeline_asm_emit_spill.c` | ~2468 | asm ELF 7.3 live／Chaitin Cap residual（wave156–168 pure 已抽） | 🟡 wave168 pure：cfg simulate walk 两面 + thin；余 index-scratch 仍 host-cc |
