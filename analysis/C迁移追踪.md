...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w289 C（w268=.x） | 含 wave289 codegen_outbuf 域 C thin（双端 L2 tip `e04877943`）。下一＝wave290 asm_codegen_mega_body 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
