...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **645／1,956**（v5.31）  
...
2. 🟡 **7.2.1b** B-minus 续（645／1,956；v5.31 exact-transcendent＋21；parse_into 卡 `diag_parse_one_mega` ABI widen；续＝parse_into 攀梯／infinite／versal／simd from_at／peek_kind；**深链分批 smoke／deep_off=0**）＋ **BC + 8.3** 
