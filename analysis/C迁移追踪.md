...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w286 C（w268=.x） | 含 wave286 typeck_check_expr 域 C thin（双端 L2 tip `34142beec`）。下一＝wave287 parser_result 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
