...
> **刷新**：2026-09-23 · 状态债 · **三端 L2 硬闸已启用** ✅；BC present **0**；AD–AO Cap／diagnostic 剥 ✅；**Class AP** Darwin leftover 拼装 ✅＋parse_commit Cap gather 剥 ✅（Cap／真减续 🟡）· 钉盘 **`ecdb5cc1e`**（不升）
...
| BC（编译层零 host-cc） | 🟡 | inventory present **0**（Class O）；余量＝map 外 from_x／seed／`.inc`／大户 Cap／真减（AP Cap gather 剥后） |
