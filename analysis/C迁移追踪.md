...
✅ **嵌套 MEMORY sret dest 保存／恢复** ✅ @ **`5f11667aa`**
  ...
  - 余（勿并本叶）：FIELD dest field_off≠0（x86 stored −8）；nest>20（21 须加宽 scratch）；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off；sat 盖 prefer；ARM64 prologue 未存 x19
