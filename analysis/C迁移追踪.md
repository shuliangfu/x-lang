...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–224／w261–w267／w269–w284 C（w268=.x） | 含 wave284 parse_orch 域 C thin（双端 L2 tip `98962ea49`）。下一＝wave285 typeck_orch 域。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
