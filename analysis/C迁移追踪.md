...
| Mega 去 pin M4（阶段 7） | 🟡 | 冷链关 pin；**7.2.1b** 1977/2006（v5.48 leftover flatten import leftover 链）；PP002 heap entry ✅；parser seed 物理删 ⬜ |
...
- 🟡 **7.2.1b** parser_asm suite audit B-minus — **1977／2,006**（v5.48 leftover flatten import leftover 链；parse_suite leftover 0；PP002 heap entry 已抬；余 validate_toplevel）  
...
2. 🟡 **7.2.1b** B-minus 续（1977／2,006；parse_suite leftover 0；PP002 heap entry ✅；v5.48 leftover flatten import leftover 链；续＝validate_toplevel；**深链分批 smoke／deep_off=0**）＋ **BC + 8.3** 
