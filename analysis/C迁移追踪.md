...
> **刷新**：2026-09-16 · tip `69efc6738` 双端 L2 5/5 · 钉盘 **`ecdb5cc1e`**
...
| `pipeline_abi` mega pure-asm | 🟡 tip 双端 L2 绿 | tip `69efc6738` 双端 L2 5/5。prefer 默认 PREFER_ASM=1。C-extract 另刀。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
...
1. **主刀 M2**（[自举效率方法-M2主链.md](自举效率方法-M2主链.md)）：纯 asm／CG002。tip `69efc6738` 双端 L2 5/5。下刀＝C-extract；禁 Darwin mega `-E`；禁盲 FORCE mega；禁升钉。双端 L2 默认 mac push→Ubuntu pull。  
