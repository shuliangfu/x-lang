...
> **刷新**：2026-09-22 · 状态债 · Win PE egg ✅；B-hybrid 建链 ✅；Win L2／win32-write 🟡 · tip `388a1605a` · 钉盘 **`ecdb5cc1e`**
...
| Win PE egg pin | ✅ | `seeds/bootstrap_xlangc.windows.x86_64`＠`99b008cc1`；B-hybrid 建链绿＠`388a1605a`；Win `product_l2`／win32-write 红；三端硬闸仍 🟡 |
...
- 🟡 **11.2.4** Windows／MSYS2 冷底座（g05＋crt0）✅；PE egg＋B-hybrid 建链 ✅；Win 默认 asm L2／win32-write ⬜；三端硬闸 ⬜  
