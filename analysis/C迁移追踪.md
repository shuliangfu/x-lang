...
| `pipeline_abi` mega pure-asm | 🟡 ttc＋…＋w219 asm＋w220–291 C＋w292/w293 部分 `.x`（w268=.x） | w292 elf_fwd 全 `.x`；w293 typeck_orch 4 shim `.x`＋layout glue 仍 C。下一＝wave294 stubs 核验／下一 C→.x。禁 Darwin mega `-E`；禁盲 FORCE 整 mega。 |
| nest 冻帽 | ✅ 纪律 | **64** |
