...
| `pipeline_typeck_method_call.c` | **~3209** | typeck method_call + generic UFCS mono（wave247：call-resolve／import thin → typeck.x；残 generic UFCS／overload／fixup／method_call_c） | 🟡 已抽出；仍 host-cc 入 `pipeline_x` |
