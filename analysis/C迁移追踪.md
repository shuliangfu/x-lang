...
| `pipeline_asm_emit_spill.c` | ~2461 | asm ELF 7.3 live／Chaitin Cap residual（wave156–159 pure 已抽） | 🟡 wave159 pure：loop-phi + has_cfg leave；余 binop VAR cache／live-merge／Chaitin／break／index-scratch 仍 host-cc |
