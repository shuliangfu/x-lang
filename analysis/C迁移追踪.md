...
| `pipeline_abi` mega pure-asm | 🟡 …＋**w344 bake**；**w344b ban**；**w345 MODLET_IN_REST prepare**；bootstrap→类 B；**w335／w337 ban** 余 | 下一＝check_expr dual-home／block_tree／GrowVec-LE。禁盲翻；禁 Darwin mega `-E`（内存）。 |
| nest 冻帽 | ✅ 纪律 | **64** |
