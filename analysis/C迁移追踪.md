...
✅ **asm INDEX-on-METHOD／CALL SIMD** ✅ @ **`1f8560578`**
  ...
  - 余（勿并本叶）：assign INDEX-on-METHOD（rbx 孪，rhs 占 rax）；nest>16 soft；TYPE_DYN／vtable 后期；4.2.4–5／4.2.7 leave-off
