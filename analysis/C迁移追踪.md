...
> **创建**：2026-07-29  
> **状态刷新**：2026-08-17 · 钉盘 **`f7424ae47`** · nest 64 冻帽 · dest leftover 族 **已尽** · g05／ensure parser 冷路径 **pin-first** · 4.2.4 leave-off 诚实 T001 · **4.2.5 multi mono 闭** · **4.2.7 nested reent deep-copy 闭**（esz=ty_ref stride；let 帧 esz>8 payload≤8KiB）· TYPE_DYN／vtable 后期 · 只改勾选与事实，无波次流水  
