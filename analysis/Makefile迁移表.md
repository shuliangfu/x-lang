...
6. **11.1+** build.x 策略图（wave734）· g05+refresh+migrate+gen shells（wave733–740）→ **11.3 物理删**；**11.5.1–4** tests/ host-cc 策略全裁定（wave734/741 · `tests/HOST_CC_POLICY.md`）；**11.1.1 🟡** 编排 DAG 库存（wave742 · `compiler/docs/BUILD_DAG.md` + `product_build_dag.sh` · `./xbuild product-dag`）
