...
| `verify-selfhost-stage2` | ~2783 | **shell** `scripts/verify-selfhost-stage2.sh` | `xbuild stage2` / make thin | 🟢 wave896 driver_leaf list→mk; wave895 std_x; wave894 formal_mod; wave893 body under scripts；root shim CI | Stage2 X dogfood |
