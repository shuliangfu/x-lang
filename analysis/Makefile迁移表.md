...
**wave763**：R3 PREFER thin try-r3-prefer — catalog `R3_COLD_SEED_OBJS` 九叶；thin+rest 单 body；Makefile thin；g05 other PREFER residual。  
