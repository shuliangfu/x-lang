...
> **F-04 v19 v1**：**`std/crypto/ed25519.inc.c`** → **`ed25519.sx`** + **`ed25519_ref10_glue.c`**（ref10 曲线仍 C 胶层）。

## 迁移范围

| 文件 | 说明 |
|------|------|
| `std/crypto/ed25519.sx` | crypto_ed25519_* C ABI + RFC 8032 烟测 |
...
- **F-04 v20**（可选）：ref10 fe/ge/sc 迁 `.sx`
