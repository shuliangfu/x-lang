...
| `grow_vec_ensure` 倍增 | 读 [ast_pool.c:137-156](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c) | 线性扩容 `nc += AST_POOL_GROW`，非倍增 |
...
`__common` 段只有两个大符号（[nm -m](file:///home/shuliangfu/worker/shu/xlang/compiler/xlang-x) 计算）：

| 符号 | 大小 | 定义 |
|------|------|------|
| `_driver_arena_static` | **128 MB** | [rt_arena_buf.from_x.c:19,24](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_arena_buf.from_x.c) |
| `_driver_module_static` | 2 MB | [rt_arena_buf.from_x.c:20,25](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_arena_buf.from_x.c) |
...
入口 [rt_run_x_emit.from_x.c:92-466](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_run_x_emit.from_x.c)：
...
参考 [pipeline_glue.c:554](file:///home/shuliangfu/worker/shu/xlang/compiler/pipeline_glue.c)：
```c
...
参考 [codegen_gen.c:547-552](file:///home/shuliangfu/worker/shu/xlang/compiler/codegen_gen.c)：
```c
struct ast_ASTArena {
    int32_t num_types;
    int32_t num_exprs;
...
[ast_pool.c:184-209](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)：
...
[ast_pool.c:411-465](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c) `arena_sidecar_get(a, create=1)`：
...
[ast_pool.c:111-123](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)：
```c
...
[ast_pool.c:14-15](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)：
```c
...
`ast_pool_arena_reset`（[ast_pool.c:1057-1087](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)）只重置
...
[rt_run_x_emit.from_x.c:256-269](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_run_x_emit.from_x.c)：
...
`parser_parse_into_init(module, arena)`（[L164](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_run_x_emit.from_x.c)）
...
`typeck_dep_arena_ptrs[]`，[L395-398](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_run_x_emit.from_x.c)）。
...
[ast_pool.c:237-272](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)：
...
**OneFuncSidecar 有 free 路径**（[ast_pool.c:589-622](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)）
和 release API `ast_pool_onefunc_release`（[L1125](file:///home/shuliangfu/worker/shu/xlang/compiler/ast_pool.c)），
...
`driver_run_x_emit_c` 在主 emit 完成后（[L455-456](file:///home/shuliangfu/worker/shu/xlang/compiler/seeds/rt_run_x_emit.from_x.c)）
循环调用：
