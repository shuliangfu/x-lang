...
IR 层的 ABI 区分直接映射到 [X ABI 设计分析](file:///home/shuliangfu/worker/shu/shux/analysis/X-ABI-设计分析.md) 的决策：
...
- 对齐 [内核级语言 §11.1](file:///home/shuliangfu/worker/shu/shux/analysis/内核级语言.md) 差分测试；
...
- 基准集对齐 [性能基准测试](file:///home/shuliangfu/worker/shu/shux/性能基准测试.md) 四层框架。
