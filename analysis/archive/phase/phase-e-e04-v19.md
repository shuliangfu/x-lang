...
> **E-04 v19**：Linux x86_64 默认 **`MAIN_LINK_O=crt0_x86_64.o`** 替代 `main_driver.o`；crt0 `_start` 改调 **`main_entry`**（与 driver_x.o -E 符号一致）；非 Linux 或 `XLANG_LEGACY_MAIN_C=1` 仍链 main.c 薄桩。
...
| `XLANG_LEGACY_MAIN_C=1` | 考古：强制 main_driver.o |
