...
> **E-04 v35**：自 `runtime.c` 将 **xlang_collect_deps_transitive / xlang_merge_direct_then_transitive_deps / xlang_load_direct_imports_for_asm_layout** 迁入 **`runtime_pipeline_abi.c/h`**。

## v35 完成（✅）

| 符号 | TU | 说明 |
|------|-----|------|
| `xlang_collect_deps_transitive` | runtime_pipeline_abi.c | 递归 resolve+preprocess+parse import 闭包 |
| `xlang_merge_direct_then_transitive_deps` | runtime_pipeline_abi.c | direct import 槽对齐 + 传递 dep 去重 merge |
| `xlang_load_direct_imports_for_asm_layout` | runtime_pipeline_abi.c | ENTRY_MODULE_ONLY 仅读 direct import 填 layout |
