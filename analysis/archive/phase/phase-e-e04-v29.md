...
> **E-04 v29**：**`driver_bump_stack_limit`** / **大栈 pthread** 迁入 **`runtime_driver_abi.c/h`**；**`xlang_preprocess_raw_to_malloc`** 与 **typeck dep 侧车** 迁入 **`runtime_pipeline_abi.c/h`**。
...
| `xlang_preprocess_raw_to_malloc` | pipeline_abi | preprocess.x 条件编译 |
