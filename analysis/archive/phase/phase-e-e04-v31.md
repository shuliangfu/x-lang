...
| 符号 | 说明 |
|------|------|
| `xlang_import_dep_dir_from_path` | 从源文件 path 提取 dep_dir（load_one_import 递归 import） |
| `xlang_driver_asm_prepare_entry_elf_emit` | asm_codegen_elf_o 前 skip_heavy + ARRAY_LIT/SoA 补类型 |
| `xlang_asm_codegen_elf_o_large_stack` | 256MiB 栈 pthread 上调用 asm_asm_codegen_elf_o |
