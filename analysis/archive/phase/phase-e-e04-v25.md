...
| `driver_asm_build_skip_typeck` | `XLANG_ASM_BUILD_SKIP_TYPECK` |
| `driver_asm_entry_emit_heavy` | `XLANG_ASM_ENTRY_EMIT_HEAVY` |
| `driver_asm_entry_module_only_from_env` | `XLANG_ASM_ENTRY_MODULE_ONLY` |
| `driver_skip_codegen_dep_0_*` | exe 路径跳过 dep0 codegen |
| `driver_set/get_current_dep_path_for_codegen` | codegen C 符号前缀 |
| `driver_compile_phase_timing_*` | `XLANG_COMPILE_PHASE_TIMING` |
