...
| 项 | 结果 |
|----|------|
| 根修 | ① `72110054` weak process-wide `g_shux_depctx_sc`（禁 per-TU static）② `a5e23ae7` **`ld_partial_export` 注入 keep `g_shux_depctx_sc`**（禁 objcopy/exported_symbols_list 局部化） |
