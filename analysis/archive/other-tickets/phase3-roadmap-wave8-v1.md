...
1. **parser C5 跨平台 xlang_asm2**：Darwin/Linux native 二进制烟测（BOOT-027）。
...
| 维度 | 目标 |
|------|------|
| **自举** | BOOT-027 C5 xlang_asm2 跨平台烟测；Linux `c5_ok=1` |
...
```
xlang: [XLANG_PLAN008_PHASE3_W8] status=ok tasks=4 sections=5 done=4
```
