...
live mock：`XLANG_SOCKETIO_LIVE=1 ./tests/run-std-socketio-live.sh`
...
npm live：`XLANG_SOCKETIO_NPM=1 ./tests/run-std-socketio-npm-live.sh`
...
npm live（含 `/chat` CONNECT POST）：`XLANG_SOCKETIO_NPM=1 ./tests/run-std-socketio-npm-live.sh`
...
npm WS live：`XLANG_SOCKETIO_NPM_WS=1 ./tests/run-std-socketio-npm-ws-live.sh`
...
npm room live：`XLANG_SOCKETIO_NPM_ROOM=1 ./tests/run-std-socketio-npm-room-live.sh`
...
npm middleware live：`XLANG_SOCKETIO_NPM_MW=1 ./tests/run-std-socketio-npm-mw-live.sh`
...
npm plugin live：`XLANG_SOCKETIO_NPM_PLUGIN=1 ./tests/run-std-socketio-npm-plugin-live.sh`
...
cluster ring live：`XLANG_SOCKETIO_CLUSTER_RING=1 ./tests/run-std-socketio-cluster-ring-live.sh`
...
all-live：`XLANG_SOCKETIO_ALL_LIVE=1 ./tests/run-std-socketio-all-live.sh`
