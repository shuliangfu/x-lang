# TU Contract: lsp_fmt_pure_thin

## 1. 当前权威源
- x 源：`src/lsp/lsp_fmt_pure_thin.x`
- seed 源：`N/A`
- prove 工件目录：`../tests/probes/prove_x_o/lsp_fmt_pure_thin`
...
- `lsp_char_in_range`
- `lsp_find_key_after`
- `lsp_fmt_is_atom_head`
- `lsp_fmt_is_atom_tail`
- `lsp_fmt_is_inline_ws`
- `lsp_fmt_is_src_ws`
- `lsp_fmt_last_out`
- `lsp_fmt_prev_src`
- `lsp_fmt_space_after`
- `lsp_fmt_space_before`
- `lsp_fmt_src_ws_after`
- `lsp_fmt_src_ws_before`
- `lsp_fmt_unary_lhs`
- `lsp_hash_source`
- `lsp_json_escape_ident`
- `lsp_line_has_block_comment_end`
- `lsp_line_is_block_comment`
- `lsp_load_i32_at`
- `lsp_load_ptr_at`
- `lsp_match_bytes_at`
- `lsp_parse_bool_after`
- `lsp_store_i32`
