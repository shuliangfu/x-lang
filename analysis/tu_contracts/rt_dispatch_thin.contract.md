# TU Contract: rt_dispatch_thin

## 1. 当前权威源
- x 源：`src/runtime/rt_dispatch_thin.x`
- seed 源：`seeds/rt_dispatch_thin.from_x.c`
- prove 工件目录：`../tests/probes/prove_x_o/rt_dispatch_thin`
...
### 3.1 必须由 thin/.x 提供
- `driver_run_asm_backend_c`

### 3.2 当前仍由 seed/rest 提供
- `driver_run_compiler_full`
- `driver_run_emit_c_path_c`
- `driver_try_compile_via_shu_c_sibling`
- `labi_rt_dispatch_thin_slice_marker`
