...
struct lexer_Lexer lexer_skip_whitespace_and_comments(struct lexer_Lexer lex, struct shux_slice_uint8_t * data) {
 ...
 } else (__tmp = ({ struct lexer_Lexer __tmp = (struct lexer_Lexer){0}; if (c == 35) {   (void)(({ struct lexer_Lexer __tmp = (struct lexer_Lexer){0}; if ((l).pos + 1 < (data)->length && ((l).pos + 1 < 0 || (size_t)((l).pos + 1) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 1]) == 91) {   return l;
 } else (__tmp = (struct lexer_Lexer){0}) ; __tmp; }));
...
void lexer_next_body_into(struct lexer_LexerResult * restrict out, struct lexer_Lexer l, struct shux_slice_uint8_t * data) {
  uint8_t c = ((l).pos < 0 || (size_t)((l).pos) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos]);
  (void)(({ int32_t __tmp = 0; if (c == 35 && (l).pos + 6 <= (data)->length && ((l).pos + 1 < 0 || (size_t)((l).pos + 1) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 1]) == 91 && ((l).pos + 2 < 0 || (size_t)((l).pos + 2) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 2]) == 115 && ((l).pos + 3 < 0 || (size_t)((l).pos + 3) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 3]) == 111 && ((l).pos + 4 < 0 || (size_t)((l).pos + 4) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 4]) == 97 && ((l).pos + 5 < 0 || (size_t)((l).pos + 5) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 5]) == 93) {   int32_t line0 = (l).line;
  int32_t col0 = (l).col;
  (l = (lexer_advance_one(l, 35)));
  (l = (lexer_advance_one(l, 91)));
  (l = (lexer_advance_one(l, 115)));
  (l = (lexer_advance_one(l, 111)));
  (l = (lexer_advance_one(l, 97)));
  (l = (lexer_advance_one(l, 93)));
