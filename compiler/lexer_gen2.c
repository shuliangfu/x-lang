...
int32_t lexer_try_alloc_attr_into(struct lexer_LexerResult * restrict out, struct lexer_Lexer l, struct shux_slice_uint8_t * data) {
  (void)(({ int32_t __tmp = 0; if ((l).pos + 8 > (data)->length) {   return 0;
 } else (__tmp = 0) ; __tmp; }));
  (void)(({ int32_t __tmp = 0; if (((l).pos < 0 || (size_t)((l).pos) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos]) != 35 || ((l).pos + 1 < 0 || (size_t)((l).pos + 1) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 1]) != 91) {   return 0;
 } else (__tmp = 0) ; __tmp; }));
  (void)(({ int32_t __tmp = 0; if (((l).pos + 2 < 0 || (size_t)((l).pos + 2) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 2]) != 97 || ((l).pos + 3 < 0 || (size_t)((l).pos + 3) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 3]) != 108 || ((l).pos + 4 < 0 || (size_t)((l).pos + 4) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 4]) != 108 || ((l).pos + 5 < 0 || (size_t)((l).pos + 5) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 5]) != 111 || ((l).pos + 6 < 0 || (size_t)((l).pos + 6) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 6]) != 99 || ((l).pos + 7 < 0 || (size_t)((l).pos + 7) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 7]) != 93) {   return 0;
 } else (__tmp = 0) ; __tmp; }));
  int32_t line0 = (l).line;
  int32_t col0 = (l).col;
  struct lexer_Lexer l2 = l;
...
struct lexer_LexerResult lexer_next_slice(struct lexer_Lexer lex, struct shux_slice_uint8_t * data) {
  ...
  (void)(({ struct lexer_LexerResult __tmp = (struct lexer_LexerResult){0}; if (lexer_try_alloc_attr_into((&(attr_out)), l, data) != 0) {   return attr_out;
 } else (__tmp = (struct lexer_LexerResult){0}) ; __tmp; }));
...
void lexer_next_body_into(struct lexer_LexerResult * restrict out, struct lexer_Lexer l, struct shux_slice_uint8_t * data) {
  ...
  (void)(({ int32_t __tmp = 0; if (lexer_try_alloc_attr_into(out, l, data) != 0) {   return;
 } else (__tmp = 0) ; __tmp; }));
  ...
  (void)(({ int32_t __tmp = 0; if (c == 46 && (l).pos + 1 < (data)->length && lexer_is_digit(((l).pos + 1 < 0 || (size_t)((l).pos + 1) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 1]))) {   size_t start = (l).pos;
  int32_t line0 = (l).line;
  int32_t col0 = (l).col;
...
struct lexer_LexerResult lexer_next_body(struct lexer_Lexer l, struct shux_slice_uint8_t * data) {
  ...
  (void)(({ struct lexer_LexerResult __tmp = (struct lexer_LexerResult){0}; if (c == 46 && (l).pos + 1 < (data)->length && lexer_is_digit(((l).pos + 1 < 0 || (size_t)((l).pos + 1) >= (data)->length ? (shux_panic_(1, 0), (data)->data[0]) : (data)->data[(l).pos + 1]))) {   size_t start = (l).pos;
  int32_t line0 = (l).line;
  int32_t col0 = (l).col;
  (l = (lexer_advance_one(l, 46)));
  double fval = 0.0;
