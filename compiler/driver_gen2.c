...
#define ast_pipeline_run_sx_pipeline_impl pipeline_run_sx_pipeline_impl
...
int32_t main_driver_argv_parse_sx_path(int32_t argc, uint8_t * argv, struct main_DriverSxEmitState * state) {
  ...
  continue;
    ...
    (void)(({ int32_t __tmp = 0; if (main_eq_minus_E(arg_buf, len) != 0) {   ++i;
  continue;
 } else (__tmp = 0) ; __tmp; }));
    (void)(({ int32_t __tmp = 0; if (main_eq_minus_E_extern(arg_buf, len) != 0) {   ++i;
  continue;
 } else (__tmp = 0) ; __tmp; }));
...
int32_t main_driver_argv_parse_sx(int32_t argc, uint8_t * argv, struct main_DriverSxEmitState * state) {
  ...
  ((state)->target_arch = (0));
  ((state)->out_path_len = (0));
  (void)(({ int32_t __tmp = 0; if (argc < 3) {   return 0;
 } else (__tmp = 0) ; __tmp; }));
  uint8_t arg_buf[512] = { 0 };
  int32_t i = 1;
  while (i < argc) {
  ...
  continue;
    ...
    (void)(({ int32_t __tmp = 0; if (main_eq_minus_E(arg_buf, len) != 0) {   int32_t pi = i + 1;
  while (pi < argc) {
  ...
  continue;
    ...
    (void)(({ int32_t __tmp = 0; if (plen_temp > 0 && main_eq_minus_sx(arg_buf, plen_temp) != 0) {   ++pi;
  continue;
 } else (__tmp = 0) ; __tmp; }));
    break;
  }
