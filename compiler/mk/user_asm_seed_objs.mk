...
# wave309 G.7 8.3 structure floor: product pipeline mega retired (empty link).
# Historical: Darwin filtered pipeline_x / Linux pipeline_x.o. Live faces =
# runtime_pipeline_abi pure/seed. PLATFORM: SHARED product pure-ld no pipeline mega.
ifeq ($(UNAME_S),Darwin)
BOOTSTRAP_DRIVER_SEED_PIPELINE_LINK_O =
...
BOOTSTRAP_DRIVER_SEED_FILTERED_OBJS = $(BOOTSTRAP_DRIVER_SEED_USER_ASM_OBJS)
XLANG_X_PIPELINE_LINK_O =
XLANG_X_USER_ASM_OBJS = $(BOOTSTRAP_DRIVER_SEED_USER_ASM_OBJS)
RELINK_XLANG_PIPELINE_LINK_O =
