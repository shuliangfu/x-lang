...
# 8.3.1+8.3.2: #include slices (ctfe/assign/.../asm_emit_block_inits/field_access/soa + ast_pool_module_import) enter STALE deps.
#
...
#   = 35 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1+8.3.2: +16 #include slices (ctfe/assign/.../asm_emit_block_inits/field_access/soa + ast_pool_module_import) in PIPELINE_X_DEPS.
