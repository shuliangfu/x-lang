...
#   = 46 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token; wave263 module_import
#   host-cc leave; wave262 type_alias leave; wave261 glue_statics leave).
#   8.3.1+8.3.2: residual #include slices still in PIPELINE_X_DEPS (struct/
#     top_level/expr_sidecar/enum/onefunc/dep_ctx/module_func/arena/block +
