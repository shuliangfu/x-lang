...
#   ast_pool_expr_sidecar + ast_pool_module_enum + ast_pool_onefunc) enter STALE deps.
#
...
#   = 41 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1+8.3.2: +22 #include slices (ctfe/assign/.../soa + ast_pool_module_import +
#     ast_pool_struct_layout + ast_pool_top_level + ast_pool_type_alias +
#     ast_pool_expr_sidecar + ast_pool_module_enum + ast_pool_onefunc) in PIPELINE_X_DEPS.
