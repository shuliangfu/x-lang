...
#   = 50 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1+8.3.2: +30 #include slices (ctfe/assign/.../soa + asm_emit_index +
#     asm_emit_match + asm_emit_panic + ast_pool_module_import + ast_pool_struct_layout +
