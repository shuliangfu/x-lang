...
# 8.3.1: #include slices (ctfe/assign/coerce_init/field_access/soa) enter STALE deps.
#
...
#   = 24 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1: +5 #include slices (ctfe/assign/coerce_init/field_access/soa) in PIPELINE_X_DEPS.
