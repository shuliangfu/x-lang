...
# 8.3.1: #include slices (ctfe/assign/coerce_init/method_call/field_access/soa) enter STALE deps.
#
...
#   = 25 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1: +6 #include slices (ctfe/assign/coerce_init/method_call/field_access/soa) in PIPELINE_X_DEPS.
