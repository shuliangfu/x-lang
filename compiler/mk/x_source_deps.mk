...
#   = 54 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1+8.3.2: +35 #include slices (ctfe/assign/.../soa + asm_emit_index +
#     asm_emit_match + asm_emit_panic + asm_emit_field_access + asm_emit_binop +
#     asm_emit_cmp + asm_emit_call_args +
