...
# 8.3.1+8.3.2: #include slices (ctfe/assign/.../soa + ast_pool_module_import + ast_pool_struct_layout) enter STALE deps.
#
...
#   8.3.1+8.3.2: +17 #include slices (ctfe/assign/.../soa + ast_pool_module_import + ast_pool_struct_layout) in PIPELINE_X_DEPS.
