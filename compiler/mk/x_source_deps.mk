...
# 8.3.1: #include slices (ctfe/assign/coerce_init/method_call/check_block/field_access/soa) enter STALE deps.
#
...
#   = 26 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1: +7 #include slices (ctfe/assign/coerce_init/method_call/check_block/field_access/soa) in PIPELINE_X_DEPS.
