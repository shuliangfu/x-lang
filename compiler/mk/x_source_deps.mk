...
#   ast_pool_struct_layout + ast_pool_top_level) enter STALE deps.
#
...
#   = 37 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1+8.3.2: +18 #include slices (ctfe/assign/.../soa + ast_pool_module_import +
#     ast_pool_struct_layout + ast_pool_top_level) in PIPELINE_X_DEPS.
