...
#   = 42 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token; wave267 asm_locals
#   host-cc leave; wave266 struct_layout leave; wave265 top_level leave;
#   wave264 module_enum leave; wave263 module_import leave; wave262 type_alias leave).
#   8.3.1+8.3.2: residual #include slices still in PIPELINE_X_DEPS (
#     expr_sidecar/onefunc/dep_ctx/module_func/arena/block +
#     elf_ctx/write_o + glue shells + asm slot/block_tree/wpo + grow_vec/
