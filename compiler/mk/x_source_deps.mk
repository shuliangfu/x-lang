...
# 8.3.1: #include slices (ctfe/assign/coerce_init/method_call/check_block/region_assign/asm_emit_unary/asm_emit_as/asm_emit_return/asm_emit_logand/asm_emit_block_body/asm_emit_block_if_stmt/field_access/soa) enter STALE deps.
#
...
#   = 33 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1: +14 #include slices (ctfe/assign/coerce_init/method_call/check_block/region_assign/asm_emit_unary/asm_emit_as/asm_emit_return/asm_emit_logand/asm_emit_block_body/asm_emit_block_if_stmt/field_access/soa) in PIPELINE_X_DEPS.
