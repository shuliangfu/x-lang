...
# 8.3.1: #include slices (ctfe/assign/coerce_init/method_call/check_block/region_assign/asm_emit_unary/asm_emit_as/asm_emit_return/asm_emit_logand/asm_emit_block_body/asm_emit_block_if_stmt/asm_emit_block_inits/field_access/soa) enter STALE deps.
#
...
#   = 34 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1: +15 #include slices (ctfe/assign/coerce_init/method_call/check_block/region_assign/asm_emit_unary/asm_emit_as/asm_emit_return/asm_emit_logand/asm_emit_block_body/asm_emit_block_if_stmt/asm_emit_block_inits/field_access/soa) in PIPELINE_X_DEPS.
