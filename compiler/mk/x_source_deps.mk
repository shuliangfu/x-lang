...
# 8.3.1+8.3.2: #include slices enter STALE deps (type_alias pure-owned leave wave262).
#
...
#   SRCS 4 + MAIN_X_DEPS 4 + PREPROCESS_X_DEPS 1 + PIPELINE_X_DEPS fixed paths 36
#   = 45 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token; wave264 module_enum
#   host-cc leave; wave263 module_import leave; wave262 type_alias leave).
#   8.3.1+8.3.2: residual #include slices still in PIPELINE_X_DEPS (struct/
#     top_level/expr_sidecar/onefunc/dep_ctx/module_func/arena/block +
