...
#   = 41 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token; wave268 slot_bytes
#   host-cc leave; wave267 asm_locals leave; wave266 struct_layout leave; wave265 top_level leave;
...
#     elf_ctx/write_o + glue shells + asm block_tree/wpo + grow_vec/
