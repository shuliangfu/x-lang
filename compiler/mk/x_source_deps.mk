...
#   = 62 (excludes the $(PIPELINE_ASM_X_DEPS) expansion token).
#   8.3.1+8.3.2: +43 #include slices (ctfe/assign/.../soa + asm_emit_index +
...
#     asm_emit_index_eff_addr + asm_emit_expr_rec +
...
PIPELINE_X_DEPS = src/pipeline/pipeline.x src/codegen/codegen.x src/typeck/typeck.x src/parser/parser.x src/ast/ast.x src/lexer/lexer.x src/preprocess/preprocess.x $(PIPELINE_ASM_X_DEPS) pipeline_glue.c pipeline_typeck_ctfe.c pipeline_typeck_assign.c pipeline_typeck_coerce_init.c pipeline_typeck_method_call.c pipeline_typeck_check_block.c pipeline_typeck_region_assign.c pipeline_asm_emit_unary.c pipeline_asm_emit_as.c pipeline_asm_emit_async_cps.c pipeline_asm_emit_x86_enc_helpers.c pipeline_asm_emit_return.c pipeline_asm_emit_logand.c pipeline_asm_emit_block_body.c pipeline_asm_emit_block_if_stmt.c pipeline_asm_emit_block_inits.c pipeline_asm_emit_assign.c pipeline_asm_emit_array_lit.c pipeline_asm_emit_index.c pipeline_asm_emit_match.c pipeline_asm_emit_panic.c pipeline_asm_emit_field_access.c pipeline_asm_emit_lea_common.c pipeline_asm_emit_with_arena.c pipeline_asm_emit_binop.c pipeline_asm_emit_cmp.c pipeline_asm_emit_var_decl.c pipeline_asm_emit_call_args.c pipeline_asm_emit_struct_lit.c pipeline_asm_emit_vector_let.c pipeline_asm_emit_vector_simd.c pipeline_asm_emit_struct_let.c pipeline_asm_emit_index_helpers.c pipeline_asm_emit_spill.c pipeline_asm_emit_index_eff_addr.c pipeline_asm_emit_expr_rec.c pipeline_elf_write_o.c pipeline_elf_ctx.c pipeline_codegen_type_to_c.c pipeline_codegen_struct_emit.c pipeline_codegen_skip_force.c pipeline_codegen_residual.c pipeline_asm_ctx_layout.c pipeline_glue_early_fwd.c pipeline_glue_mid_fwd.c pipeline_glue_backend_fwd.c pipeline_glue_typeck_fwd.c pipeline_glue_typeck_mid_fwd.c pipeline_glue_emit_fwd.c pipeline_glue_emit_block_fwd.c pipeline_asm_locals.c pipeline_asm_slot_bytes.c pipeline_asm_block_tree.c pipeline_asm_ctx_loop.c pipeline_asm_wpo.c pipeline_asm_selfhost.c pipeline_asm_emit_heavy_env.c pipeline_asm_emit_heavy_safe_helper.c pipeline_asm_thin_delegate.c pipeline_asm_parser_emit_heavy.c pipeline_asm_diag.c pipeline_asm_skip_dispatch.c pipeline_resolve_path.c pipeline_import_bind.c pipeline_parse_typeck_dispatch.c pipeline_run_x_pipeline.c pipeline_codegen_dep.c pipeline_lsp_diag.c pipeline_emit_sidecar.c pipeline_preprocess_if.c pipeline_grow_vec.c ast_pool_typedefs.c ast_pool_sidecar_pool.c ast_pool_ptr_at.c pipeline_backend_asm_wrapper.c ast_pool.c ast_pool_module_import.c ast_pool_struct_layout.c ast_pool_top_level.c ast_pool_type_alias.c ast_pool_expr_sidecar.c ast_pool_module_enum.c ast_pool_onefunc.c ast_pool_dep_ctx.c ast_pool_module_func.c ast_pool_arena.c ast_pool_block.c ast_pool_lifecycle.c pipeline_lint_meta.c ast_pool_bootstrap_glue.c
