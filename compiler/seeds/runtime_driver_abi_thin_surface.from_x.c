 ...
 * Prove: thin.x vs this seed → nm IDENTICAL (public surface 61+; _impl are U)
 * Cap residual: *_impl / static slots / path-read / spawn in seeds/runtime_driver_abi.from_x.c rest
