...
#if defined(__linux__) || defined(__APPLE__) || defined(_WIN32) || defined(_WIN64) || defined(_WIN32) || defined(_WIN64)
#include <xlang_sync_cap.h> /* Cap residual 10.6.3: Linux futex / Darwin pthread / Windows Win32 sync_cap */
#include <xlang_thread_cap.h> /* Cap spawn/join for condvar smoke */
#else
#include <pthread.h>
#endif
