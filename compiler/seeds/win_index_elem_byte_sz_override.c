 ...
 * w1012: ARRAY/SLICE named i8 → esz=1 (true pack). i16/u16 stay Cap
 * residual 4 (need scale2+sext16). PTR *i8 stays 1.
 ...
 * ARRAY/SLICE named i8 → 1 (true pack); i16/u16 Cap residual → 4; PTR *i8 → 1.
 */
