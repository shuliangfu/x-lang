 ...
 * parse_primary dest-buffer / P4bi parse_struct_lit_fields dest-buffer / P4bj anonymous-struct alloc (ANON_STRUCT_FROM_X) / P4bk BREAK/CONTINUE primary / P4bl suffix_loop LT relcompare rewind / P4bm STRING decode (STRING_DECODE_FROM_X; append_byte stays C)
