 ...
 * G-02f simd_enc_thin R2 mixed surface - isomorphic with src/asm/simd_enc_thin.x
 * Product PREFER_X_O: xlang-c -E(.x) -> thin.o + ld -r with rest (seeds/simd_enc_thin.from_x.c)
 * Prove: full.x vs this surface -> nm IDENTICAL (74 symbols)
 * Mode: mixed - 3 DIRECT compute + 71 thin+rest forwards to _impl
 * Cap residual: 71 extern bridges (all *_impl, defined in rest C)
 * doc_anchor: none (simd_enc_thin.x has no doc_anchor).
 * Logic: 74 functions = 3 DIRECT compute
 *   (simd_arm64_ins_v1_from_v0_s, simd_arm64_rbp_lea_off_128half, simd_rbp_disp32)
 *   + 71 thin+rest forwards to _impl (simd_append_impl, simd_append_disp32_impl,
 *     simd_x86_addps_xmm0_xmm1_impl, simd_x86_paddd_xmm0_xmm1_impl,
 *     simd_x86_psubd_xmm0_xmm1_impl, simd_x86_vpsubd_ymm0_ymm1_impl,
 *     simd_x86_vpaddd_ymm0_ymm1_impl, simd_x86_mulps_xmm0_xmm1_impl,
 *     simd_x86_pmulld_xmm0_xmm1_impl, simd_x86_vpmulld_ymm0_ymm1_impl,
 *     simd_x86_vfmadd231ps_xmm0_xmm1_xmm2_impl, simd_x86_pxor_xmm3_xmm3_impl,
 *     simd_x86_pcmpgtd_xmm2_xmm3_impl, simd_x86_pand_xmm0_xmm2_impl,
 *     simd_x86_pandn_xmm2_xmm1_impl, simd_x86_por_xmm0_xmm2_impl,
 *     simd_x86_xorps_xmm3_xmm3_impl, simd_x86_cmpgtps_xmm2_xmm3_impl,
 *     simd_x86_andps_xmm0_xmm2_impl, simd_x86_andnps_xmm2_xmm1_impl,
 *     simd_x86_orps_xmm0_xmm2_impl, simd_x86_vpxor_ymm3_ymm3_impl,
 *     simd_x86_vpcmpgtd_ymm2_ymm3_impl, simd_x86_vpand_ymm0_ymm2_impl,
 *     simd_x86_vpandn_ymm2_ymm1_impl, simd_x86_vpor_ymm0_ymm2_impl,
 *     simd_x86_vxorps_ymm3_ymm3_impl, simd_x86_vcmpgtps_ymm2_ymm3_impl,
 *     simd_x86_vandps_ymm0_ymm2_impl, simd_x86_vandnps_ymm2_ymm1_impl,
 *     simd_x86_vorps_ymm0_ymm2_impl, simd_x86_vmovups_ymm0_from_rbx_rax4_impl,
 *     simd_x86_vmovups_ymm1_from_rbx_rax4_impl, simd_x86_vmovups_ymm0_to_rbx_rax4_impl,
 *     simd_x86_movups_xmm0_from_rbx_rax4_impl, simd_x86_movups_xmm1_from_rbx_rax4_impl,
 *     simd_x86_movups_xmm0_to_rbx_rax4_impl, simd_x86_movups_xmm0_from_rbp_impl,
 *     simd_x86_movups_xmm1_from_rbp_impl, simd_x86_movups_xmm0_to_rbp_impl,
 *     simd_x86_vmovups_ymm0_from_rbp_impl, simd_x86_vmovups_ymm1_from_rbp_impl,
 *     simd_x86_vmovups_ymm0_to_rbp_impl, simd_x86_movups_xmm2_from_rbp_impl,
 *     simd_x86_vmovups_ymm2_from_rbp_impl, simd_enc_x86_xorps_xmm0_zero_impl,
 *     simd_enc_x86_movups_xmm1_rbp_disp_impl, simd_enc_x86_addps_xmm0_xmm1_impl,
 *     simd_enc_try_hw_vector_iadd_rbp_impl, simd_enc_try_hw_vector_isub_rbp_impl,
 *     simd_append_u32_le_impl, simd_x86_pshufd_xmm0_imm8_impl,
 *     simd_x86_vpshufd_ymm0_imm8_impl, simd_enc_emit_i32_select_xmm_seq_impl,
 *     simd_enc_emit_f32_select_xmm_seq_impl, simd_enc_emit_i32_select_ymm_seq_impl,
 *     simd_enc_emit_f32_select_ymm_seq_impl, simd_x86_pshufd_xmm1_xmm0_impl,
 *     simd_enc_x86_horizontal_addps_xmm0_impl, simd_enc_x86_movss_xmm0_rbp_disp_impl,
 *     simd_enc_f32_soa_col_movups_xmm1_at_idx_impl,
 *     simd_enc_try_hw_vector_iadd_isub_rbp_impl, simd_enc_try_hw_vector_imul_rbp_impl,
 *     simd_enc_try_hw_vector_fadd_rbp_impl, simd_enc_try_hw_vector_fmul_rbp_impl,
 *     simd_enc_try_hw_vector_fma_rbp_impl, simd_enc_try_hw_vector_binop_rbp_at_idx_impl,
 *     simd_arm64_pshufd_imm8_128_rbp_impl, simd_arm64_select_128_rbp_impl,
 *     simd_enc_try_pshufd_rbp_impl, simd_enc_try_hw_vector_select_rbp_impl).
 * Regen: xlang_asm -E src/asm/simd_enc_thin.x | filter DBG + polish prologue
 */
#include <stdint.h>
#include <stddef.h>
/* Forward declarations for all 74 surface functions (nm IDENTICAL targets). */
...
/* Cap residual: 71 _impl bridges (thin+rest forwards target these). */
