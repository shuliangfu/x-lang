 ...
 * Product PREFER_X_O: g05_try_x_to_o(thin.x) + full seed rest (-DXLANG_L2_SIMD_ENC_THIN_FROM_X) ld -r
 ...
 * Regen: ./xlang -E ... src/asm/simd_enc_thin.x | filter DBG + polish externs
 */
#include <stddef.h>
#include <stdint.h>
#include <sys/types.h>
