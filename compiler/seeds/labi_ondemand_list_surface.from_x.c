 ...
 * Prove: full.x vs this seed → nm IDENTICAL (on_demand tables + wave118–125 needs_std_net/set/map/queue/test + needs_core_mem/slice + needs_std_heap_page_mmap pure)
