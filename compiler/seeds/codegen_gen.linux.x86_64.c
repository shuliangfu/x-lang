...
int32_t codegen_emit_block(struct ast_ASTArena * arena, struct codegen_CodegenOutBuf * out, int32_t block_ref, int32_t indent, struct ast_PipelineDepCtx * ctx) {
  ...
  (void)(({ int32_t __tmp = 0; if ((!ast_ref_is_null(final_ref))) {   (void)(({ int32_t __tmp = 0; if (codegen_emit_indent(out, indent) != 0) {   return (-1);
 } else (__tmp = 0) ; __tmp; }));
  uint8_t ret[8] = { 114, 101, 116, 117, 114, 110, 32, 0 };
  (void)(({ int32_t __tmp = 0; if (codegen_emit_bytes_8(out, ret, 7) != 0) {   return (-1);
 } else (__tmp = 0) ; __tmp; }));
  struct ast_Expr fe_ordered = ast_arena_expr_get(arena, final_ref);
 ...
 } else {   __tmp = ({ int32_t __tmp = 0; if (codegen_emit_expr(arena, out, final_ref, ctx) != 0) {   return (-1);
 } else (__tmp = 0) ; __tmp; });
 } ; __tmp; }));
  uint8_t sc[4] = { 59, 10, 0, 0 };
  __tmp = ({ int32_t __tmp = 0; if (codegen_emit_bytes_4(out, sc, 2) != 0) {   return (-1);
  ...
  (void)(({ int32_t __tmp = 0; if ((!ast_ref_is_null(final_ref_plain))) {   (void)(({ int32_t __tmp = 0; if (codegen_emit_indent(out, indent) != 0) {   return (-1);
 } else (__tmp = 0) ; __tmp; }));
  uint8_t ret[8] = { 114, 101, 116, 117, 114, 110, 32, 0 };
  (void)(({ int32_t __tmp = 0; if (codegen_emit_bytes_8(out, ret, 7) != 0) {   return (-1);
 } else (__tmp = 0) ; __tmp; }));
  struct ast_Expr fe_plain = ast_arena_expr_get(arena, final_ref_plain);
 ...
 } else {   __tmp = ({ int32_t __tmp = 0; if (codegen_emit_expr(arena, out, final_ref_plain, ctx) != 0) {   return (-1);
 } else (__tmp = 0) ; __tmp; });
 } ; __tmp; }));
  uint8_t sc[4] = { 59, 10, 0, 0 };
  __tmp = ({ int32_t __tmp = 0; if (codegen_emit_bytes_4(out, sc, 2) != 0) {   return (-1);
