 ...
 *
 * Hybrid P12b/P12c/P12d/P12e/P12f/P12h/P12i/P12j/P12k/P12l/P12m/P12n/P12o/P12p/P12q (XLANG_PTHIN_SKIP_TL_BODIES_FROM_X):
 ...
 * F3 lookup + F3 simple getters) come from pthin_skip_tl.x;
 ...
 * + offsetof for slot/param i32). dest-extras elem_array_dim stay C.
 * method_on_param stays C.
 * is_registered stays a C thin wrapper over find_reg.
 * Cold: no BODIES define, full .inc.
 * Do not reuse XLANG_PTHIN_SKIP_TL_FROM_X for P12b–P12q bodies.
