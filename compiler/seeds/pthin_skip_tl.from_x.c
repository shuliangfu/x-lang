 ...
 *
 * Hybrid P12b/P12c/P12d/P12e/P12f/P12h/P12i/P12j/P12k/P12l (XLANG_PTHIN_SKIP_TL_BODIES_FROM_X):
 ...
 * type_param_index + concrete_implements_trait) come from pthin_skip_tl.x;
 ...
 * Do not reuse XLANG_PTHIN_SKIP_TL_FROM_X for P12b–P12l bodies.
