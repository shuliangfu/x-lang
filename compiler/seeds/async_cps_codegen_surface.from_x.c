 ...
 * R2 pure surface + Cap residual pure wave1+wave2 — isomorphic with src/async/async_cps_codegen.x
 ...
 *   module/sched resolve + func_uses_void_entry (+ cstr helpers);
 ...
 *   sched_wrapper/phase_reset); walk _impl bodies.
