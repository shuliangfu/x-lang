 ...
 * Product: ../std/net/net_io_batch_fast.o; logic still C until full .x port.
 */
#include <shux_weak.h>
#include <stdint.h>
...
SHUX_WEAK int32_t io_read_batch(int32_t fd, uint8_t *p0, uintptr_t l0, uint8_t *p1, uintptr_t l1, uint8_t *p2,
...
SHUX_WEAK int32_t io_write_batch(int32_t fd, uint8_t *p0, uintptr_t l0, uint8_t *p1, uintptr_t l1, uint8_t *p2,
                                              uintptr_t l2, uint8_t *p3, uintptr_t l3, int32_t n, uint32_t timeout_ms) {
