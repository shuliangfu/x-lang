 ...
 * Regen: ./shux-c src/lsp/lsp_diag_pipeline_sizes.x -E > seeds/lsp_diag_pipeline_sizes.from_x.c
 * Product G05 links this as src/lsp/lsp_diag_pipeline_sizes_nostub.o (no handwritten .inc).
 */
#include <stdint.h>
#include <stddef.h>
#ifndef SHUX_LSP_DIAG_PIPELINE_SIZES_FROM_X
...
#endif /* SHUX_LSP_DIAG_PIPELINE_SIZES_FROM_X */
