/* PLATFORM: WINDOWS leftover-PE — real asm_parser_emit_heavy_safe_helper +
 * asm_parser_func_is_thin_delegate. Twin of FROM_X. Class Z.
 * Stub was return -1 (false error: callers treat !=0 as fail). Link FIRST.
 */
#include <stdint.h>
#include <string.h>
