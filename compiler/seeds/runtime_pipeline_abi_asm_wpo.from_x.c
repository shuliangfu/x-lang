/* WAVE274 leftover gcc cold twin: asm WPO v0 DCE + PGO-Lite emit order.
 ...
 * EDGES 4096→8192. Twin of runtime_pipeline_abi.x asm_wpo_max_*.
 * wave741: FUNCS 2048→4096 (mega-EOF aliases + dummy pad≥2048 silent
 * truncate at exactly 2048 T, XLANG_DEBUG_PARSE skips=0 — emit-order cap,
 * not parser skip). EDGES 8192→16384 same ratio. PLATFORM: SHARED. */
#define ASM_WPO_MAX_FUNCS 4096
#define ASM_WPO_MAX_MODS 64
#define ASM_WPO_MAX_EDGES 16384
