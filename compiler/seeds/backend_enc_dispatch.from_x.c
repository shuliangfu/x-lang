 ...
 * Do not pass -DXLANG_BACKEND_ENC_DISPATCH_FROM_X: that empties the tail.
 * Keep default unwind: the linked object has __compact_unwind.
 * PLATFORM: SHARED.
 */
 ...
 * ta == 0 appends movq, movq, addsd, movq. The prototype above
...
/* w899: backend_enc_subsd_rax_rbx_arch is defined in
 * backend_enc_dispatch_thin.x. ta == 1 appends fmov/fsub/fmov.
 * ta == 0 appends movq, movq, subsd, movq. The prototype above
 * still names the symbol. Stays strong. PLATFORM: SHARED. */
...
/* w901: backend_enc_divsd_rax_rbx_arch is defined in
 * backend_enc_dispatch_thin.x. ta == 1 appends fmov/fdiv/fmov.
 ...
 * Stays strong.
 * w879: arch_x86_64_enc_enc_call_reg is defined in that .x too.
 * The prototype above still satisfies backend_enc_blr_arch. Stays strong.
 * w880: arch_x86_64_enc_enc_load_rax_rbx_disp32 is defined in that .x too.
 * The prototype above still satisfies backend_enc_ldr_xreg_xreg_imm_arch.
 * Stays strong.
