 ...
 *   xlang_host_is_linux + xlang_host_is_apple_aarch64 + labi_host_lit_count
 * Cap residual（mega rest 常驻）：
 *   xlang_host_is_linux_impl（#if __linux__）
 *   xlang_host_is_apple_aarch64_impl（#if __APPLE__ && __aarch64__）
