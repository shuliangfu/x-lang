...
/* PLATFORM: SHARED — cold-start aliases: bootstrap seed binary still emits process_shux_*
 * from -E preambles until bootstrap_xlangc is regenerated by renamed product compiler.
 * Authoritative names: process_xlang_*. Remove after seed binary refresh. */
