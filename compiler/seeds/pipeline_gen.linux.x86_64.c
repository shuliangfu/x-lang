...
struct parser_OneFuncResult { int ok; struct lexer_Lexer next_lex; uint8_t name[256]; int32_t name_len; int32_t num_params; int32_t num_generic_params; int32_t num_consts; int32_t num_lets; int has_if_expr; int if_cond_true; int32_t if_then_val; int32_t if_else_val; int32_t if_cond_expr_ref; int has_mul; int32_t mul_right_val; int has_binop; int32_t binop_right_val; int32_t binop_left_param_idx; int32_t binop_right_param_idx; int has_unary_neg; int32_t return_val; int has_call_expr; uint8_t call_callee_name[256]; int32_t call_callee_len; uint8_t return_var_name[256]; int32_t return_var_name_len; int32_t return_expr_ref; int has_final_expr; int has_explicit_return_kw; int32_t call_num_args; int32_t num_loops; int32_t num_for_loops; int32_t num_if_stmts; int32_t num_src_stmt_order; int32_t num_src_body_expr_stmts; int32_t func_return_type_ref; };
...
struct parser_ExternParseResult { struct lexer_Lexer next_lex; uint8_t name[256]; int32_t name_len; int32_t return_ty_ref; int32_t num_params; int32_t abi_kind; int32_t is_variadic; };
struct parser_TrySkipAllowResult { struct lexer_Lexer lex; int32_t skipped; uint8_t _pad[4]; };
struct parser_LibraryParseResult { int ok; uint8_t _pad[4]; struct lexer_Lexer next_lex; uint8_t name[256]; int32_t name_len; uint8_t _pad_tail[4]; };
struct parser_LibraryParseScanResult { int ok; uint8_t _pad[4]; struct lexer_Lexer next_lex; uint8_t name[256]; int32_t name_len; uint8_t param_name[256]; int32_t param_name_len; uint8_t param_type_name[256]; int32_t param_type_len; uint8_t field_name[256]; int32_t field_len; uint8_t _pad_tail[4]; uint8_t _pad_tail2[4]; };
...
struct platform_elf_ElfLabelEntry { uint8_t name[256]; int32_t name_len; int32_t offset; };
struct platform_elf_ElfPatchEntry { int32_t rel32_offset; uint8_t name[256]; int32_t name_len; int32_t patch_imm_bits; };
struct platform_elf_ElfRelocEntry { int32_t offset; int32_t name_len; };
struct platform_elf_ElfRelocSymName64 { uint8_t bytes[256]; };
struct platform_elf_ElfSymEntry { uint8_t name[256]; int32_t name_len; int32_t offset; int32_t sym_shndx; };
struct platform_elf_ElfCodegenCtx { int32_t code_len; struct platform_elf_ElfLabelEntry labels[16384]; int32_t num_labels; struct platform_elf_ElfPatchEntry patches[65536]; int32_t num_patches; struct platform_elf_ElfRelocEntry relocs[16384]; struct platform_elf_ElfRelocSymName64 reloc_sym_names[16384]; int32_t num_relocs; struct platform_elf_ElfSymEntry syms[16384]; int32_t num_syms; int32_t sym_name_len; int32_t e_machine; int32_t reloc_type_r_pc32; int32_t current_frame_size; int32_t macho_leading_underscore; int32_t code_hot_len; int32_t emit_hot; uint8_t code_data[8716288]; uint8_t code_hot_data[1048576]; uint8_t sym_name_data[131072]; };
struct asm_backend_AsmFuncCtx { int32_t frame_size; int32_t next_offset; int32_t num_locals; int32_t label_counter; struct ast_Module * module_ref; uint8_t loop_break_label_stack[512]; int32_t loop_break_len_stack[8]; uint8_t loop_continue_label_stack[512]; int32_t loop_continue_len_stack[8]; uint8_t break_label[128]; int32_t break_len; uint8_t continue_label[128]; int32_t continue_len; int32_t loop_label_depth; struct ast_PipelineDepCtx * dep_pipe; uint8_t tail_join_label[128]; int32_t tail_join_label_len; };
