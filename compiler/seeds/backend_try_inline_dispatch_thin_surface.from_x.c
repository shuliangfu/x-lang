 ...
 * G-02f backend_try_inline_dispatch_thin R2 mixed surface - isomorphic with src/asm/backend_try_inline_dispatch_thin.x
 * Product PREFER_X_O: xlang-c -E(.x) -> thin.o + ld -r with rest (seeds/backend_try_inline_dispatch_thin.from_x.c)
 * Prove: full.x vs this surface -> nm IDENTICAL (50 symbols)
 * Mode: mixed - 8 DIRECT compute + 42 thin+rest forwards to _impl
 * Cap residual: 42 extern bridges (37 *_impl + 5 pipeline_/asm_ctx_/backend_)
 * doc_anchor: none (.x has no doc_anchor).
 * Logic: 50 functions = 8 DIRECT compute
 *   (glue_align_up8_c, glue_is_vector_lane_scalar_binop_ko,
 *    glue_const_scalar_binop_eval_i32, asm_index_elem_byte_sz,
 *    asm_struct_lit_reserve_stack_bytes, pipeline_asm_struct_lit_reserve_stack_bytes_c,
 *    glue_try_inline_local_slot_off, glue_try_fold_func_return_operand_ref)
 *   + 42 thin+rest forwards to _impl (glue_enc_local_slot_ptr_or_addr_impl,
 *     glue_arch_emit_local_slot_ptr_or_addr_text_impl, glue_fold_func_return_operand_ref_module_impl,
 *     asm_array_lit_elem_byte_sz_impl, asm_array_lit_reserve_stack_bytes_impl,
 *     glue_asm_ctx_module_ref_c_impl, asm_local_var_slot_holds_indirect_ptr_impl,
 *     glue_try_expr_const_i32_impl, glue_module_func_index_by_name_impl,
 *     glue_module_named_type_has_struct_layout_impl, glue_type_ref_is_named_struct_layout_impl,
 *     glue_expr_is_func_param_at_impl, glue_struct_lit_field_index_by_name_impl,
 *     glue_try_array_lit_lane_const_i32_impl, glue_fold_func_returns_param0_index_const_impl,
 *     glue_const_struct_lit_field_can_inline_impl, glue_fold_func_returns_param01_scalar_binop_impl,
 *     glue_fold_func_returns_param_struct_lit_impl, glue_fold_func_returns_param01_vector_binop_impl,
 *     glue_call_is_zero_arg_default_alloc_impl, glue_dep_module_field_offset_by_name_impl,
 *     glue_fold_func_returns_const_struct_lit_impl, glue_emit_default_alloc_to_rbx_offset_impl,
 *     glue_inner_call_arg_for_field_access_impl, try_inline_wpo_const_scalar_binop_call_elf_impl,
 *     try_inline_x_plus_k_call_elf_impl, try_inline_param0_single_field_call_elf_impl,
 *     try_inline_wpo_const_vector_lane_of_binop_call_elf_impl, try_call_wpo_mono_symbol_elf_impl,
 *     glue_inline_var_field_access_offset_impl, try_inline_param0_field_sum_call_elf_impl,
 *     try_call_wpo_mono_vector_lane_of_binop_call_elf_impl, glue_struct_lit_field_init_param_index_impl,
 *     try_inline_struct_lit_return_call_to_slot_elf_impl, try_inline_const_struct_lit_return_call_to_slot_elf_impl,
 *     glue_call_lookup_callee_mod_fi_arena_impl, try_inline_var_field_sum_binop_elf_impl).
 * Regen: xlang_asm -E src/asm/backend_try_inline_dispatch_thin.x | filter DBG + polish prologue
 */
#include <stdint.h>
#include <stddef.h>
/* Forward declarations for all 50 surface functions (nm IDENTICAL targets). */
...
/* Cap residual: 37 _impl bridges (thin+rest forwards target these). */
...
/* Cap residual: 5 pipeline_/asm_ctx_/backend_ bridges (DIRECT compute target these). */
