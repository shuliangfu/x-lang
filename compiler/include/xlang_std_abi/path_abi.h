/**
 * xlang_std_abi/path_abi.h — std.path 与 codegen 生成 C 的 ABI 头文件（F-ZC Z9）
 *
 * 【职责】empty_len 宏转发；canonical 副本供 LANG-005。
 * 【codegen】runtime.c write_fs_path_map_error_abi_inline 内联写入生成 C。
 */
#ifndef XLANG_STD_ABI_PATH_ABI_H
#define XLANG_STD_ABI_PATH_ABI_H
...
#endif /* XLANG_STD_ABI_PATH_ABI_H */
