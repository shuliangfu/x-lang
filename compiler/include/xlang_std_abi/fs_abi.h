/**
 * xlang_std_abi/fs_abi.h — std.fs 与 codegen 生成 C 的 ABI 头文件（F-ZC Z9）
 *
 ...
 */
#ifndef XLANG_STD_ABI_FS_ABI_H
#define XLANG_STD_ABI_FS_ABI_H
...
/** 只读打开 path（NUL 结尾）；失败 -1。供 asm 跳过 std.fs emit 时链入 std_fs.o。 */
