/**
 * simd_vector_inline.h — M8-tail：SIMD 向量 intrinsic let-init 内联 C API（X 薄包装 bl 目标）。
 */
#ifndef XLANG_SIMD_VECTOR_INLINE_H
#define XLANG_SIMD_VECTOR_INLINE_H
...
#endif /* XLANG_SIMD_VECTOR_INLINE_H */
