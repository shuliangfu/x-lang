/**
 * _x_stubs2.c — verify-selfhost-stage2.sh 链接 xlang-x2 时的桩与转发
 *
 * Stage2 用 xlang-x 生成的 *_gen2.c / *_x2.o 与 seed 拓扑混合链接；本文件补齐：
 ...
 * - preprocess 名桥接
 *
 * 构建：verify-selfhost-stage2.sh 编译为 _x_stubs2.o；亦可在本地 cc -c 验证。
 */
#include <stdint.h>
#include <stddef.h>
#include <stdlib.h>
