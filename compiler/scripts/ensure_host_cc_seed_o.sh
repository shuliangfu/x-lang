...
ensure_catalog_family() {
  ...
  for o in $list; do
    [ -z "$o" ] && continue
    # w847/w863/w864/w865/w866/w867/w868/w869/w870/w871/w872/w873: seed-only cc drops the alias bodies that live in the .x.
    # PLATFORM: SHARED.
...
#   pipeline_expr_field_access_name_into mangled face, and the w873
#   pipeline_dep_ctx_ndep mangled face; eleven weakened)
...
ensure_x_frontend_link_alias_prefer() {
  ...
  if (
    ...
    log "x-frontend-link-alias $o <- pure-asm $xsrc + lexer/mangled rest (w873; type_kind_ord, func_export, import_binding, heap_redirect, import_path, field_name_len, field_base_ref, binop_left, binop_right, field_name_into, and dep_ctx_ndep faces are in the .x; field_name_len, field_base_ref, binop_left, binop_right, field_name_into, and dep_ctx_ndep stay weak)"
    rm -f "$thin" "$rest"
    return 0
  fi
...
try_ensure_r1_one() {
  ...
  # w847/w863/w864/w865/w866/w867/w868/w869/w870/w871/w872/w873: alias bodies that live in the .x are not in the seed.
