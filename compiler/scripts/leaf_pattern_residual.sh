...
#   wave897: B2 std_core hybrid product edges list→mk + multi-target FORCE thin (5)
#   wave898: RT_SEED_SLICE product edges multi-target FORCE thin try-heat (5)
#            (G.7 有则补全: RT_SEED_SLICE_OBJS in driver_seed_r_lists.mk; no second list)
#   wave899: R1_CORE_SEED product edges multi-target FORCE thin try-heat (5)
#            (G.7 有则补全: R1_CORE_SEED_OBJS in driver_seed_r_lists.mk; no second list)
#   wave900: R1_FRONTEND_GLUE product edges multi-target FORCE thin try-heat (3)
#            (G.7 有则补全: R1_FRONTEND_GLUE_OBJS in driver_seed_r_lists.mk; no second list)
#   wave901: R1_MAIN_RUNTIME product edges multi-target FORCE thin try-heat (7)
#            (G.7 有则补全: R1_MAIN_RUNTIME_OBJS in driver_seed_r_lists.mk; no second list)
#   wave902: R1_ALIAS_STUBS product edges multi-target FORCE thin try-heat (8)
#            (G.7 有则补全: R1_ALIAS_STUBS_OBJS in driver_seed_r_lists.mk; no second list)
#   wave903: R1_EXTRA_CFLAGS product edges multi-target FORCE thin try-heat (5)
...
#   wave910: GEN_C_TO_O (B4) product edges multi-target FORCE thin try-heat (5)
...
# wave897: B2 std/core hybrid product edges list→mk multi-target FORCE thin (make-graph only).
# Body authority remains ensure try-heat → try-std-core-prefer (wave780/790). NOT physical delete.
PHYS_DEL_B2_STD_CORE_LIST_MK=1
PHYS_DEL_B2_STD_CORE_LIST_MK_WAVE=wave897
PHYS_DEL_B2_STD_CORE_LIST_MK_COUNT=5
PHYS_DEL_B2_STD_CORE_LIST_MK_VIA=mk_std_core_hybrid_product_objs_multi_target_thin
PHYS_DEL_B2_STD_CORE_LIST_MK_NOTE=list_to_mk_multi_target_force_thin_edges_remain
SWALLOWED_B2_STD_CORE_LIST_MK=1
B2_STD_CORE_LIST_MK_SWALLOWED=1
B2_STD_CORE_LIST_MK_WAVE=wave897
# wave898: RT_SEED_SLICE product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains RT_SEED_SLICE_OBJS in mk/driver_seed_r_lists.mk
# (wave748/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_RT_SEED_SLICE_LIST_MK=1
PHYS_DEL_RT_SEED_SLICE_LIST_MK_WAVE=wave898
PHYS_DEL_RT_SEED_SLICE_LIST_MK_COUNT=5
PHYS_DEL_RT_SEED_SLICE_LIST_MK_VIA=mk_rt_seed_slice_objs_multi_target_thin
PHYS_DEL_RT_SEED_SLICE_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
SWALLOWED_RT_SEED_SLICE_LIST_MK=1
RT_SEED_SLICE_LIST_MK_SWALLOWED=1
RT_SEED_SLICE_LIST_MK_WAVE=wave898
# wave899: R1_CORE_SEED product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains R1_CORE_SEED_OBJS in mk/driver_seed_r_lists.mk
# (wave749/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_R1_CORE_SEED_LIST_MK=1
PHYS_DEL_R1_CORE_SEED_LIST_MK_WAVE=wave899
PHYS_DEL_R1_CORE_SEED_LIST_MK_COUNT=5
PHYS_DEL_R1_CORE_SEED_LIST_MK_VIA=mk_r1_core_seed_objs_multi_target_thin
PHYS_DEL_R1_CORE_SEED_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
SWALLOWED_R1_CORE_SEED_LIST_MK=1
R1_CORE_SEED_LIST_MK_SWALLOWED=1
R1_CORE_SEED_LIST_MK_WAVE=wave899
# wave900: R1_FRONTEND_GLUE product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains R1_FRONTEND_GLUE_OBJS in mk/driver_seed_r_lists.mk
# (wave750/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK=1
PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_WAVE=wave900
PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_COUNT=3
PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_VIA=mk_r1_frontend_glue_objs_multi_target_thin
PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
SWALLOWED_R1_FRONTEND_GLUE_LIST_MK=1
R1_FRONTEND_GLUE_LIST_MK_SWALLOWED=1
R1_FRONTEND_GLUE_LIST_MK_WAVE=wave900
# wave901: R1_MAIN_RUNTIME product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains R1_MAIN_RUNTIME_OBJS in mk/driver_seed_r_lists.mk
# (wave751/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK=1
PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_WAVE=wave901
PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_COUNT=7
PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_VIA=mk_r1_main_runtime_objs_multi_target_thin
PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
SWALLOWED_R1_MAIN_RUNTIME_LIST_MK=1
R1_MAIN_RUNTIME_LIST_MK_SWALLOWED=1
R1_MAIN_RUNTIME_LIST_MK_WAVE=wave901
# wave902: R1_ALIAS_STUBS product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains R1_ALIAS_STUBS_OBJS in mk/driver_seed_r_lists.mk
# (wave752/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_R1_ALIAS_STUBS_LIST_MK=1
PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_WAVE=wave902
PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_COUNT=8
PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_VIA=mk_r1_alias_stubs_objs_multi_target_thin
PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
SWALLOWED_R1_ALIAS_STUBS_LIST_MK=1
R1_ALIAS_STUBS_LIST_MK_SWALLOWED=1
R1_ALIAS_STUBS_LIST_MK_WAVE=wave902
# wave903: R1_EXTRA_CFLAGS product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains R1_EXTRA_CFLAGS_OBJS in mk/driver_seed_r_lists.mk
# (wave753/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK=1
PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_WAVE=wave903
PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_COUNT=5
PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_VIA=mk_r1_extra_cflags_objs_multi_target_thin
PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
SWALLOWED_R1_EXTRA_CFLAGS_LIST_MK=1
R1_EXTRA_CFLAGS_LIST_MK_SWALLOWED=1
R1_EXTRA_CFLAGS_LIST_MK_WAVE=wave903
# wave904: R1_MISC_BASENAME product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority remains R1_MISC_BASENAME_OBJS in mk/driver_seed_r_lists.mk
# (wave754/788; no second product mk). Body = ensure try-heat. NOT physical delete.
PHYS_DEL_R1_MISC_BASENAME_LIST_MK=1
PHYS_DEL_R1_MISC_BASENAME_LIST_MK_WAVE=wave904
PHYS_DEL_R1_MISC_BASENAME_LIST_MK_COUNT=9
PHYS_DEL_R1_MISC_BASENAME_LIST_MK_VIA=mk_r1_misc_basename_objs_multi_target_thin
PHYS_DEL_R1_MISC_BASENAME_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
...
# wave910: GEN_C_TO_O (B4) product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority = GEN_C_TO_O_SEED_OBJS in mk/driver_seed_r_lists.mk
# (wave782 try-gen-c-to-o map lexer/ast_gen2/driver/preprocess/stubs; no second body).
...
# wave911: B3_LSP_SAT product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority = B3_LSP_SAT_SEED_OBJS in mk/driver_seed_r_lists.mk
# (wave781 try-lsp-sat-prefer map sizes_nostub/stubs_no_c; no second body).
# Body = ensure try-heat → try-lsp-sat-prefer. NOT physical delete.
PHYS_DEL_B3_LSP_SAT_LIST_MK=1
PHYS_DEL_B3_LSP_SAT_LIST_MK_WAVE=wave911
PHYS_DEL_B3_LSP_SAT_LIST_MK_COUNT=2
PHYS_DEL_B3_LSP_SAT_LIST_MK_VIA=mk_b3_lsp_sat_seed_objs_multi_target_thin
PHYS_DEL_B3_LSP_SAT_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
...
# wave913: R2 CRT0 product edges multi-target FORCE thin try-heat (make-graph only).
# G.7 有则补全: list authority = DRIVER_SEED_CRT0_OBJS in mk/driver_seed_r_lists.mk
# (migrated from export_lists; try-r2 body; COUNT=6).
PHYS_DEL_R2_CRT0_LIST_MK=1
PHYS_DEL_R2_CRT0_LIST_MK_WAVE=wave913
PHYS_DEL_R2_CRT0_LIST_MK_COUNT=6
PHYS_DEL_R2_CRT0_LIST_MK_VIA=mk_driver_seed_crt0_objs_multi_target_thin
PHYS_DEL_R2_CRT0_LIST_MK_NOTE=list_multi_target_force_thin_edges_remain
...
# paths (25; excludes $(PIPELINE_ASM_X_DEPS) wildcard token) = COUNT=34.
# 8.3.1: +15 #include slices (ctfe/assign/coerce_init/method_call/check_block/region_assign/asm_emit_unary/asm_emit_as/asm_emit_return/asm_emit_logand/asm_emit_block_body/asm_emit_block_if_stmt/asm_emit_block_inits/field_access/soa) into PIPELINE_X_DEPS STALE.
...
PHYS_DEL_B7B_SOURCE_DEPS_LIST_COUNT=34
...
B7B_SOURCE_DEPS_LIST_WAVE=wave823/8.3.1
...
# cold path 100% shell, 0 make calls).
...
PHYS_DEL_PREFLIGHT_B2_STD_CORE_LIST_MK=1
PHYS_DEL_PREFLIGHT_RT_SEED_SLICE_LIST_MK=1
PHYS_DEL_PREFLIGHT_R1_CORE_SEED_LIST_MK=1
PHYS_DEL_PREFLIGHT_R1_FRONTEND_GLUE_LIST_MK=1
PHYS_DEL_PREFLIGHT_R1_MAIN_RUNTIME_LIST_MK=1
...
if [ ! -f "$DOC_REL" ]; then
  ...
  if ! grep -qE 'wave897|B2 std_core hybrid|STD_CORE_HYBRID_PRODUCT_OBJS|std_core hybrid list' "$DOC_REL"; then
    bad "$DOC_REL must document wave897 B2 std_core hybrid product edges list→mk"
  fi
  if ! grep -qE 'wave898|RT_SEED_SLICE.*multi|RT_SEED_SLICE_OBJS|rt_seed_slice list' "$DOC_REL"; then
    bad "$DOC_REL must document wave898 RT_SEED_SLICE multi-target FORCE thin"
  fi
  if ! grep -qE 'wave899|R1_CORE_SEED.*multi|R1_CORE_SEED_OBJS|r1_core_seed list|core.seed multi' "$DOC_REL"; then
    bad "$DOC_REL must document wave899 R1_CORE_SEED multi-target FORCE thin"
  fi
  if ! grep -qE 'wave900|R1_FRONTEND_GLUE.*multi|R1_FRONTEND_GLUE_OBJS|r1_frontend_glue list|frontend.glue multi' "$DOC_REL"; then
    bad "$DOC_REL must document wave900 R1_FRONTEND_GLUE multi-target FORCE thin"
  fi
  if ! grep -qE 'wave901|R1_MAIN_RUNTIME.*multi|R1_MAIN_RUNTIME_OBJS|r1_main_runtime list|main.runtime multi' "$DOC_REL"; then
    bad "$DOC_REL must document wave901 R1_MAIN_RUNTIME multi-target FORCE thin"
  fi
  if ! grep -qE 'wave902|R1_ALIAS_STUBS.*multi|R1_ALIAS_STUBS_OBJS|r1_alias_stubs list|alias.stubs multi' "$DOC_REL"; then
    bad "$DOC_REL must document wave902 R1_ALIAS_STUBS multi-target FORCE thin"
  fi
  if ! grep -qE 'wave903|R1_EXTRA_CFLAGS.*multi|R1_EXTRA_CFLAGS_OBJS|r1_extra_cflags list|extra.cflags multi' "$DOC_REL"; then
    bad "$DOC_REL must document wave903 R1_EXTRA_CFLAGS multi-target FORCE thin"
  fi
  ...
  if ! grep -qE 'wave910|GEN_C_TO_O.*multi|GEN_C_TO_O_SEED_OBJS|gen.c_to_o multi|B4.*multi|gen_c_to_o multi' "$DOC_REL"; then
    bad "$DOC_REL must document wave910 GEN_C_TO_O multi-target FORCE thin"
  fi
...
if ! grep -q 'PHYS_DEL_B2_STD_CORE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B2_STD_CORE_LIST_MK=1 (wave897)"
fi
if ! grep -q 'PHYS_DEL_B2_STD_CORE_LIST_MK_WAVE=wave897' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B2_STD_CORE_LIST_MK_WAVE=wave897"
fi
if ! grep -q 'PHYS_DEL_B2_STD_CORE_LIST_MK_COUNT=5' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B2_STD_CORE_LIST_MK_COUNT=5 (wave897)"
fi
if ! grep -q 'SWALLOWED_B2_STD_CORE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_B2_STD_CORE_LIST_MK=1 (wave897)"
fi
if ! grep -q 'PHYS_DEL_PREFLIGHT_B2_STD_CORE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_B2_STD_CORE_LIST_MK=1 (wave897)"
fi
if ! grep -q 'PHYS_DEL_RT_SEED_SLICE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_RT_SEED_SLICE_LIST_MK=1 (wave898)"
fi
if ! grep -q 'PHYS_DEL_RT_SEED_SLICE_LIST_MK_WAVE=wave898' <<<"$_out"; then
  bad "dump must set PHYS_DEL_RT_SEED_SLICE_LIST_MK_WAVE=wave898"
fi
if ! grep -q 'PHYS_DEL_RT_SEED_SLICE_LIST_MK_COUNT=5' <<<"$_out"; then
  bad "dump must set PHYS_DEL_RT_SEED_SLICE_LIST_MK_COUNT=5 (wave898)"
fi
if ! grep -q 'SWALLOWED_RT_SEED_SLICE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_RT_SEED_SLICE_LIST_MK=1 (wave898)"
fi
if ! grep -q 'PHYS_DEL_PREFLIGHT_RT_SEED_SLICE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_RT_SEED_SLICE_LIST_MK=1 (wave898)"
fi
if ! grep -q 'PHYS_DEL_R1_CORE_SEED_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_CORE_SEED_LIST_MK=1 (wave899)"
fi
...
if ! grep -q 'PHYS_DEL_PREFLIGHT_R1_CORE_SEED_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_R1_CORE_SEED_LIST_MK=1 (wave899)"
fi
if ! grep -q 'PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK=1 (wave900)"
fi
if ! grep -q 'PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_WAVE=wave900' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_WAVE=wave900"
fi
if ! grep -q 'PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_COUNT=3' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_FRONTEND_GLUE_LIST_MK_COUNT=3 (wave900)"
fi
if ! grep -q 'SWALLOWED_R1_FRONTEND_GLUE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_R1_FRONTEND_GLUE_LIST_MK=1 (wave900)"
fi
if ! grep -q 'PHYS_DEL_PREFLIGHT_R1_FRONTEND_GLUE_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_R1_FRONTEND_GLUE_LIST_MK=1 (wave900)"
fi
if ! grep -q 'PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK=1 (wave901)"
fi
if ! grep -q 'PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_WAVE=wave901' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_WAVE=wave901"
fi
if ! grep -q 'PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_COUNT=7' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_MAIN_RUNTIME_LIST_MK_COUNT=7 (wave901)"
fi
if ! grep -q 'SWALLOWED_R1_MAIN_RUNTIME_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_R1_MAIN_RUNTIME_LIST_MK=1 (wave901)"
fi
if ! grep -q 'PHYS_DEL_PREFLIGHT_R1_MAIN_RUNTIME_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_R1_MAIN_RUNTIME_LIST_MK=1 (wave901)"
fi
if ! grep -q 'PHYS_DEL_R1_ALIAS_STUBS_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_ALIAS_STUBS_LIST_MK=1 (wave902)"
fi
if ! grep -q 'PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_WAVE=wave902' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_WAVE=wave902"
fi
if ! grep -q 'PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_COUNT=8' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_ALIAS_STUBS_LIST_MK_COUNT=8 (wave902)"
fi
if ! grep -q 'SWALLOWED_R1_ALIAS_STUBS_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_R1_ALIAS_STUBS_LIST_MK=1 (wave902)"
fi
if ! grep -q 'PHYS_DEL_PREFLIGHT_R1_ALIAS_STUBS_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_R1_ALIAS_STUBS_LIST_MK=1 (wave902)"
fi
if ! grep -q 'PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK=1 (wave903)"
fi
if ! grep -q 'PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_WAVE=wave903' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_WAVE=wave903"
fi
if ! grep -q 'PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_COUNT=5' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_EXTRA_CFLAGS_LIST_MK_COUNT=5 (wave903)"
fi
if ! grep -q 'SWALLOWED_R1_EXTRA_CFLAGS_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_R1_EXTRA_CFLAGS_LIST_MK=1 (wave903)"
fi
if ! grep -q 'PHYS_DEL_PREFLIGHT_R1_EXTRA_CFLAGS_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_R1_EXTRA_CFLAGS_LIST_MK=1 (wave903)"
fi
if ! grep -q 'PHYS_DEL_R1_MISC_BASENAME_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_MISC_BASENAME_LIST_MK=1 (wave904)"
fi
if ! grep -q 'PHYS_DEL_R1_MISC_BASENAME_LIST_MK_WAVE=wave904' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_MISC_BASENAME_LIST_MK_WAVE=wave904"
fi
if ! grep -q 'PHYS_DEL_R1_MISC_BASENAME_LIST_MK_COUNT=9' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R1_MISC_BASENAME_LIST_MK_COUNT=9 (wave904)"
fi
if ! grep -q 'SWALLOWED_R1_MISC_BASENAME_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_R1_MISC_BASENAME_LIST_MK=1 (wave904)"
fi
...
if ! grep -q 'PHYS_DEL_GEN_C_TO_O_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_GEN_C_TO_O_LIST_MK=1 (wave910)"
fi
...
if ! grep -q 'PHYS_DEL_PREFLIGHT_GEN_C_TO_O_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_PREFLIGHT_GEN_C_TO_O_LIST_MK=1 (wave910)"
fi
if ! grep -q 'PHYS_DEL_B3_LSP_SAT_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B3_LSP_SAT_LIST_MK=1 (wave911)"
fi
if ! grep -q 'PHYS_DEL_B3_LSP_SAT_LIST_MK_WAVE=wave911' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B3_LSP_SAT_LIST_MK_WAVE=wave911"
fi
if ! grep -q 'PHYS_DEL_B3_LSP_SAT_LIST_MK_COUNT=2' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B3_LSP_SAT_LIST_MK_COUNT=2 (wave911)"
fi
if ! grep -q 'SWALLOWED_B3_LSP_SAT_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_B3_LSP_SAT_LIST_MK=1 (wave911)"
fi
...
if ! grep -q 'PHYS_DEL_R2_CRT0_LIST_MK=1' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R2_CRT0_LIST_MK=1 (wave913)"
fi
if ! grep -q 'PHYS_DEL_R2_CRT0_LIST_MK_WAVE=wave913' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R2_CRT0_LIST_MK_WAVE=wave913"
fi
if ! grep -q 'PHYS_DEL_R2_CRT0_LIST_MK_COUNT=6' <<<"$_out"; then
  bad "dump must set PHYS_DEL_R2_CRT0_LIST_MK_COUNT=6 (wave913)"
fi
if ! grep -q 'SWALLOWED_R2_CRT0_LIST_MK=1' <<<"$_out"; then
  bad "dump must set SWALLOWED_R2_CRT0_LIST_MK=1 (wave913)"
fi
...
if ! grep -q 'PHYS_DEL_B7B_SOURCE_DEPS_LIST_COUNT=34' <<<"$_out"; then
  bad "dump must set PHYS_DEL_B7B_SOURCE_DEPS_LIST_COUNT=34 (8.3.1 slices)"
fi
...
# wave897: B2 std/core hybrid product edges list→mk multi-target FORCE thin try-heat.
...
_sc_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^STD_CORE_HYBRID_PRODUCT_OBJS[[:space:]]*=/ { inlist=1 }
    inlist {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
      if ($0 !~ /\\[[:space:]]*$/ && $0 !~ /^STD_CORE_HYBRID_PRODUCT_OBJS/) inlist=0
    }
    END { print c+0 }
  ' "$_SC_MK"
)
if [ "${_sc_list_n:-0}" -ne 5 ]; then
...
while IFS= read -r _sc; do
  ...
  if awk -v leaf="$_sc" '
    $0 ~ ("^" leaf ":") { want=1; next }
    want && /^[^#[:space:]]/ { want=0 }
    want && /ensure_host_cc_seed_o\.sh/ && /try-heat|try-std-core-prefer/ { found=1 }
    END { exit found ? 0 : 1 }
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_sc" "$_SC_MK"     && grep -qE '\$\(STD_CORE_HYBRID_PRODUCT_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_sc" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _sc; do
  [ -z "$_sc" ] && continue
  case "$_sc" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_sc}:" "$MF" 2>/dev/null; then
    _sc_indiv=$((_sc_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave898: RT_SEED_SLICE product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_RT_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_RT_MK" ] || _RT_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_RT_MK" ]; then
  bad "missing $_RT_MK (wave898 RT_SEED_SLICE list authority)"
fi
if ! grep -qE '^RT_SEED_SLICE_OBJS\s*=' "$_RT_MK"; then
  bad "$_RT_MK must define RT_SEED_SLICE_OBJS (wave748/788/898)"
fi
_rt_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^RT_SEED_SLICE_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
      # single-line list (wave788 form)
      next
    }
    END { print c+0 }
  ' "$_RT_MK"
)
if [ "${_rt_list_n:-0}" -ne 5 ]; then
...
while IFS= read -r _rt; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_rt" "$_RT_MK" \
    && grep -qE '\$\(RT_SEED_SLICE_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_rt" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _rt; do
  [ -z "$_rt" ] && continue
  case "$_rt" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_rt}:" "$MF" 2>/dev/null; then
    _rt_indiv=$((_rt_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave899: R1_CORE_SEED product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_R1CS_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_R1CS_MK" ] || _R1CS_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_R1CS_MK" ]; then
  bad "missing $_R1CS_MK (wave899 R1_CORE_SEED list authority)"
fi
if ! grep -qE '^R1_CORE_SEED_OBJS\s*=' "$_R1CS_MK"; then
  bad "$_R1CS_MK must define R1_CORE_SEED_OBJS (wave749/788/899)"
fi
_r1cs_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^R1_CORE_SEED_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _r1cs; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_r1cs" "$_R1CS_MK" \
    && grep -qE '\$\(R1_CORE_SEED_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_r1cs" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _r1cs; do
  [ -z "$_r1cs" ] && continue
  case "$_r1cs" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_r1cs}:" "$MF" 2>/dev/null; then
    _r1cs_indiv=$((_r1cs_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave900: R1_FRONTEND_GLUE product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_R1FG_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_R1FG_MK" ] || _R1FG_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_R1FG_MK" ]; then
  bad "missing $_R1FG_MK (wave900 R1_FRONTEND_GLUE list authority)"
fi
if ! grep -qE '^R1_FRONTEND_GLUE_OBJS\s*=' "$_R1FG_MK"; then
  bad "$_R1FG_MK must define R1_FRONTEND_GLUE_OBJS (wave750/788/900)"
fi
_r1fg_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^R1_FRONTEND_GLUE_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _r1fg; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_r1fg" "$_R1FG_MK" \
    && grep -qE '\$\(R1_FRONTEND_GLUE_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_r1fg" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _r1fg; do
  [ -z "$_r1fg" ] && continue
  case "$_r1fg" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_r1fg}:" "$MF" 2>/dev/null; then
    _r1fg_indiv=$((_r1fg_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave901: R1_MAIN_RUNTIME product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_R1MR_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_R1MR_MK" ] || _R1MR_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_R1MR_MK" ]; then
  bad "missing $_R1MR_MK (wave901 R1_MAIN_RUNTIME list authority)"
fi
if ! grep -qE '^R1_MAIN_RUNTIME_OBJS\s*=' "$_R1MR_MK"; then
  bad "$_R1MR_MK must define R1_MAIN_RUNTIME_OBJS (wave751/788/901)"
fi
_r1mr_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^R1_MAIN_RUNTIME_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _r1mr; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_r1mr" "$_R1MR_MK" \
    && grep -qE '\$\(R1_MAIN_RUNTIME_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_r1mr" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _r1mr; do
  [ -z "$_r1mr" ] && continue
  case "$_r1mr" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_r1mr}:" "$MF" 2>/dev/null; then
    _r1mr_indiv=$((_r1mr_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave902: R1_ALIAS_STUBS product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_R1AS_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_R1AS_MK" ] || _R1AS_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_R1AS_MK" ]; then
  bad "missing $_R1AS_MK (wave902 R1_ALIAS_STUBS list authority)"
fi
if ! grep -qE '^R1_ALIAS_STUBS_OBJS\s*=' "$_R1AS_MK"; then
  bad "$_R1AS_MK must define R1_ALIAS_STUBS_OBJS (wave752/788/902)"
fi
_r1as_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^R1_ALIAS_STUBS_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _r1as; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_r1as" "$_R1AS_MK" \
    && grep -qE '\$\(R1_ALIAS_STUBS_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_r1as" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _r1as; do
  [ -z "$_r1as" ] && continue
  case "$_r1as" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_r1as}:" "$MF" 2>/dev/null; then
    _r1as_indiv=$((_r1as_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave903: R1_EXTRA_CFLAGS product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_R1EC_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_R1EC_MK" ] || _R1EC_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_R1EC_MK" ]; then
  bad "missing $_R1EC_MK (wave903 R1_EXTRA_CFLAGS list authority)"
fi
if ! grep -qE '^R1_EXTRA_CFLAGS_OBJS\s*=' "$_R1EC_MK"; then
  bad "$_R1EC_MK must define R1_EXTRA_CFLAGS_OBJS (wave753/788/903)"
fi
_r1ec_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^R1_EXTRA_CFLAGS_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _r1ec; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_r1ec" "$_R1EC_MK" \
    && grep -qE '\$\(R1_EXTRA_CFLAGS_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_r1ec" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _r1ec; do
  [ -z "$_r1ec" ] && continue
  case "$_r1ec" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_r1ec}:" "$MF" 2>/dev/null; then
    _r1ec_indiv=$((_r1ec_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave904: R1_MISC_BASENAME product edges multi-target FORCE thin try-heat (G.7 有则补全 list).
_R1MB_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_R1MB_MK" ] || _R1MB_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_R1MB_MK" ]; then
  bad "missing $_R1MB_MK (wave904 R1_MISC_BASENAME list authority)"
fi
if ! grep -qE '^R1_MISC_BASENAME_OBJS\s*=' "$_R1MB_MK"; then
  bad "$_R1MB_MK must define R1_MISC_BASENAME_OBJS (wave754/788/904)"
fi
_r1mb_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^R1_MISC_BASENAME_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _r1mb; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_r1mb" "$_R1MB_MK" \
    && grep -qE '\$\(R1_MISC_BASENAME_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_r1mb" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _r1mb; do
  [ -z "$_r1mb" ] && continue
  case "$_r1mb" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_r1mb}:" "$MF" 2>/dev/null; then
    _r1mb_indiv=$((_r1mb_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave910: GEN_C_TO_O (B4) product edges multi-target FORCE thin try-heat (G.7 list authority).
_GCTO_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_GCTO_MK" ] || _GCTO_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_GCTO_MK" ]; then
  bad "missing $_GCTO_MK (wave910 GEN_C_TO_O list authority)"
fi
if ! grep -qE '^GEN_C_TO_O_SEED_OBJS\s*=' "$_GCTO_MK"; then
  bad "$_GCTO_MK must define GEN_C_TO_O_SEED_OBJS (wave782/910)"
fi
_gcto_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^GEN_C_TO_O_SEED_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _gcto; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_gcto" "$_GCTO_MK" \
    && grep -qE '\$\(GEN_C_TO_O_SEED_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_gcto" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _gcto; do
  [ -z "$_gcto" ] && continue
  case "$_gcto" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_gcto}:" "$MF" 2>/dev/null; then
    _gcto_indiv=$((_gcto_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave911: B3_LSP_SAT product edges multi-target FORCE thin try-heat (G.7 list authority).
_B3_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_B3_MK" ] || _B3_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_B3_MK" ]; then
  bad "missing $_B3_MK (wave911 B3_LSP_SAT list authority)"
fi
if ! grep -qE '^B3_LSP_SAT_SEED_OBJS\s*=' "$_B3_MK"; then
  bad "$_B3_MK must define B3_LSP_SAT_SEED_OBJS (wave781/911)"
fi
_b3_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^B3_LSP_SAT_SEED_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _b3; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_b3" "$_B3_MK" \
    && grep -qE '\$\(B3_LSP_SAT_SEED_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_b3" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _b3; do
  [ -z "$_b3" ] && continue
  case "$_b3" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_b3}:" "$MF" 2>/dev/null; then
    _b3_indiv=$((_b3_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# wave913: R2 CRT0 product edges multi-target FORCE thin try-heat (G.7 list authority).
_CRT0_MK="compiler/mk/driver_seed_r_lists.mk"
[ -f "$_CRT0_MK" ] || _CRT0_MK="mk/driver_seed_r_lists.mk"
if [ ! -f "$_CRT0_MK" ]; then
  bad "missing $_CRT0_MK (wave913 R2 CRT0 list authority)"
fi
if ! grep -qE '^DRIVER_SEED_CRT0_OBJS\s*=' "$_CRT0_MK"; then
  bad "$_CRT0_MK must define DRIVER_SEED_CRT0_OBJS (wave762/913)"
fi
# export_lists must not re-assign (G.7 single literal after migrate)
_CRT0_EXP="compiler/mk/driver_seed_export_lists.mk"
[ -f "$_CRT0_EXP" ] || _CRT0_EXP="mk/driver_seed_export_lists.mk"
if [ -f "$_CRT0_EXP" ] && grep -qE '^DRIVER_SEED_CRT0_OBJS\s*=' "$_CRT0_EXP"; then
  bad "$_CRT0_EXP must not re-assign DRIVER_SEED_CRT0_OBJS (wave913 list authority = r_lists)"
fi
_crt0_list_n=$(
  awk '
    /^[[:space:]]*#/ { next }
    /^DRIVER_SEED_CRT0_OBJS[[:space:]]*=/ {
      line=$0
      sub(/#.*/,"",line)
      n=split(line, a, /[[:space:]\\]+/)
      for (i=1;i<=n;i++) if (a[i] ~ /\.o$/) c++
...
while IFS= read -r _c0; do
  ...
  ' "$MF" 2>/dev/null; then
    _ok_t=1
  elif grep -qF "$_c0" "$_CRT0_MK" \
    && grep -qE '\$\(DRIVER_SEED_CRT0_OBJS\):[[:space:]]*FORCE' "$MF"; then
    _ok_t=1
  fi
  if awk -v leaf="$_c0" '
    $0 ~ ("^" leaf ":") {
...
while IFS= read -r _c0; do
  [ -z "$_c0" ] && continue
  case "$_c0" in *.o) ;; *) continue ;; esac
  if grep -qE "^${_c0}:" "$MF" 2>/dev/null; then
    _crt0_indiv=$((_crt0_indiv + 1))
  fi
done < <(
  awk '
    /^[[:space:]]*#/ { next }
...
# Fixed multi-token authority COUNT=34 (8.3.1: was 33; +1 asm_emit_block_inits slice):
#   SRCS 4 + MAIN_X_DEPS 4 + PREPROCESS_X_DEPS 1 + PIPELINE_X_DEPS fixed paths 25
...
_xsd_n=$(awk '
  ...
  END { print t+0 }
' "$_XSD_MK")
if [ "${_xsd_n:-0}" -ne 34 ]; then
  bad "8.3.1 expected SOURCE_DEPS fixed multi-token count 34 in mk, got ${_xsd_n:-0}"
fi
...
# wave897–902: multi-target collapses N leaves → 1 try-heat recipe line; expand
# logical leaf count so wave862 honesty floor (>=100) stays valid (not physical delete).
...
if grep -qE '\$\(R1_MAIN_RUNTIME_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _th_recipe_n=$((_th_recipe_n + 6))
fi
# wave902: multi-target collapses 8 ALIAS_STUBS leaves → 1 rule; logical expand +7.
if grep -qE '\$\(R1_ALIAS_STUBS_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _th_recipe_n=$((_th_recipe_n + 7))
fi
# wave903: multi-target collapses 5 EXTRA_CFLAGS leaves → 1 rule; logical expand +4.
if grep -qE '\$\(R1_EXTRA_CFLAGS_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _th_recipe_n=$((_th_recipe_n + 4))
fi
# wave904: multi-target collapses 9 MISC_BASENAME leaves → 1 rule; logical expand +8.
...
# wave910: multi-target collapses 5 GEN_C_TO_O leaves → 1 rule; logical expand +4.
if grep -qE '\$\(GEN_C_TO_O_SEED_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _th_recipe_n=$((_th_recipe_n + 4))
fi
# wave911: multi-target collapses 2 B3_LSP_SAT leaves → 1 rule; logical expand +1.
...
# wave913: multi-target collapses 6 R2 CRT0 leaves → 1 rule; logical expand +5.
...
# wave902: multi-target collapses 8 ALIAS_STUBS leaves → 1 @bash line; logical expand +7
# so wave890 honesty floor (>=200) stays valid (not physical delete).
if grep -qE '\$\(R1_ALIAS_STUBS_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _bash_thin_n=$((_bash_thin_n + 7))
fi
# wave903: multi-target collapses 5 EXTRA_CFLAGS leaves → 1 @bash line; logical expand +4.
if grep -qE '\$\(R1_EXTRA_CFLAGS_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _bash_thin_n=$((_bash_thin_n + 4))
fi
# wave904: multi-target collapses 9 MISC_BASENAME leaves → 1 @bash line; logical expand +8.
if grep -qE '\$\(R1_MISC_BASENAME_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
...
# wave910: multi-target collapses 5 GEN_C_TO_O leaves → 1 @bash line; logical expand +4.
if grep -qE '\$\(GEN_C_TO_O_SEED_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
  _bash_thin_n=$((_bash_thin_n + 4))
fi
# wave911: multi-target collapses 2 B3_LSP_SAT leaves → 1 @bash line; logical expand +1.
if grep -qE '\$\(B3_LSP_SAT_SEED_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
...
# wave913: multi-target collapses 6 R2 CRT0 leaves → 1 @bash line; logical expand +5.
if grep -qE '\$\(DRIVER_SEED_CRT0_OBJS\):[[:space:]]*FORCE' "$MF" 2>/dev/null; then
...
if [ -f "$MF" ]; then
  ...
  # wave797 inventory = 113 logical FORCE+try-heat leaves (source-prereq closed).
  # wave897: B2 multi-target $(STD_CORE_HYBRID_PRODUCT_OBJS) is 1 rule line for 5
  # logical leaves — expand rule-line count by +4 so honesty stays 113.
  # wave898: RT_SEED_SLICE multi-target $(RT_SEED_SLICE_OBJS) is 1 rule for 5
  # logical leaves — expand +4 likewise.
  # wave899: R1_CORE_SEED multi-target $(R1_CORE_SEED_OBJS) is 1 rule for 5
  # logical leaves — expand +4 likewise.
  _force_n=$(grep -cE '^[A-Za-z0-9_./$()].*: FORCE scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null || true)
  _force_n=${_force_n:-0}
  if grep -qE '\$\(STD_CORE_HYBRID_PRODUCT_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 4))
  fi
  if grep -qE '\$\(RT_SEED_SLICE_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 4))
  fi
  if grep -qE '\$\(R1_CORE_SEED_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 4))
  fi
  # wave900: multi-target collapses 3 FRONTEND_GLUE leaves → 1 rule; logical expand +2.
  if grep -qE '\$\(R1_FRONTEND_GLUE_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 2))
  fi
  # wave901: multi-target collapses 7 MAIN_RUNTIME leaves → 1 rule; logical expand +6.
  if grep -qE '\$\(R1_MAIN_RUNTIME_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 6))
  fi
  # wave902: multi-target collapses 8 ALIAS_STUBS leaves → 1 rule; logical expand +7.
  if grep -qE '\$\(R1_ALIAS_STUBS_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 7))
  fi
  # wave903: multi-target collapses 5 EXTRA_CFLAGS leaves → 1 rule; logical expand +4.
  if grep -qE '\$\(R1_EXTRA_CFLAGS_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 4))
  fi
  # wave904: multi-target collapses 9 MISC_BASENAME leaves → 1 rule; logical expand +8.
  ...
  # wave910: multi-target collapses 5 GEN_C_TO_O leaves → 1 rule; logical expand +4.
  if grep -qE '\$\(GEN_C_TO_O_SEED_OBJS\):[[:space:]]*FORCE[[:space:]]+scripts/ensure_host_cc_seed_o\.sh' "$MF" 2>/dev/null; then
    _force_n=$((_force_n + 4))
  fi
  # wave911: multi-target collapses 2 B3_LSP_SAT leaves → 1 rule; logical expand +1.
