...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave167 pure: cfg peak+color entry; residual interf BSS+simulate/index-scratch)|2150|present"
