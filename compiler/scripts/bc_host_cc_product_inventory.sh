...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave162 pure: break/continue ELF; residual binop-cache/note/Chaitin/index-scratch)|2410|present"
