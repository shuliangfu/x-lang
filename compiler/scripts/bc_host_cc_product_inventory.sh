...
dump_rows() {
  ...
  echo "NEXT=8.3.2 pipeline_x mega host-cc leave (wave278 expr_sidecar done · present 31); candidates: ast_pool_lifecycle/onefunc/module_func or pipeline_x mega"
}
