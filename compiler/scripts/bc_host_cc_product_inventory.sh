...
dump_rows() {
  ...
  echo "NEXT=8.3.2 pipeline_x mega host-cc leave (wave284 parse_orch seed ALWAYS · present 27 LOC−mega); candidate: typeck thin / glue shells / typedefs / parser_result"
}
