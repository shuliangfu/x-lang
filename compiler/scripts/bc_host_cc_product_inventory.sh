...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave165 pure: color pins+linear interf; residual interf BSS+thin/evict/index-scratch)|2280|present"
