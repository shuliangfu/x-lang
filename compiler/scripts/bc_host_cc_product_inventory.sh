...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_typeck_region_assign.c|8.3.1|typeck region/escape assign-site (wave240 with_arena BSS pure leave; scan/region-label residual)|260|present"
