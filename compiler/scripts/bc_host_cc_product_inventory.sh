...
dump_rows() {
  ...
  echo "NEXT=8.3.2 pipeline_x mega host-cc leave (wave285 typeck_orch seed ALWAYS · present 27 LOC−mega); candidate: typeck_check_expr thin / glue shells / typedefs / parser_result"
}
