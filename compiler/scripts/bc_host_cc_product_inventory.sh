...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave159 pure: loop-phi+has_cfg; residual binop-cache/live-merge/Chaitin/break/index-scratch)|2461|present"
