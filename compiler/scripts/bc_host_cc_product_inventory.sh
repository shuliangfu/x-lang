...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave157 pure: frame-sum; residual binop-cache/live/Chaitin/break/index-scratch)|2614|present"
