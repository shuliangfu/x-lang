...
dump_rows() {
  ...
  echo "NEXT=BC 8.3 floor closed + wave311 typeck_gen monofile dual WEAK leave + typeck.x U*/ L003 root (present 0); residual host-cc = codegen/parser mega gen + runtime seeds; BC 终局 still ⬜"
}
