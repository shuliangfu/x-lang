...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave160 pure: if/loop live-merge; residual binop-cache/break-note/Chaitin/index-scratch)|2471|present"
