...
PRODUCT_RESIDUAL_ROWS=(
  ...
  "compiler/pipeline_asm_emit_spill.c|8.3.1|asm ELF 7.3 live/Chaitin Cap residual (wave158 pure: CFG merge/phi+def-offs; residual binop-cache/live/Chaitin/break/index-scratch)|2486|present"
