...
#    + leftover_twokind + leftover_asbind + leftover_kindarr + leftover_validate
#    + leftover_pathpost + leftover_preamble + leftover_fromat sibling TUs
#    + harness + link
...
$CC -c -I. -Iinclude -o "$OUT/leftover_validate.o" \
  ...
  cat "$OUT/leftover_validate_cc.err" >&2; exit 1; }
$CC -c -I. -Iinclude -o "$OUT/leftover_pathpost.o" \
  ...
  cat "$OUT/leftover_pathpost_cc.err" >&2; exit 1; }
