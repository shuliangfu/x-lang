...
if asm_strict_typeck_selfhosted; then
  ...
  if asm_seed_omit_c_frontend_seed; then
    ...
    ST_SEED_PARSER_TCK="$ST_ASYNC_CPS_SEED codegen_x.o lexer_x_link_alias.o typeck_x_link_alias.o codegen_x_link_alias.o"
    ...
    ensure_typeck_x_o_for_strict_link || true
    ST_SEED_PARSER_TCK="$SEED_O/parser.o $ST_ASYNC_CPS_SEED $SEED_O/lexer.o $SEED_O/ast_seed.o codegen_x.o lexer_x_link_alias.o typeck_x_link_alias.o codegen_x_link_alias.o"
    ...
    ST_SEED_PARSER_TCK="$ST_TYPECK_C_STUBS $ST_TYPECK_BARE_ALIAS $SEED_O/parser.o $ST_ASYNC_CPS_SEED $SEED_O/lexer.o $SEED_O/ast_seed.o codegen_x.o lexer_x_link_alias.o typeck_x_link_alias.o codegen_x_link_alias.o"
  ...
  ST_SEED_PARSER_TCK="$SEED_O/parser.o $ST_ASYNC_CPS_SEED $SEED_O/lexer.o $SEED_O/ast_seed.o $ST_TYPECK_X_LINK codegen_x.o lexer_x_link_alias.o typeck_x_link_alias.o codegen_x_link_alias.o"
