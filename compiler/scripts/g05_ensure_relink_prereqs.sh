...
if [ "${G05_SKIP_HOT_REBUILD:-}" != "1" ]; then
  ...
  if [ -f pipeline_glue.c ] && [ -f pipeline_gen.c ]; then
    ...
    for _gs in pipeline_elf_write_o.c pipeline_elf_ctx.c pipeline_glue_early_fwd.c pipeline_glue_mid_fwd.c pipeline_glue_backend_fwd.c pipeline_glue_typeck_fwd.c pipeline_glue_typeck_mid_fwd.c pipeline_glue_emit_fwd.c pipeline_glue_emit_block_fwd.c pipeline_glue_emit_lea_fwd.c pipeline_glue_emit_mid_fwd.c pipeline_asm_wpo.c \
      ast_pool_typedefs.c ast_pool_sidecar_pool.c ast_pool_ptr_at.c ast_pool.c ast_pool_top_level.c ast_pool_expr_sidecar.c ast_pool_module_enum.c ast_pool_onefunc.c ast_pool_dep_ctx.c ast_pool_module_func.c ast_pool_arena.c ast_pool_block.c ast_pool_lifecycle.c ast_pool_bootstrap_glue.c; do
