...
/* wave1189: fwd decls for migrated sub-class helpers (defined in
 * pipeline_typeck_check_expr.c EOF, #included at L6233). Needed because:
 * - check_expr.c impl_mega_c / impl_c call match/deref/var before their def
