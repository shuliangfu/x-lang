 ...
 * wave221/222/223: pure-leaved faces are extern-only below.
 * PLATFORM: SHARED — host-cc residual shell.
 * ========================================================================== */
 ...
 * wave223 pure-owned leave: sret_* get/set live = pure.
...
/* wave223 pure sret faces (mega_body residual write path). */
