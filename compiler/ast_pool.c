...
/** BC 8.3.2 wave988–989: block domain thin (append/region/defer + loop/labeled/getters) — same-TU include. */
...
/* BC 8.3.2 wave989: block residual (expr_stmt/stmt_order/while/for/labeled +
 * const/let/if getters) moved into ast_pool_block.c (same-TU #include above).
...
/** BC 8.3.2: OneFunc const/let/param/call/while/for sidecar domain (same-TU thin). */
