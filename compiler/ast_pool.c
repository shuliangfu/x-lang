...
/** BC 8.3.2 wave988–990: block domain thin (append/region/defer + loop/labeled/getters + parent/resolve) — same-TU include. */
#include "ast_pool_block.c"

/* BC 8.3.2 wave991: onefunc defer/labeled/if/region/stmt_order + fill_* residual
 * moved into ast_pool_onefunc.c (same-TU #include later). core residual here:
 * module_top_level_name_is_const; stmt_order rebuild/fixup later. */
