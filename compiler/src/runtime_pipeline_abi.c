...
/* 更多 pipeline stub */
int32_t pipeline_parse_set_main_from_buf_c(struct ast_Module *m, struct ast_ASTArena *a, uint8_t *d, int s, int l) { (void)m; (void)a; (void)d; (void)s; (void)l; return 0; }
