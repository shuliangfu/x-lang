// Thin pure: wave316 M2 — emit_ctx_sret Cap residual C→.x (was wave223 C thin).
...
// PRODUCT inject: -E+$CC via pipeline_abi_inject_emit_ctx_sret_thin
...
// (Lxml COMMON dual-home vs mega named .data).
