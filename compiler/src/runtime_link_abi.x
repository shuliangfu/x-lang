...
export extern "C" function xlang_empty_cstr(): *u8;
export extern "C" function xlang_asm_ld_bank_push_impl(b: *u8, path: *u8): *u8;
export extern "C" function xlang_runtime_asm_io_stubs_o_path_impl(argv0: *u8): *u8;
export extern "C" function xlang_runtime_process_argv_o_path_impl(argv0: *u8): *u8;
export extern "C" function xlang_asm_ld_effective_link_argv0_impl(link_argv0: *u8, syn_buf: *u8, syn_sz: i32): *u8;
export extern "C" function xlang_invoke_ld_for_exe_impl(o_path: *u8, exe_path: *u8, target: *u8, use_macho_o: i32, use_coff_o: i32, link_argv0: *u8, lib_roots: *u8, n_lib_roots: i32): i32;
export extern "C" function xlang_asm_ld_append_mach_tail_libs_impl(compress_o: *u8, user_o: *u8, flags: *u8, argv: *u8, la: *i32, max_la: i32, append_lsystem: i32): void;
export extern "C" function xlang_asm_ld_append_unix_gcc_tail_libs_impl(compress_o: *u8, user_o: *u8, flags: *u8, need_pt: i32, argv: *u8, la: *i32, max_la: i32): void;
export extern "C" function xlang_ensure_runtime_arrow_simd_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_asm_io_stubs_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_atomic_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_backtrace_platform_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_channel_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_compress_zlib_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_crypto_inc_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_dynlib_os_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_ed25519_ref10_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_env_os_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_heap_user_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_http_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_kv_mmap_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_log_os_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_math_libm_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_net_udp_batch_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_net_workers_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_panic_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_process_argv_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_process_os_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_queue_contention_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_random_fill_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_scheduler_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_sqlite_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_sync_lock_diag_tls_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_sync_os_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_test_fn_invoke_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_thread_glue_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_time_os_o_impl(argv0: *u8): i32;
export extern "C" function xlang_ensure_runtime_tls_mbedtls_bio_o_impl(argv0: *u8): i32;
...
export extern "C" function xlang_asm_ld_lib_root_ptr_usable_impl(p: *u8): i32;
export extern "C" function xlang_asm_ld_lib_root_default_impl(root_buf: *u8): void;
export extern "C" function xlang_linux_host_gcc_path_impl(): *u8;
export extern "C" function xlang_linux_ld_child_path_impl(): void;

export extern "C" function xlang_runtime_o_realpath_if_exists_impl(path: *u8, resolved: *u8): *u8;
export extern "C" function xlang_runtime_compiler_o_path_copy_impl(argv0: *u8, leaf: *u8, out: *u8, out_sz: i64): i32;
...
export extern "C" function xlang_cc_compile_sync_impl(src: *u8, out_o: *u8, inc0: *u8, inc1: *u8, inc2: *u8, from_asm_s: i32): i32;
...
export extern "C" function xlang_link_perror_impl(msg: *u8): void;
...
export extern "C" function xlang_cc_compile_sync_ex_impl(src: *u8, out_o: *u8, inc0: *u8, inc1: *u8, inc2: *u8, from_asm_s: i32, extra_flags: *u8): i32;
export extern "C" function xlang_asm_nostdlib_minimal_selfcontained_exe_link_impl(o_path: *u8, exe_path: *u8, link_eff: *u8, lib_roots: *u8, n_lib_roots: i32): i32;

/** Exported function `xlang_forward_main_to_main_entry`.
 * Implements `xlang_forward_main_to_main_entry`.
 * @param argc i32
 * @param argv *u8
 * @return i32
 */
#[no_mangle]
export function xlang_forward_main_to_main_entry(argc: i32, argv: *u8): i32 {
  unsafe {
...
/** Exported function `xlang_freestanding_user_o_needs_panic`.
 * Memory management helper `xlang_freestanding_user_o_needs_panic`.
 * @param user_o *u8
 * @return i32
 */
#[no_mangle]
export function xlang_freestanding_user_o_needs_panic(user_o: *u8): i32 {
  unsafe {
    let r: i32 = xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_panic_");
    return r;
  }
  return 0;
}

/** Exported function `xlang_freestanding_user_o_needs_io`.
 * Memory management helper `xlang_freestanding_user_o_needs_io`.
 * @param user_o *u8
 * @return i32
 */
#[no_mangle]
export function xlang_freestanding_user_o_needs_io(user_o: *u8): i32 {
  unsafe {
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_write") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_read") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_close") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_exit") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_open") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_openat") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_mmap") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_munmap") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_socket") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_connect") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_bind") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_sys_listen") != 0) {
      return 1;
    }
...
export function link_abi_user_o_needs_libc_heap(user_o: *u8): i32 {
  unsafe {
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "malloc") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "calloc") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "realloc") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "free") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "posix_memalign") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "getenv") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_map(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_empty_size") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_new_Map_i32_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_with_capacity_Map_i32_i32_ptr_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_insert_Map_i32_i32_ptr_i32_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_get_Map_i32_i32_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_find_Map_i32_i32_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_deinit_Map_i32_i32_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_str_new") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_map_str_insert") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_set(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_new_i32_retSet_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_new_i32_retSet_u64") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_with_capacity_Set_i32_ptr_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_insert_Set_i32_ptr_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_insert_Set_u64_ptr_u64") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_contains_key_Set_i32_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_contains_key_Set_u64_u64") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_remove_Set_i32_ptr_i32") != 0) {
      return 1;
    }
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_deinit_Set_u64_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_str_new") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_str_insert") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_set_i32_insert") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_set_i32_contains") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_set_i32_remove") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_set_i32_len") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_set_set_i32_deinit") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_queue(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_new_retQueue_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_new_retQueue_u8") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_push_back_Queue_i32_ptr_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_push_back_Queue_u8_ptr_u8") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_push_front") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_pop_front_Queue_i32_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_pop_back") != 0) {
      return 1;
    }
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_deinit_Queue_i32_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_queue_with_capacity") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_test(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "test_runner_") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "test_expect_") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "test_bench_") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "test_f_test_") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "test_io_") != 0) {
      return 1;
    }
...
export function link_abi_user_o_needs_core_mem(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_align_up") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_align_down") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_mem_copy") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_mem_set") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_mem_zero") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_mem_move") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_mem_mem_compare") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_core_slice(user_o: *u8): i32 {
  unsafe {
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_slice_i32_from_ptr_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_subslice_i32_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_slice_u8_from_ptr_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_subslice_u8_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_slice_u64_from_ptr_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "core_subslice_u64_c") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_heap_page_mmap(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_page_mmap_page_mmap_heap_available") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_page_mmap_page_mmap_heap_init") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_page_mmap_page_mmap_heap_alloc") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_page_mmap_page_mmap_heap_deinit") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_page_mmap_page_mmap_heap_free") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_sys_linux(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_syscall_invoke_available") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_anonymous_mmap") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_syscall_munmap") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_syscall_read") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_syscall_write") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_syscall_close") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_linux_syscall_exit") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_sys(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_write_stdout") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_write_stderr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_write") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_read") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_close") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_exit") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_freestanding_write_available") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_sys_linux_syscall_table_available") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_net(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_listen") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_connect") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_udp_bind") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_udp_recv_many_buf") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_udp_send_many_buf") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_addr_to_u32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_net_close_udp") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_stream_write_batch_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_tcp_connect_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_tcp_listen_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_udp_bind_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_udp_recv_many_buf_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_udp_send_many_buf_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_close_socket_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_udp_send_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_dns_resolve_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "net_sock_create_c") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_std_heap_api(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_alloc_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_alloc_u8") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_free_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_free_u8") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_alloc_size_zero") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_alloc_usize") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_free_u8_ptr") != 0) {
      return 1;
    }
    /* Formal std/vec/vec.o Allocator/default/kind family — keep seed probes in sync (G.7). */
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_default_alloc") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_kind_arena") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_alloc_Allocator_usize") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_realloc_Allocator_u8_ptr_usize") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_free_Allocator_u8_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_arena64_alloc") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_arena64_alloc_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_alloc_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_free_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_alloc_aligned_c") != 0) {
      return 1;
    }
    /* Typed libc heap surface used by formal set/map/queue/vec .o. */
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_alloc_i32_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_alloc_u8_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_alloc_u64_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_free_i32_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_free_u8_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_free_u64_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_map_find") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "std_heap_libc_heap_copy_u8_at_c") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_heap_user_syms(user_o: *u8): i32 {
  ...
  unsafe {
    ...
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "heap_alloc_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "heap_free_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "heap_realloc_c") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "heap_arena64_alloc_c") != 0) {
      return 1;
    }
    return 0;
  }
...
export function link_abi_user_o_needs_async_scheduler(user_o: *u8): i32 {
  unsafe {
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_coop_pingpong") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_coop_pingpong_jmp") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_cps_suspend") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_asm_frame_phase_by_id") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_asm_frame_store_from_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_asm_frame_load_to_ptr") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_asm_frame_reset_by_id") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_cps_suspend_io") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_task_submit") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_task_submit_to") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_scheduler_drain") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_worker_drain") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_worker_count") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_worker_pending") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_queue_reset") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_scheduler_pending") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_io_wake_all") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_io_waiters_pending") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_io_completions_ready") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_set_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_reset") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_push_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_push_u32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_push_i64") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_valid") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_take_i32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_take_u32") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_async_run_seed_take_i64") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_io_submit_read_async") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_io_complete_read_async") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_io_complete_read_async_slot") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_io_submit_write_async") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_io_complete_write_async") != 0) {
      return 1;
    }
    if (xlang_link_obj_needs_undef_sym_impl(user_o, "xlang_io_complete_write_async_slot") != 0) {
      return 1;
    }
    return 0;
  }
...
/** Exported function `xlang_generated_c_needs_async_scheduler`.
 * Implements `xlang_generated_c_needs_async_scheduler`.
 * @param c_path *u8
 * @return i32
 */
#[no_mangle]
export function xlang_generated_c_needs_async_scheduler(c_path: *u8): i32 {
  unsafe {
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_run_i32") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_cps_suspend") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_task_submit") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_run_seed_") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_coop_pingpong_jmp") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_coop_pingpong") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_run_drain_until_idle") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_queue_reset") != 0) {
      return 1;
    }
    if (link_abi_generated_c_contains_substr(c_path, "xlang_async_bind_context_c") != 0) {
      return 1;
    }
    return 0;
  }
...
#[no_mangle]
export function xlang_invoke_ld_for_exe(o_path: *u8, exe_path: *u8, target: *u8, use_macho_o: i32, use_coff_o: i32, link_argv0: *u8, lib_roots: *u8, n_lib_roots: i32): i32 {
  if (o_path == 0 as *u8) {
    return 0 - 1;
  }
  if (exe_path == 0 as *u8) {
...
/** Exported function `xlang_asm_ld_append_mach_tail_libs`.
 * Implements `xlang_asm_ld_append_mach_tail_libs`.
 * @param compress_o *u8
 * @param user_o *u8
 * @param flags *u8
 * @param argv *u8
 ...
 */
#[no_mangle]
export function xlang_asm_ld_append_mach_tail_libs(compress_o: *u8, user_o: *u8, flags: *u8, argv: *u8, la: *i32, max_la: i32, append_lsystem: i32): void {
  if (flags == 0 as *u8) {
    return;
  }
  if (argv == 0 as *u8) {
...
/** Exported function `xlang_asm_ld_append_unix_gcc_tail_libs`.
 * Implements `xlang_asm_ld_append_unix_gcc_tail_libs`.
 * @param compress_o *u8
 * @param user_o *u8
 * @param flags *u8
 * @param need_pt i32
 ...
 */
#[no_mangle]
export function xlang_asm_ld_append_unix_gcc_tail_libs(compress_o: *u8, user_o: *u8, flags: *u8, need_pt: i32, argv: *u8, la: *i32, max_la: i32): void {
  if (flags == 0 as *u8) {
    return;
  }
  if (argv == 0 as *u8) {
...
export extern "C" function xlang_asm_ld_prepare_for_exe_link_impl(link_eff: *u8, user_o: *u8, driver_freestanding: i32, use_macho_o: i32, use_coff_o: i32): i32;
...
/** Exported function `xlang_ensure_runtime_asm_io_stubs_o`.
 * Implements `xlang_ensure_runtime_asm_io_stubs_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_atomic_glue_o`.
 * Implements `xlang_ensure_runtime_atomic_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_backtrace_platform_o`.
 * Implements `xlang_ensure_runtime_backtrace_platform_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_channel_glue_o`.
 * Implements `xlang_ensure_runtime_channel_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_compress_zlib_glue_o`.
 * Implements `xlang_ensure_runtime_compress_zlib_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_crypto_inc_glue_o`.
 * Implements `xlang_ensure_runtime_crypto_inc_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_dynlib_os_o`.
 * Implements `xlang_ensure_runtime_dynlib_os_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_ed25519_ref10_glue_o`.
 * Implements `xlang_ensure_runtime_ed25519_ref10_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_env_os_o`.
 * Implements `xlang_ensure_runtime_env_os_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_heap_user_o`.
 * Implements `xlang_ensure_runtime_heap_user_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_http_glue_o`.
 * Implements `xlang_ensure_runtime_http_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_kv_mmap_glue_o`.
 * Implements `xlang_ensure_runtime_kv_mmap_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_log_os_o`.
 * Implements `xlang_ensure_runtime_log_os_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_math_libm_o`.
 * Implements `xlang_ensure_runtime_math_libm_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_net_udp_batch_o`.
 * Implements `xlang_ensure_runtime_net_udp_batch_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_net_workers_o`.
 * Implements `xlang_ensure_runtime_net_workers_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_panic_o`.
 * Implements `xlang_ensure_runtime_panic_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_process_argv_o`.
 * Implements `xlang_ensure_runtime_process_argv_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_process_os_glue_o`.
 * Implements `xlang_ensure_runtime_process_os_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_queue_contention_o`.
 * Implements `xlang_ensure_runtime_queue_contention_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_random_fill_o`.
 * Implements `xlang_ensure_runtime_random_fill_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_scheduler_glue_o`.
 * Implements `xlang_ensure_runtime_scheduler_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_sqlite_glue_o`.
 * Implements `xlang_ensure_runtime_sqlite_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_sync_lock_diag_tls_o`.
 * Implements `xlang_ensure_runtime_sync_lock_diag_tls_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_sync_os_o`.
 * Implements `xlang_ensure_runtime_sync_os_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_test_fn_invoke_o`.
 * Implements `xlang_ensure_runtime_test_fn_invoke_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_thread_glue_o`.
 * Read path helper `xlang_ensure_runtime_thread_glue_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_time_os_o`.
 * Implements `xlang_ensure_runtime_time_os_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_runtime_tls_mbedtls_bio_o`.
 * Implements `xlang_ensure_runtime_tls_mbedtls_bio_o`.
 * @param argv0 *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_ensure_crt0_user_o`.
 * Implements `xlang_ensure_crt0_user_o`.
 * @param argv0 *u8
...
/** Exported function `xlang_ensure_freestanding_io_o`.
 * Memory management helper `xlang_ensure_freestanding_io_o`.
 * @param argv0 *u8
 * @param driver_freestanding i32
 * @return i32
 */
...
/** Exported function `xlang_asm_user_o_has_undef_syms`.
 * Implements `xlang_asm_user_o_has_undef_syms`.
 * @param o_path *u8
 * @return i32
 */
#[no_mangle]
export function xlang_asm_user_o_has_undef_syms(o_path: *u8): i32 {
  if (o_path == 0 as *u8) {
    return 1;
  }
  unsafe {
...
/** Exported function `xlang_asm_ld_prepare_for_exe_link`.
 * Implements `xlang_asm_ld_prepare_for_exe_link`.
 * @param link_eff *u8
 * @param user_o *u8
 * @param driver_freestanding i32
...
/** Exported function `xlang_asm_invoke_ld_platform`.
 * Implements `xlang_asm_invoke_ld_platform`.
 * @param o_path *u8
 * @param exe_path *u8
 * @param target *u8
 * @param use_macho_o i32
 ...
 */
#[no_mangle]
export function xlang_asm_invoke_ld_platform(o_path: *u8, exe_path: *u8, target: *u8, use_macho_o: i32, use_coff_o: i32, link_argv0: *u8, lib_roots: *u8, n_lib_roots: i32, driver_freestanding: i32): i32 {
  if (o_path == 0 as *u8) {
    return 0 - 1;
  }
  if (exe_path == 0 as *u8) {
...
/** Exported function `xlang_asm_ld_append_std_objs`.
 * Implements `xlang_asm_ld_append_std_objs`.
 * @param link_argv0 *u8
 * @param lib_roots *u8
 * @param n_lib_roots i32
 * @param bank *u8
 ...
 */
#[no_mangle]
export function xlang_asm_ld_append_std_objs(link_argv0: *u8, lib_roots: *u8, n_lib_roots: i32, bank: *u8, argv: *u8, la: *i32, max_la: i32, flags: *u8): void {
  if (argv == 0 as *u8) {
    return;
  }
  if (la == 0 as *i32) {
  ...
  unsafe {
    xlang_asm_ld_append_std_objs_impl(link_argv0, lib_roots, n_lib_roots, bank, argv, la, max_la, flags);
  }
}

/** Exported function `xlang_asm_ld_append_on_demand_user_objs`.
 * Implements `xlang_asm_ld_append_on_demand_user_objs`.
 * @param link_argv0 *u8
 * @param user_o *u8
 * @param lib_roots *u8
 * @param n_lib_roots i32
...
export function xlang_asm_ld_append_on_demand_user_objs(link_argv0: *u8, user_o: *u8, lib_roots: *u8, n_lib_roots: i32, bank: *u8, argv: *u8, la: *i32, max_la: i32, flags: *u8): void {
  ...
  unsafe {
    xlang_asm_ld_append_on_demand_user_objs_impl(link_argv0, user_o, lib_roots, n_lib_roots, bank, argv, la, max_la, flags);
  }
}
 ...
 * Implements `xlang_linux_ld_child_path`.
 * @return void
 */
#[no_mangle]
export function xlang_linux_ld_child_path(): void {
  unsafe {
    xlang_linux_ld_child_path_impl();
  }
}
 ...
 * Implements `xlang_runtime_compiler_o_path_copy`.
 * @param argv0 *u8
 * @param leaf *u8
 * @param out *u8
 * @param out_sz i64
...
#[no_mangle]
export function xlang_cc_compile_sync(src: *u8, out_o: *u8, inc0: *u8, inc1: *u8, inc2: *u8, from_asm_s: i32): i32 {
  unsafe {
 ...
 * path aligned. Cap residual xlang_spawn_sync_impl stays mega always.
...
/** Exported function `xlang_link_perror`.
 * Implements `xlang_link_perror`.
 * @param msg *u8
 * @return void
 */
#[no_mangle]
...
#[no_mangle]
export function xlang_cc_compile_sync_ex(src: *u8, out_o: *u8, inc0: *u8, inc1: *u8, inc2: *u8, from_asm_s: i32, extra_flags: *u8): i32 {
  unsafe {
...
/** Exported function `xlang_asm_nostdlib_minimal_selfcontained_exe_link`.
 * Implements `xlang_asm_nostdlib_minimal_selfcontained_exe_link`.
 * @param o_path *u8
 * @param exe_path *u8
 * @param link_eff *u8
 * @param lib_roots *u8
 ...
 */
#[no_mangle]
export function xlang_asm_nostdlib_minimal_selfcontained_exe_link(o_path: *u8, exe_path: *u8, link_eff: *u8, lib_roots: *u8, n_lib_roots: i32): i32 {
  unsafe {
...
/** Exported function `xlang_asm_ld_lib_root_ptr_usable`.
 * Implements `xlang_asm_ld_lib_root_ptr_usable`.
 * @param p *u8
 * @return i32
 */
#[no_mangle]
...
/** Exported function `xlang_path_has_sep`.
 * Implements `xlang_path_has_sep`.
 * @param s *u8
 * @return i32
 */
#[no_mangle]
