...
//   LINUX injects assign_helpers_thin (helpers+lhs+rhs; see wave420).
...
// wave403/413/416/420: MACOS PREFER full; LINUX PREFER helpers+lhs+rhs.
//   Ubuntu full tip XT001@asg_thin_store MISATTRIBUTED; helpers+rhs -c green;
//   remaining (rhs_to_rax/emit/field/body) tip reinject still BAN on LINUX.
