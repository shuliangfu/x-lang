// Thin pure: wave142 assign FULL leaf (helpers + emit/field/body exports).
...
//   LINUX injects assign_helpers_thin (lhs+rhs+pair+body; see wave421).
...
// wave403/413/416/420/421: MACOS PREFER full; LINUX PREFER helpers skip middle.
//   Ubuntu contiguous grow through rhs_to_rax/emit → XT001; skip-middle
//   pair+body unlock product L2 green. Middle tip reinject still BAN LINUX.
