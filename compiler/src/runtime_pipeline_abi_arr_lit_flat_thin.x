// Thin pure: arr REST array_lit_flat only.
// G.7: body MUST match pipeline_asm_emit_array_lit_flat_elf_c in arr thin / mega.
// wave427: Darwin -c ~6612B; LINUX HARD BAN (Ubuntu asm empty .o RC=0).
