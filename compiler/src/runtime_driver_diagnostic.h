...
/** wave664 Cap residual: INDEX index must be integer-like (not ptr/float/struct/bool). */
...
/** wave677 Cap residual: bool cannot be used in arithmetic/bitops/shifts or unary -/~. */
