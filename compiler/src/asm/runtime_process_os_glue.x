...
extern "C" function process_nop_sigchld_impl(sig: i32): void;
extern "C" function process_dup_stdio_posix_impl(fd: i32, slot: i32): i32;

function runtime_process_os_glue_x_doc_anchor(): i32 {
  return 0;
}
...
#[no_mangle]
function process_nop_sigchld(sig: i32): void {
  unsafe {
...
#[no_mangle]
function process_dup_stdio_posix(fd: i32, slot: i32): i32 {
  unsafe {
