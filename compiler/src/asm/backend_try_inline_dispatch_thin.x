...
extern "C" function glue_enc_local_slot_ptr_or_addr_impl(arena: *u8, elf_ctx: *u8, arg_ref: i32, slot_off: i32, ta: i32, asm_ctx: *u8): i32;
extern "C" function glue_arch_emit_local_slot_ptr_or_addr_text_impl(arena: *u8, out: *u8, arg_ref: i32, slot_off: i32, ta: i32, asm_ctx: *u8): i32;
...
#[no_mangle]
function glue_enc_local_slot_ptr_or_addr(arena: *u8, elf_ctx: *u8, arg_ref: i32, slot_off: i32, ta: i32, asm_ctx: *u8): i32 {
  unsafe {
...
extern "C" function glue_fold_func_returns_param_struct_lit_impl(arena: *u8, mod: *u8, func_idx: i32, out_lit_ref: *i32): i32;
extern "C" function glue_fold_func_returns_param01_vector_binop_impl(arena: *u8, mod: *u8, func_idx: i32, out_binop_ko: *i32): i32;
extern "C" function glue_call_is_zero_arg_default_alloc_impl(arena: *u8, call_ref: i32): i32;
...
extern "C" function glue_inline_var_field_access_offset_impl(arena: *u8, mod: *u8, pctx: *u8, asm_ctx: *u8, fa_ref: i32): i32;
extern "C" function try_inline_param0_field_sum_call_elf_impl(arena: *u8, elf_ctx: *u8, expr_ref: i32, ctx: *u8, ta: i32): i32;
extern "C" function try_call_wpo_mono_vector_lane_of_binop_call_elf_impl(arena: *u8, elf_ctx: *u8, expr_ref: i32, ctx: *u8, ta: i32): i32;
