/**
 * pipeline_wpo_strict_link_alias.c — strict WPO 链 glue：pipeline_wpo.o SX 编排 + runtime 期望名。
 *
 * pipeline_wpo.o 导出 run_sx_pipeline_impl；glue/driver 仍引用 pipeline_run_sx_pipeline_impl。
 * SX typecheck_entry thin bl 引用 run_sx_pipeline_typecheck_entry_emit → ast_pool emit_c。
...
/** SX typecheck_entry thin bl → C emit（pipeline_wpo.o U 此符号）。 */
