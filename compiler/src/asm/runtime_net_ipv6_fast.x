...
extern "C" function net_ipv6_ensure_wsa_c_impl(): i32;
extern "C" function net_ipv6_close_socket_c_impl(fd: i32): i32;
extern "C" function net_ipv6_set_nonblock_c_impl(fd: i32): i32;
extern "C" function net_ipv6_poll_writable_c_impl(fd: i32, timeout_ms: u32): i32;
extern "C" function net_ipv6_connect_retry_ok_c_impl(): i32;

function runtime_net_ipv6_fast_x_doc_anchor(): i32 {
  return 0;
}
...
#[no_mangle]
function net_ipv6_close_socket_c(fd: i32): i32 {
  unsafe {
