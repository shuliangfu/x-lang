 ...
 * 与 main.c 一致：main.c 调 main_entry（driver_gen.c）；asm 全链若 main.o 仍为空桩，Goal2 回退链入 driver_sx.o
 * 时同样使用 main_entry，而非裸符号 entry。
 *
 * 链接时需：本 .o + main.sx 对应实现（asm main.o 或 driver_sx.o 等）+ runtime_driver.o + -lc。
 *
