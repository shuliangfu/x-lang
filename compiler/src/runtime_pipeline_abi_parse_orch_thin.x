// Thin pure: wave323/374/374b/388 M2 — parse_orch Cap residual C→.x
//   (was wave284 C thin).
...
// wave388: HARD BAN reinject both ends (stamp .pabi_w388_parse_orch.stamp);
//   stay prior Darwin PREFER / Ubuntu prior -E until ParseIntoResult root.
