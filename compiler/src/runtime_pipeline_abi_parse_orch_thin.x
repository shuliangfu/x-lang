// Thin pure: wave323 M2 — parse_orch Cap residual C→.x (was wave284 C thin).
...
// PRODUCT inject: -E+$CC via pipeline_abi_inject_parse_orch_thin
...
#[no_mangle]
export function pipeline_sizeof_arena(): usize { return W323_ARENA_SZ; }

#[no_mangle]
export function pipeline_sizeof_module(): usize { return W323_MODULE_SZ; }

#[no_mangle]
export function pipeline_sizeof_dep_ctx(): usize { return W323_DEP_CTX_SZ; }

#[no_mangle]
export function pipeline_sizeof_onefunc_result(): usize { return W323_ONEFUNC_RESULT_SZ; }

#[no_mangle]
export function pipeline_arena_offset_num_types(): usize { return W323_ARENA_OFF_NUM_TYPES; }
