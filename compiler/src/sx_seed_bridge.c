 ...
 *
 * pipeline_sx.o / parser_sx.o / typeck_su.o / codegen_su.o 经 -E-extern 分模块后，
...
/** parser.sx 生成体引用；初始化 match 相关字段。verify-selfhost-stage2 链 ast_su2.o 时由 ast.sx 导出，勿重复定义。 */
