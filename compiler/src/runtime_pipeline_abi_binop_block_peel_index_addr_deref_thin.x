// Thin pure: index_addr DEREF peel arm (wave479).
...
/**
 * DEREF peel: recurse on unary operand (caller already gated ko==52).
 * wave479: no-local — re-call; ban `let x=call()`.
 * @return i32 — clobber decision
 * PLATFORM: SHARED freestanding emit.
 */
#[no_mangle]
export function glue_binop_index_addr_deref_elf_c(arena: *u8, expr_ref: i32): i32 {
  unsafe {
