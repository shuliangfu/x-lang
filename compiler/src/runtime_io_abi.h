 ...
 * 与其它文件的关系：不依赖 C 前端；ast_pool 经 xlang_read_file_into_path 回退读文件。
 */

#ifndef XLANG_RUNTIME_IO_ABI_H
#define XLANG_RUNTIME_IO_ABI_H
