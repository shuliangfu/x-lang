// Thin pure: arr REST emit_return_elf_impl only.
// G.7: body MUST match pipeline_asm_emit_return_elf_impl.
// wave427: Darwin -c ~18079B; LINUX HARD BAN (Ubuntu asm empty .o RC=0).
