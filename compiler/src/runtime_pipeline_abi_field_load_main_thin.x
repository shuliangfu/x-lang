// Thin pure: field_load REST load_byte_sz only (bytes_eq via leftover helpers).
// G.7: body MUST match field_load_sz_thin / mega.
// wave431: Darwin -c ~4571B; LINUX HARD BAN (Ubuntu asm empty .o; -E omit T).
