// Thin pure: FIELD ptr-path TYPE_ARRAY(10) arm (wave476).
...
/**
 * FIELD ptr-path array arm — lvalue→rbx then fixed_array_type_let_init (slot -3).
 * wave476: no-local — re-call type_ref; ban `let x=call()`.
 * @return i32 — 0 ok; -1 fail; -3 not this arm
 * PLATFORM: SHARED freestanding · LINUX gold · MACOS|ARM64.
 */
#[no_mangle]
export function glue_emit_assign_field_ptr_array_elf_c(arena: *u8, elf_ctx: *u8, left_ref: i32, right_ref: i32, ctx: *u8, ta: i32): i32 {
  unsafe {
