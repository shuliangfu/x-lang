// Thin pure: wave321 M2 — bootstrap_glue Cap residual C→.x (was wave282 C thin).
...
// PRODUCT inject: -E+$CC via pipeline_abi_inject_bootstrap_glue_thin
// (ALLOW_E_REPLACE + stamp). File-local scope sidecar flat BSS (64×16).
