...
export extern "C" function driver_run_asm_backend_impl(input_path: *u8, out_path: *u8, lib_roots: *u8, n_lib_roots: i32,
                                                 target: *u8, argc: i32, argv: *u8): i32;

/** asm backend 编排（薄门闩；实际实现 seed _impl）。 */
#[no_mangle]
export function driver_run_asm_backend(input_path: *u8, out_path: *u8, lib_roots: *u8, n_lib_roots: i32, target: *u8,
