// Thin pure: assign REST emit_assign only (peers+asg_thin via leftover/helpers).
// G.7: body MUST match pipeline_asm_emit_assign_elf_c in assign_thin / mega.
// wave426: Darwin -c ~50281B single T; LINUX HARD BAN — Ubuntu asm empty .o;
//   -E typeck OK but omits T (same class as w425 rhsrax). No product overlay.
