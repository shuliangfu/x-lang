 ...
 */
/**
 * wave438 leaf: after scalar emit, repark base into rbx if elem may clobber.
 * @param arena *u8 — unused (ABI match)
 * @param elf_ctx *u8 — ELF ctx
 * @param init_ref i32 — unused
 * @param ctx *u8 — unused
 * @param ta i32 — arch
 * @param stack_slot_off i32 — array base
