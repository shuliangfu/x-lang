// Thin pure: wave393 M2 — asm_codegen mega LOOP leaf (split from mega_body).
...
// wave392 ROOT: Ubuntu typeck/arena pressure on helpers+LOOP combined; this leaf
// keeps LOOP + local T001 wrappers only (no ctx_reset). BAN reinject until unlock.
...
// wave393: T001 wrappers used by mega LOOP only. PLATFORM: SHARED.
