...
/**
 * Float→i32/u32 truncate arm. Return -2 fallthrough.
 * PLATFORM: SHARED freestanding cast emit.
 */
#[no_mangle]
export function glue_emit_as_f2i32_elf_c(arena: *u8, elf_ctx: *u8, op: i32, ctx: *u8, ta: i32, tgt: i32): i32 {
  unsafe {
    if (pipeline_type_kind_ord_at(arena, tgt) != 0 && pipeline_type_kind_ord_at(arena, tgt) != 3) {
      return 0 - 2;
    }
