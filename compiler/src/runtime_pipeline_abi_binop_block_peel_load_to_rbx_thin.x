// Thin pure: peel REST load_to_rbx only (peers via leftover/helpers).
// G.7: body MUST match glue_binop_operand_load_to_rbx_clobbers_rax_elf_c
// in binop_block_peel_thin.x / mega.
// wave423: LINUX PREFER — single middle export; load/index Ubuntu asm -c
//   empty .o (RC=0 bogus) still BAN. ensure injects after helpers+may_clobber.
