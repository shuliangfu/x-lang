// Thin pure: wave319 M2 — typeck_check_expr Cap residual C→.x (was wave286 C thin).
...
// PRODUCT inject: -E+$CC via pipeline_abi_inject_typeck_check_expr_thin
// (ALLOW_E_REPLACE + stamp). Match BSS OK under -E+$CC.
