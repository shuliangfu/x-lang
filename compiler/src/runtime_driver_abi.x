...
export function driver_typeck_force_c_enabled(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_TYPECK_FORCE_C");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
export function driver_asm_build_skip_typeck(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_ASM_BUILD_SKIP_TYPECK");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
export function driver_asm_entry_emit_heavy(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_ASM_ENTRY_EMIT_HEAVY");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
export function driver_asm_entry_module_only_from_env(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_ASM_ENTRY_MODULE_ONLY");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
export function driver_asm_parse_metric_only_from_env(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_ASM_PARSE_METRIC_ONLY");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
export function driver_sanitize_address_get(): i32 {
  unsafe {
    ...
    let e: *u8 = link_abi_getenv("SHUX_SANITIZE_ADDRESS");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
export function driver_compile_phase_timing_enabled(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_COMPILE_PHASE_TIMING");
    if (e == 0 as *u8) {
      return 0;
    }
    return 1;
...
export function driver_pipeline_no_large_stack_env(): i32 {
  unsafe {
    let e: *u8 = link_abi_getenv("SHUX_PIPELINE_NO_LARGE_STACK");
    if (e == 0 as *u8) {
      return 0;
    }
    if (e[0] == 0) {
...
/** Exported function `driver_parse_u32_cstr`.
...
// driver_argv_is_D_inline: see function docblock below.
...
// driver_argv_is_value_skip_flag: see function docblock below.
...
// driver_cstr_contains_bytes: see function docblock below.
