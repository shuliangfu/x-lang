/**
 * pipeline_gen.c 调用 typeck_typeck_sx_ast*；typeck_gen.c 导出 typeck_sx_ast*。
 * 链接期别名，避免重编不同命名约定的 pipeline_sx.o。
 */
#include <stdint.h>
...
extern int32_t typeck_sx_ast(struct ast_Module *module, struct ast_ASTArena *arena,
                             struct ast_PipelineDepCtx *ctx);
extern int32_t typeck_sx_ast_library(struct ast_Module *module, struct ast_ASTArena *arena,
                                     struct ast_PipelineDepCtx *ctx);
...
int32_t typeck_typeck_sx_ast(struct ast_Module *module, struct ast_ASTArena *arena,
                             struct ast_PipelineDepCtx *ctx) {
  return typeck_sx_ast(module, arena, ctx);
}

int32_t typeck_typeck_sx_ast_library(struct ast_Module *module, struct ast_ASTArena *arena,
                                     struct ast_PipelineDepCtx *ctx) {
