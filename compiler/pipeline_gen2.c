...
extern int32_t  pipeline_block_append_region(struct ast_ASTArena *a, int32_t br, uint8_t *label, int32_t label_len,
                                         int32_t body_ref);
extern int32_t  pipeline_block_append_unsafe(struct ast_ASTArena *a, int32_t br, int32_t body_ref);
extern int32_t  pipeline_block_append_with_arena(struct ast_ASTArena *a, int32_t br, int32_t cap_ref, int32_t body_ref);
...
extern void  pipeline_block_stmt_order_fix_prefix_lets(struct ast_ASTArena *a, int32_t br, int32_t prefix_n);
extern void  pipeline_block_with_arena_fixup_stmt_order(struct ast_ASTArena *a, int32_t br);
...
int32_t pipeline_run_sx_pipeline_typecheck_after_load(struct ast_Module * module, struct ast_ASTArena * arena, struct ast_PipelineDepCtx * ctx) {
  return run_sx_pipeline_typecheck_after_load_c(module, arena, ctx);
}
int32_t pipeline_run_sx_pipeline_typecheck_entry(struct ast_Module * module, struct ast_ASTArena * arena, struct ast_PipelineDepCtx * ctx) {
  (void)(({ int32_t __tmp = 0; if (module == ((struct ast_Module *)(0)) || arena == ((struct ast_ASTArena *)(0)) || ctx == ((struct ast_PipelineDepCtx *)(0))) {   return (-1);
 } else (__tmp = 0) ; __tmp; }));
