...
```text
./xbuild compiler-all  →  scripts/compiler_all_ci.sh  →  make xlang (g05 product · wave786 B7D) + xlang-c (seed · wave784 B6; heat B7A residual · cold residual_make=0 wave787 · catalog shell wave788)
```
...
| Leaf `.o` pattern rules (R1–R5) | **named inventory wave746** · … · **B7D TARGET→g05 wave786** · **B7A cold residual_make=0 wave787** · **B7B shell catalog wave788** · residual heat B7A + physical delete after Windows → 11.3.1 |
