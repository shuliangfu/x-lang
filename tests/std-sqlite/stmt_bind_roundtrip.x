...
function main(): i32 {
  ...
  if (sqlite.bind(ins, 1, 10) != 0 || sqlite.bind(ins, 2, &alice[0]) != 0) {
    sqlite.finalize(ins);
    sqlite.close(c);
    return 4;
  }
  ...
  if (sqlite.reset(ins) != 0) {
    sqlite.finalize(ins);
    sqlite.close(c);
    return 6;
  }
  if (sqlite.bind(ins, 1, 20) != 0 || sqlite.bind(ins, 2, &bob[0]) != 0) {
    sqlite.finalize(ins);
    sqlite.close(c);
    return 7;
  }
  ...
  if (sqlite.reset(sel) != 0 || sqlite.bind(sel, 1, 20) != 0) {
    sqlite.close(c);
    return 14;
  }
  st = sqlite.step(sel);
