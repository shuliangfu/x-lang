...
# observational std-math-special / leftover nested observational
# std-math-fenv; refuse leftover ignore of explicit-bad). leftover nested
# product path stay.
...
# leftover nested ensure / leftover nested observational
# std-math-special / leftover nested observational std-math-fenv
...
# observational std-math-special / observational std-math-fenv).
# PLATFORM: SHARED — product path honesty; Ubuntu gold still required.
if [ -n "${XLANG:-}" ]; then
