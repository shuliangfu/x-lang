#!/usr/bin/env bash
# STD-150: std.sort complex key comparator gate — honesty soft auto-make →硬绿.
#
...
# auto-make / prefer-c / soft ensure rebuild). Product key_stable.x -o exit0 =
# hard run. check / host-C archaeology = obs. Report: run=/obs=/skip=.
