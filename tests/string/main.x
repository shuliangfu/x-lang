...
function main(): i32 {
  ...
  if (string.string_starts_with(h, &bad_pref[0], 2) != 0) { return 15; }
  let suf: u8[2] = [100, 101];
  if (string.string_ends_with(h, &suf[0], 2) != 1) { return 16; }
  if (string.string_ends_with(h, &bad_pref[0], 2) != 0) { return 17; }
  
  let sub: u8[2] = [98, 99];
  if (string.string_find_slice(h, &sub[0], 2) != 1) { return 18; }
  if (string.string_contains(h, &sub[0], 2) != 1) { return 19; }
  let no: u8[2] = [122, 122];
  ...
  if (string.string_view_eq(v, v3) != 0) { return 26; }
  ...
  let out_zero: u8[1] = [0];
  let c0: i32 = string.string_copy_to(s2, &out_zero[0], 1);
  if (c0 != 0) { return 30; }
  
  if (string.string_capacity() != 256) { return 2; }
  return 0;
}
