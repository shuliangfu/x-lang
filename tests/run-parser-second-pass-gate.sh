...
# 与 build_xlang_asm compile_x 一致（须在 compiler/ 目录下执行）。
...
STRETCH_FAIL=${XLANG_PARSER_SECOND_PASS_STRETCH_FAIL:-0}
...
BASELINE_FAIL=${XLANG_PARSER_SECOND_PASS_BASELINE_FAIL:-0}
