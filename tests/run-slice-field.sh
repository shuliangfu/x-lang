#!/usr/bin/env bash
# slice field smoke: data_field exit 0; main s[1] exit 20
#
...
PREFIX="${XLANG_SLICE_FIELD_PREFIX:-xlang: [SLICE-FIELD]}"
...
echo "=== slice-field gate (prefer asm; hard) ==="
