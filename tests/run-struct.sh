...
$SHU tests/boundary/struct_get_field_inline.su -o /tmp/shu_struct_get_field_inline 2>&1
...
$SHU tests/boundary/struct_mk_field_inline.su -o /tmp/shu_struct_mk_field_inline 2>&1
...
$SHU tests/boundary/struct_mk_pair_sum_inline.su -o /tmp/shu_struct_mk_pair_sum_inline 2>&1
...
$SHU tests/boundary/struct_mk_let_inline.su -o /tmp/shu_struct_mk_let_inline 2>&1
...
$SHU tests/boundary/struct_mk_while_let_inline.su -o /tmp/shu_struct_mk_while_let_inline 2>&1
...
$SHU tests/boundary/while_if_nested_let.su -o /tmp/shu_while_if_nested_let 2>&1
