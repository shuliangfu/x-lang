...
$LINK_SHUX tests/struct/simple.sx -o /tmp/shux_struct_simple 2>&1
...
$LINK_SHUX tests/struct/padding_allow.sx -o /tmp/shux_struct_pad 2>&1
...
$LINK_SHUX tests/memory-contract/packed_struct.sx -o /tmp/shux_struct_packed 2>&1
...
$LINK_SHUX tests/boundary/struct_add_pair_inline.sx -o /tmp/shux_struct_add_pair_inline 2>&1
...
$LINK_SHUX tests/boundary/struct_get_field_inline.sx -o /tmp/shux_struct_get_field_inline 2>&1
...
$LINK_SHUX tests/boundary/struct_mk_field_inline.sx -o /tmp/shux_struct_mk_field_inline 2>&1
...
$LINK_SHUX tests/boundary/struct_mk_pair_sum_inline.sx -o /tmp/shux_struct_mk_pair_sum_inline 2>&1
...
$LINK_SHUX tests/boundary/struct_mk_let_inline.sx -o /tmp/shux_struct_mk_let_inline 2>&1
...
$LINK_SHUX tests/boundary/struct_mk_while_let_inline.sx -o /tmp/shux_struct_mk_while_let_inline 2>&1
...
$LINK_SHUX tests/boundary/while_if_nested_let.sx -o /tmp/shux_while_if_nested_let 2>&1
