...
[ -f compiler/src/asm/runtime_kv_mmap_glue.inc ] || die "missing kv_mmap_glue.c"
...
grep -q 'shu_kv_mmap_file_c' compiler/src/asm/runtime_kv_mmap_glue.inc || die "glue missing mmap"
