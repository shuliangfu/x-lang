...
ALL_FROM_X="
  -DSHUX_RT_CONTENT_FROM_X -DSHUX_RT_UTIL_FROM_X -DSHUX_RT_ARGV_FROM_X
  -DSHUX_RT_EMIT_FLAGS_FROM_X -DSHUX_RT_PREAMBLE_FROM_X -DSHUX_RT_COMPILE_FROM_X
  -DSHUX_RT_RUN_EXEC_FROM_X -DSHUX_RT_ASM_STUB_FROM_X -DSHUX_RT_ENTRY_FROM_X
  -DSHUX_RT_DIAG_ERRNO_FROM_X -DSHUX_RT_EMIT_STATE_FROM_X -DSHUX_RT_PIPELINE_ELF_DIAG_FROM_X
  -DSHUX_RT_LIB_ROOT_FROM_X -DSHUX_RT_PARSE_DIAG_FROM_X -DSHUX_RT_FS_OPEN_FROM_X
  -DSHUX_RT_ARENA_BUF_FROM_X -DSHUX_RT_FMT_ONE_FROM_X -DSHUX_RT_DISPATCH_THIN_FROM_X
  -DSHUX_RT_DISPATCH_IMPL_FROM_X -DSHUX_RT_RUN_X_EMIT_FROM_X -DSHUX_RT_RUN_ASM_BACKEND_FROM_X
  -DSHUX_RT_RUN_COMPILER_PARSED_FROM_X -DSHUX_RT_STACK_FROM_X
"
