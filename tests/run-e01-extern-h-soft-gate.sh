...
LSP_EXTERN_C="compiler/src/runtime_driver_strict_glue_stubs.c"
...
# 独立 .h 已软删除（内容在 runtime_driver_strict_glue_stubs.c）。
...
grep -q 'lsp_io_extern_block' "$LSP_EXTERN_C" || die "runtime_driver_strict_glue_stubs.c missing lsp_io_extern_block"
grep -q 'lsp_gen_extern_block' "$LSP_EXTERN_C" || die "runtime_driver_strict_glue_stubs.c missing lsp_gen_extern_block"

echo "e01 extern-h soft-retire gate OK (embedded in runtime_driver_strict_glue_stubs.c; C-04 -E-extern)"
