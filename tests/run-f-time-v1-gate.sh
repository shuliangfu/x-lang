...
# std-time; refuse leftover ignore of explicit-bad). leftover nested
# product path stay.
...
xlang_compiler_make ../std/time/time.o >/dev/null 2>&1 \
  || die "ensure time.o failed (xlang_compiler_make; prefer asm)"
ENSURE_OK=1
