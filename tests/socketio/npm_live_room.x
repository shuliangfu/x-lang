...
function main(): i32 {
  ...
  let ev: u8[16] = [114, 111, 111, 109, 95, 112, 105, 110, 103, 0];
  let data: u8[4] = [120, 0];
  let url: u8[128] = [];
  let out_ev: u8[16] = [];
  let out_data: u8[16] = [];
