...
SOA_SRC="tests/bench/dod_soa_sum_x.x"
AOS_SRC="tests/bench/dod_aos_sum_x.x"
F32_SOA_SRC="tests/bench/dod_f32_soa_sum_x.x"
F32_AOS_SRC="tests/bench/dod_f32_aos_sum_x.x"
