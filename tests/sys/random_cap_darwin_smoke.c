/**
 * tests/sys/random_cap_darwin_smoke.c — Darwin Cap random probe (9.1.6).
 *
 * Verifies xlang_random_fill_bytes without libc getentropy on Darwin:
 ...
 *
 * PLATFORM: MACOS|DARWIN Cap (9.1.6).
 */
#include <stdint.h>
#include <stddef.h>
#include <string.h>
