...
function main(): i32 {
  ...
  if (resp.header_end != 38) { return 5; }
  if (resp.body_len != 4) { return 6; }
  ...
  if (got >= 0) {
    if (resp.status < 100 || resp.status > 599) { return 11; }
  }
  ...
  if (http.hpack_huffman_smoke() != 0) { return 13; }
  if (http.flow_control_smoke() != 0) { return 14; }
  if (http.hpack_huffman_is_available() == false) { return 15; }
