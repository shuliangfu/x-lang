...
VSIX="${VSCODE_DIR}/vscode-xlang-${EXPECTED_VER}.vsix"
...
npx --yes @vscode/vsce package --allow-missing-repository --out "vscode-xlang-${EXPECTED_VER}.vsix"

if [ ! -f "vscode-xlang-${EXPECTED_VER}.vsix" ]; then
