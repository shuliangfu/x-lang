...
run_one tests/asm/assign_index_var_to_var.x /tmp/xlang_asm_assign_index_var_to_var 15
run_one tests/asm/assign_index_lit_to_var.x /tmp/xlang_asm_assign_index_lit_to_var 15
