...
DOC="${SHU_PLAN005_DOC:-analysis/phase3-roadmap-wave5-v1.md}"
MANIFEST="${SHU_PLAN005_TSV:-tests/baseline/phase3-roadmap-wave5.tsv}"
NEXT_MD="NEXT.md"
...
for kw in Phase 3 BOOT-024 COMP-018 STD-066 SHU_PLAN005; do
