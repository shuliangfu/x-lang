...
$SHUX tests/asm/binop_div_index_binop.x -o /tmp/shux_asm_div_index_binop 2>&1
exitcode=0
...
$SHUX tests/asm/binop_div_binop_index.x -o /tmp/shux_asm_div_binop_index 2>&1
exitcode=0
...
$SHUX tests/asm/assign_index_block_seq.x -o /tmp/shux_asm_assign_index_block 2>&1
exitcode=0
