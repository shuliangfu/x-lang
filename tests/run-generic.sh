...
GENERIC_OUT="${TMPDIR:-/tmp}/xlang_generic"

$LINK_XLANG build -L . tests/generic/main.x -o "$GENERIC_OUT" 2>&1
exitcode=0
...
GENERIC_ERR=$("$LINK_XLANG" -L . tests/generic/wrong_type_args.x -o "${TMPDIR:-/tmp}/xlang_generic_wrong" 2>&1 || true)
