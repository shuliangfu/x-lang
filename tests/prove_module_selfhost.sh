...
MODULES=(
  ...
  #   rest FROM_X 无 pure-dup flag_slot/path-len/format/set_at/os_lit/begin/end/flush/now_sec/call_fn/setrlimit/uname _impl；
  # Cap residual：pthread/path-read IO/debug_pipe
