...
MODULES=(
  ...
  #  lib path slots + full try_append + full argv_append）：
  ...
  #  user_ignore_at / lib_buf_at/store）；
  # rest FROM_X 无 pure-dup _impl；Cap residual：walk/stat/file_list ptrs/store/clear/one_file_body
