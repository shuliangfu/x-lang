...
MODULES=(
  ...
  # labi_path_pure R2 full：.x 吃满 23 公共门闩 + count（wave116 try_under + wave146–151 + wave160 compiler_o_path_copy + wave162 repo_root + wave163–166 path ladders + wave180 scheduler_o_for_task_link）；
