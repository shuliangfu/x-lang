...
MODULES=(
  ...
  # labi_freestanding_list R2 full：.x 吃满 env/io_sym/panic/ensure + wave117 heap/nostdlib + wave136 gen needs_fs/time/random/runtime + wave137 compress zlib/zstd/brotli + wave138 core_slice/db_kv/db_arrow 纯表+orch；
