...
MODULES=(
  ...
  # labi_ondemand_list R2 full：.x 吃满 simple/kv/arrow/time/queue + rel_* + wave118–125 needs_std_net/set/map/queue/test + needs_core_mem/slice + needs_std_heap_page_mmap 纯表+orch；
