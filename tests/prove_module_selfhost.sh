...
MODULES=(
  ...
  # labi_path_pure R2 full：.x 吃满 20 公共门闩 + count（wave116 try_under + wave146–151 + wave160 compiler_o_path_copy + wave162 repo_root + wave163 panic_o_path + wave164 crt0_user_o_path）；
