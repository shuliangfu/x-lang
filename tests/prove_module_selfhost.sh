...
MODULES=(
  ...
  # rt_emit_state: the .x is the sole body of the five setters (w845 deleted
  # the C twins). The seed keeps BSS, lib-name, the entry-prefix setter, and
  # the slice marker. No full C fallback. Slot API is in driver_abi.
