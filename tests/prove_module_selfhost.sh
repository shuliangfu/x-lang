...
MODULES=(
  ...
  #  driver_run_compiler_check full orch）：
  ...
  #  user_ignore_at / lib_buf_at/store / file_list_at/store/clear / run_compiler_check）；
  # rest FROM_X 无 pure-dup _impl；Cap residual：walk/stat/one_file_body/run_fmt
