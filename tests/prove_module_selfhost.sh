...
MODULES=(
  ...
  # diagnostic R2 thin + Cap residual pure 深迁：thin.x 公共门闩 + 固定措辞 typeck 10 + pipe orch 4 pure 真体；
  # rest SHUX_L2_RDD_THIN_FROM_X：无 thin 公共体、无 pure-dup _impl；Cap residual snprintf/va_list/debug 在 full seed rest
