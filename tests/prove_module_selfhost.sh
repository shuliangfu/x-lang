...
MODULES=(
  ...
  # labi_path_pure R2 full：.x 吃满 12 公共门闩 + count（wave116 try_under + wave146 argv_has_obj + wave147 push_stable）；
  # 产品 rest 在 FROM_X 下业务 H=0（仅 marker）；Cap residual：Windows #if sep 在 mega 冷路径；bank_push Cap
