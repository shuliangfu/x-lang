...
MODULES=(
  ...
  #   rest FROM_X 无 pure-dup flag_slot/path-len/format/set_at/os_lit/begin/end/flush/now_sec/call_fn/setrlimit/uname/path_read _impl；
  # Cap residual：pthread create / debug_pipe
