...
MODULES=(
  ...
  # labi_invoke_cc_list R2 full：.x 吃满 harden/skip-native/icc rel 纯表 + wave155 harden orch + wave198 early_needs + wave199 std need scan + wave200 ensure-push front
