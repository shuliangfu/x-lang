...
MODULES=(
  ...
  # labi_path_io R2 full：.x 吃满 4 公共门闩 + count（wave209 + path_readable）；
  # 产品 rest 在 FROM_X 下业务 H=0（仅 marker）；Cap residual：stat/realpath/access _impl 在 mega rest
