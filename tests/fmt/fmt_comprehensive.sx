// fmt 综合回归：注释、块注释、分号链、空格链、超长无断点标识符、嵌套块。
// 本文件由 tests/run-fmt-wrap.sh 复制后执行 fmt，再经 scan_fmt_damage / check 校验。

// 超长单行注释：formatter 不得折断且不得丢失 // 前缀；若折行则每行必须以 // 开头。
// Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.

/**
* 多行块注释第一行故意写得很长，用来验证星号续行不会被 fmt 折成丢失 * 的普通代码行。
* 第二行正常较短。
*/
