...
DOC="${SHU_PLAN007_DOC:-analysis/phase3-roadmap-wave7-v1.md}"
MANIFEST="${SHU_PLAN007_TSV:-tests/baseline/phase3-roadmap-wave7.tsv}"
NEXT_MD="NEXT.md"
...
for kw in Phase 3 BOOT-026 COMP-020 STD-068 SHU_PLAN007; do
