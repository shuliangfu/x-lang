...
# static / leftover nested std-elf-parse; refuse leftover ignore of
# explicit-bad). leftover auto-make of elf.o (`xlang_compiler_make`
...
# leftover nested std-elf-parse (refuse leftover SKIP→OK / leftover
...
if [ ! -f std/elf/elf.o ]; then
  die "missing std/elf/elf.o (refuse leftover auto-make)"
fi
ENSURE_OK=1
