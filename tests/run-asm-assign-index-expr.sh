...
$SHUX build tests/asm/assign_index_var_plus_lit.x -o /tmp/shux_asm_assign_index_var_plus_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/binop_index_add_chain.x -o /tmp/shux_asm_binop_index_add_chain 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_plus_var.x -o /tmp/shux_asm_assign_index_var_plus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_plus_var_copy.x -o /tmp/shux_asm_assign_index_var_plus_var_copy 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_lit.x -o /tmp/shux_asm_assign_index_var_minus_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_var.x -o /tmp/shux_asm_assign_index_var_minus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_mul_lit.x -o /tmp/shux_asm_assign_index_var_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_lit_mul_var.x -o /tmp/shux_asm_assign_index_lit_mul_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_var_plus_var.x -o /tmp/shux_asm_assign_index_var_minus_var_plus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_minus_var_plus_var.x -o /tmp/shux_asm_assign_read_index_var_minus_var_plus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_var_minus_var.x -o /tmp/shux_asm_assign_index_var_minus_var_minus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_add3.x -o /tmp/shux_asm_assign_index_var_minus_add3 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_var_mul_lit.x -o /tmp/shux_asm_assign_index_var_minus_var_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_minus_add3.x -o /tmp/shux_asm_assign_read_index_var_minus_add3 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_plus_paren_var_plus_var.x -o /tmp/shux_asm_assign_index_var_plus_paren_var_plus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_add3_mul_lit.x -o /tmp/shux_asm_assign_index_var_add3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_plus_var_plus_var.x -o /tmp/shux_asm_assign_index_var_plus_var_plus_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_plus_var_mul_lit.x -o /tmp/shux_asm_assign_index_var_plus_var_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_mul_var.x -o /tmp/shux_asm_assign_index_var_mul_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_mul_lit.x -o /tmp/shux_asm_assign_read_index_var_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_mul_var.x -o /tmp/shux_asm_assign_read_index_var_mul_var 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_plus_var_mul_lit.x -o /tmp/shux_asm_assign_read_index_var_plus_var_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_add3_mul_lit.x -o /tmp/shux_asm_assign_read_index_var_add3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_subadd3_mul_lit.x -o /tmp/shux_asm_assign_index_var_subadd3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_subadd3_mul_lit.x -o /tmp/shux_asm_assign_read_index_var_subadd3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_subsub3_mul_lit.x -o /tmp/shux_asm_assign_index_var_subsub3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_subsub3_mul_lit.x -o /tmp/shux_asm_assign_read_index_var_subsub3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_index_var_minus_add3_mul_lit.x -o /tmp/shux_asm_assign_index_var_minus_add3_mul_lit 2>&1
exitcode=0
...
$SHUX build tests/asm/assign_read_index_var_minus_add3_mul_lit.x -o /tmp/shux_asm_assign_read_index_var_minus_add3_mul_lit 2>&1
exitcode=0
