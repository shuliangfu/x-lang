...
xlang_compiler_make ../std/crypto/crypto.o runtime_ed25519_ref10_glue.o runtime_crypto_inc_glue.o >/dev/null 2>&1 || die "ensure crypto.o failed (xlang_compiler_make)"
