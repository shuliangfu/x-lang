 ...
 *
 * submit + suspend 后调用 xlang_io_poll_async_completions（Linux io_uring 路径）或
...
int main(void) {
    ...
    if (xlang_async_task_submit(io_read_task) != 0) {
    ...
    polled = xlang_io_poll_async_completions(500);
