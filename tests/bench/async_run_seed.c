...
extern void shux_async_run_seed_push_u32(uint32_t v);
extern void shux_async_run_seed_push_i64(int64_t v);
extern void shux_async_run_seed_push_usize(size_t v);
extern void shux_async_run_seed_set_i32(int32_t v);
extern int shux_async_run_seed_valid(void);
extern int32_t shux_async_run_seed_take_i32(void);
extern uint32_t shux_async_run_seed_take_u32(void);
extern int64_t shux_async_run_seed_take_i64(void);
extern size_t shux_async_run_seed_take_usize(void);
...
int main(void) {
    ...
    if (shux_async_run_seed_valid() != 0) {
        fprintf(stderr, "async_run_seed: valid before set\n");
        return 1;
    }
    shux_async_run_seed_set_i32(42);
    if (shux_async_run_seed_valid() != 1) {
        fprintf(stderr, "async_run_seed: valid after set\n");
        return 2;
    }
    if (shux_async_run_seed_take_i32() != 42) {
    ...
    shux_async_run_seed_push_i32(10);
    shux_async_run_seed_push_i32(32);
    if (shux_async_run_seed_valid() != 1) {
        fprintf(stderr, "async_run_seed: valid after dual push\n");
        return 5;
    }
    if (shux_async_run_seed_take_i32() != 10) {
    ...
    if (shux_async_run_seed_take_i32() != 32) {
    ...
    shux_async_run_seed_reset();
    shux_async_run_seed_push_u32(42u);
    if (shux_async_run_seed_take_u32() != 42u) {
        fprintf(stderr, "async_run_seed: take u32 mismatch\n");
        return 11;
    }

    shux_async_run_seed_reset();
    shux_async_run_seed_push_i64(10000000000LL);
    if (shux_async_run_seed_take_i64() != 10000000000LL) {
        fprintf(stderr, "async_run_seed: take i64 mismatch\n");
        return 12;
    }

    shux_async_run_seed_reset();
    shux_async_run_seed_push_usize((size_t)0xABCDEF01u);
    if (shux_async_run_seed_take_usize() != (size_t)0xABCDEF01u) {
