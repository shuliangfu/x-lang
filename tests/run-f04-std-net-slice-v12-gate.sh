...
#        XLANG=./compiler/xlang_asm ./tests/run-f04-std-net-slice-v12-gate.sh
...
# static / nested v11; refuse leftover ignore of explicit-bad). leftover
...
# nested v11 (refuse leftover SKIP→OK / leftover ignore of explicit-bad /
