...
# inventory / nested run-std-compress; refuse leftover ignore of
# explicit-bad). leftover nested product path (inventory / STD-007
# compress) stay. G.7: complete existing resolve_shu; converge
# dod_native_exe.
...
# nested run-std-compress (refuse leftover SKIP→OK / leftover ignore of
