...
if ! cc -O2 -Icompiler/src/asm/http tests/bench/http_bench_server.c compiler/src/asm/http/runtime_http_glue.c -o "$SERVER_BIN" 2>/tmp/http_bench_server_build.log; then
