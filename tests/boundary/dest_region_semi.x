...
// (isolate dest_reg_nosemi). Gate lives here so dest-park leftover is
// not this leaf. Leftover codes stay in 1..255.
// Expected exit 0.
// PLATFORM: SHARED dest extra-arm region compound ASI.
...
/**
 * Gate dest extra-arm `region label { … }; dest` optional compound ASI.
