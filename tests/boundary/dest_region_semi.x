...
// leftover 112+ lives in dest_fromreg_mid_semi.x — stacking
// it here blows Ubuntu dest-park (asm 139). Gate lives
// here so dest-park leftover is not this leaf. Leftover
// codes stay in 1..255.
// Expected exit 0.
 ...
 * dest-from-region intermediate leftover 112+ is
 * dest_fromreg_mid_semi.x (this main Ubuntu dest-park 139).
