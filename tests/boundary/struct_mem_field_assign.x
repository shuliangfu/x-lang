...
function main(): i32 {
  ...
  let hlit: Holder32 = { s: { a: 0, b: 0, c: 0, d: 0 } };
  hlit.s = { a: 1, b: 2, c: 3, d: 4 };
  ...
  let hpc: Prefixed = { tag: 7, s: { a: 0, b: 0, c: 0, d: 0 } };
  hpc.s = id32(q);
