...
MATRIX="${XLANG_BOOT_CROSSPLATFORM_TSV:-tests/baseline/bootstrap-crossplatform-matrix.tsv}"
CI_MATRIX="${XLANG_CI_PLATFORM_MATRIX:-tests/baseline/ci-platform-matrix.tsv}"
MIN_LINUX_MUST=4
MIN_MACOS_MUST=3
MIN_MANIFEST=4
