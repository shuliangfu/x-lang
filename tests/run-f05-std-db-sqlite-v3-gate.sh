...
[ -f compiler/src/asm/runtime_sqlite_glue.inc ] || die "missing sqlite_glue.c"
...
grep -q 'shu_sqlite3_open_c' compiler/src/asm/runtime_sqlite_glue.inc || die "glue missing open"
grep -q 'shu_db_use_sqlite3_c' compiler/src/asm/runtime_sqlite_glue.inc || die "glue missing use probe"
