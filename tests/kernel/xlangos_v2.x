// XlangOS v2 — comprehensive kernel integrating all OS features.
...
function kmain(): i32 {
  ...
  // VGA banner
  let banner: u8[8] = [83, 104, 117, 120, 79, 83, 50, 0];  // "XlangOS2"
  vga_print_str((&banner[0]) as u32, 11);
  
  // Serial banner
  kputchar(83); kputchar(104); kputchar(117); kputchar(120);  // Xlang
