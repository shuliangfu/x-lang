...
$LINK_SHUX tests/return-expr/explicit.sx -o /tmp/shux_return_explicit 2>&1
exitcode=0
...
# err=$(./compiler/shux tests/return-expr/return_type_mismatch.sx -o /tmp/shux_return_fail 2>&1) || true
