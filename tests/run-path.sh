...
$SHUX build -L . tests/path/extension_stem_abs_clean.x -o /tmp/shux_path_ext 2>&1
...
$SHUX build -L . tests/path/resolve.x -o /tmp/shux_path_resolve 2>&1
...
$SHUX build -L . tests/path/extreme_clean.x -o /tmp/shux_path_extreme 2>&1
