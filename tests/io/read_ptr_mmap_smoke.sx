...
function main(): i32 {
  ...
  let payload: u8[12] = [90, 67, 50, 109, 109, 97, 112, 116, 101, 115, 116, 10];
  ...
  let g: u64 = io.ptr_gen();
  if (io.ptr_valid(g) != 1) {
    fs.close(fd_r);
    return 8;
  }
  let backend: i32 = io.ptr_backend();
