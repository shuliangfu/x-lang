...
$SHU -L . tests/string/compare_append_find.su -o "${TMPDIR:-/tmp}/shu_string_caf" 2>&1
...
$SHU -L . tests/string/contains_trim_replace.su -o "${TMPDIR:-/tmp}/shu_string_ctr" 2>&1
...
$SHU -L . tests/string/view_zerocopy.su -o "${TMPDIR:-/tmp}/shu_string_view" 2>&1
