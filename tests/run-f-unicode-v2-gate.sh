...
grep -q 'unicode_category_c' std/unicode/unicode.x || die "unicode.x missing category"
grep -q 'unicode_nfc_buf_c' std/unicode/unicode.x || die "unicode.x missing nfc"
