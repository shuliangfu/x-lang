...
[ -f compiler/src/asm/runtime_arrow_simd_glue.inc ] || die "missing arrow_simd_glue.c"
...
grep -q 'arrow_column_f32_sum_c' compiler/src/asm/runtime_arrow_simd_glue.inc || die "glue missing f32 sum"
