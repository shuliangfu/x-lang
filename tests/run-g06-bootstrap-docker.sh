...
LOG="${XLANG_G06_BOOTSTRAP_LOG:-/tmp/xlang-g06-bootstrap.log}"
...
copy_seed seeds/bootstrap_xlangc.linux.x86_64 bootstrap_xlangc
copy_seed seeds/bootstrap_xlangc.linux.x86_64 xlang-c
chmod +x bootstrap_xlangc xlang-c
