...
neg=$("$TYPECK_SHUX" check tests/typeck/linear/double_move.sx 2>&1) || true
...
neg_call=$("$TYPECK_SHUX" check tests/typeck/linear/call_double.sx 2>&1) || true
...
neg_addr=$("$TYPECK_SHUX" check tests/typeck/linear/addr_of.sx 2>&1) || true
...
neg_ret=$("$TYPECK_SHUX" check tests/typeck/linear/return_branch.sx 2>&1) || true
