...
[ -f compiler/src/asm/runtime_backtrace_platform.inc ] || die "missing runtime_backtrace_platform.inc"
...
grep -q 'backtrace_capture_c' compiler/src/asm/runtime_backtrace_platform.inc || die "runtime missing capture"
grep -q 'backtrace_gold_anchor_c' compiler/src/asm/runtime_backtrace_platform.inc || die "runtime missing anchor"
