...
# 含 import 的 .sx 须在 shux_asm -backend asm -o 下产出非空 .o（修复前 typeck_entry SIGSEGV）。
set -e
cd "$(dirname "$0")/.."
...
wpo_s3_try_asm_o smoke tests/wpo/stack_promote_smoke.sx
wpo_s3_try_asm_o dead_user tests/wpo/dead_user.sx
wpo_s3_try_asm_o cross_i32 tests/wpo/stack_promote_cross_i32.sx
wpo_s3_try_asm_o cross_ret tests/wpo/stack_promote_cross_ret.sx
wpo_s3_try_asm_o escape_cross tests/wpo/stack_promote_escape_cross.sx
wpo_s3_try_asm_o cross_full tests/wpo/stack_promote_cross.sx
