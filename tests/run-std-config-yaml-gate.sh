#!/usr/bin/env bash
# STD-119: std.config YAML optional backend gate — honesty leftover unused compiler-make →硬绿.
#
...
# yaml_smoke.x -o exit0 = hard run (run=1). check / host-C archaeology = obs.
