...
# 测试 1+2 -> 退出码 3
$LINK_SHUX tests/binary-expr/main.sx -o /tmp/shux_binary_expr 2>&1
exitcode=0
...
# 测试 42-10 -> 退出码 32
$LINK_SHUX tests/binary-expr/sub.sx -o /tmp/shux_binary_sub 2>&1
exitcode=0
...
# 测试 6*7 -> 退出码 42
$LINK_SHUX tests/binary-expr/mul.sx -o /tmp/shux_binary_mul 2>&1
exitcode=0
...
# 测试 20/4 -> 退出码 5
$LINK_SHUX tests/binary-expr/div.sx -o /tmp/shux_binary_div 2>&1
exitcode=0
...
$LINK_SHUX tests/binary-expr/precedence.sx -o /tmp/shux_binary_prec 2>&1
exitcode=0
...
# 测试括号：(1+2)*3 = 9
$LINK_SHUX tests/binary-expr/paren.sx -o /tmp/shux_binary_paren 2>&1
exitcode=0
...
# 测试一元负号：10 + -4 = 6
$LINK_SHUX tests/binary-expr/unary_neg.sx -o /tmp/shux_binary_neg 2>&1
exitcode=0
