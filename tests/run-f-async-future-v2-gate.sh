...
# static / leftover nested std-async-future; refuse leftover ignore of
# explicit-bad). leftover auto-make of future.o (`xlang_compiler_make`
...
# leftover nested std-async-future (refuse leftover SKIP→OK / leftover
...
if [ ! -f std/async/future.o ]; then
  die "missing std/async/future.o (refuse leftover auto-make)"
fi
ENSURE_OK=1
