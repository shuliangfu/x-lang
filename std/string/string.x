...
/** Exported function `xlang_string_portable_memmem`.
 * Implements `xlang_string_portable_memmem`.
 * @param hay *u8
 * @param hay_len i32
 * @param needle *u8
 ...
 * @return i32
 */
export function xlang_string_portable_memmem(hay: *u8, hay_len: i32, needle: *u8, needle_len: i32): i32 {
  let i: i32 = 0;
  let j: i32 = 0;
  let ok: i32 = 0;
...
export function xlang_string_memmem_c(hay: *u8, hay_len: i32, needle: *u8, needle_len: i32): i32 {
  ...
  return xlang_string_portable_memmem(hay, hay_len, needle, needle_len);
}
