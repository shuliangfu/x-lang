...
/** Exported function `crypto_chacha_aead_marker_c`.
 * Implements `crypto_chacha_aead_marker_c`.
 * @return i32
 */
...
/** Exported function `crypto_chacha20_poly1305_smoke_c`.
 * Implements `crypto_chacha20_poly1305_smoke_c`.
 * @return i32
 */
