...
/** Exported function `crypto_ed25519_public_from_seed_c`.
 * Implements `crypto_ed25519_public_from_seed_c`.
 * @param seed *u8
 * @param pub *u8
 * @return void
 */
...
/** Exported function `crypto_ed25519_smoke_c`.
 * Implements `crypto_ed25519_smoke_c`.
 * @return i32
 */
