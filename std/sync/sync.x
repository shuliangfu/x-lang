...
const SYNC_LOCK_DIAG_ERR_RECURSIVE: i32 = -1;
const SYNC_LOCK_DIAG_ERR_ORDER: i32 = -2;
const SYNC_LOCK_DIAG_ERR_UNLOCK: i32 = -3;
const SYNC_LOCK_DIAG_ERR_TABLE: i32 = -4;
const SYNC_LOCK_DIAG_MAX_META: i32 = 64;
...
function sync_f_sync_v1_marker_c(): i32 {
  return 1;
}

/** F-sync-lock-diag v2：诊断 API 锚点标记（逻辑见 runtime TLS C）。 */
function sync_f_sync_lock_diag_v2_marker_c(): i32 {
  return 1;
}
