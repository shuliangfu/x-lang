...
export extern function db_query_rows_c(handle: i64, sql: *u8): i32;
export extern function db_query_begin_c(handle: i64, sql: *u8): i64;
export extern function db_next_row_c(cursor: i64): i32;
export extern function db_row_col_i32_c(cursor: i64, col: i32): i32;
export extern function db_row_col_text_c(cursor: i64, col: i32, out_buf: *u8, out_cap: i32): i32;
export extern function db_row_col_blob_c(cursor: i64, col: i32, out_buf: *u8, out_cap: i32): i32;
export extern function db_row_col_blob_len_c(cursor: i64, col: i32): i32;
export extern function db_row_col_blob_read_c(cursor: i64, col: i32, offset: i32, out_buf: *u8, out_cap: i32): i32;
export extern function db_query_end_c(cursor: i64): i32;
export extern function db_begin_tx_c(handle: i64): i32;
export extern function db_commit_c(handle: i64): i32;
export extern function db_rollback_c(handle: i64): i32;
export extern function db_last_code_c(): i32;
export extern function db_last_error_msg_c(): *u8;
export extern function db_backend_name_c(): *u8;
export extern function db_changes_c(handle: i64): i32;
export extern function db_prepare_c(handle: i64, sql: *u8): i64;
export extern function db_prepare_cached_c(handle: i64, sql: *u8): i64;
export extern function db_stmt_bind_i32_c(stmt: i64, idx: i32, val: i32): i32;
export extern function db_stmt_bind_text_c(stmt: i64, idx: i32, text: *u8): i32;
export extern function db_stmt_step_c(stmt: i64): i32;
export extern function db_stmt_reset_c(stmt: i64): i32;
export extern function db_stmt_finalize_c(stmt: i64): i32;
export extern function db_stmt_cache_clear_c(handle: i64): i32;
export extern function db_pool_open_c(path: *u8, max_conns: i32): i64;
export extern function db_pool_close_c(pool: i64): i32;
export extern function db_pool_acquire_c(pool: i64): i64;
export extern function db_pool_release_c(pool: i64, conn: i64): i32;
export extern function db_pool_idle_c(pool: i64): i32;
