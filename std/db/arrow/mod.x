...
/** 列类型：Int32。 */
const ARROW_I32: i32 = 1;
/** 列类型：Float32。 */
const ARROW_F32: i32 = 2;
/** 列类型：Float64。 */
const ARROW_F64: i32 = 3;

/** 列对齐字节数（与 arrow.x ARROW_ALIGN 一致）。 */
const ARROW_ALIGN_BYTES: i32 = 64;
...
function free(col: ArrowColumn): void {
...
/** 销毁 batch 及所含列。 */
function free(batch: ArrowBatch): void {
...
/** SIMD 硬件是否可用。 */
function simd_hw_available(): i32 {
