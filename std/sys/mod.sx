 ...
 */
#[cfg(target_os = "linux")]
function write(fd: i32, buf: *u8, len: i32): i32 {
  if (len <= 0) {
    return 0;
  }
  if (buf == 0) {
...
#[cfg(target_os = "linux")]
function write_stdout(buf: *u8, len: i32): i32 {
...
#[cfg(target_os = "linux")]
function write_stderr(buf: *u8, len: i32): i32 {
...
#[cfg(target_os = "linux")]
function read(fd: i32, buf: *u8, len: i32): i32 {
