...
export const MACOS_O_RDONLY: i32 = 0;

/** macOS open(2) O_RDWR。 */
export const MACOS_O_RDWR: i32 = 2;

/** macOS open(2) O_CREAT。 */
export const MACOS_O_CREAT: i32 = 512;

/** mmap(2) MAP_PRIVATE @ libSystem。 */
export const MACOS_MAP_PRIVATE: i32 = 2;

/** mmap(2) MAP_ANON @ libSystem。 */
export const MACOS_MAP_ANON: i32 = 4096;

/** mmap(2) MAP_SHARED @ libSystem。 */
export const MACOS_MAP_SHARED: i32 = 1;

/** mmap(2) PROT_READ。 */
export const MACOS_PROT_READ: i32 = 1;

/** mmap(2) PROT_WRITE。 */
export const MACOS_PROT_WRITE: i32 = 2;
