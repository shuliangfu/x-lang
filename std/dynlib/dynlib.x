...
export function dynlib_last_error_smoke_c(): i32 {
  let bad: u8[49] = [47, 110, 111, 110, 101, 120, 105, 115, 116, 101, 110, 116, 47, 120, 108, 97, 110, 103, 95, 100, 121, 110, 108, 105, 98, 95, 109, 105, 115, 115, 105, 110, 103, 46, 115, 111, 0];
  let msg: u8[128] = [];
  let lib: *u8 = 0 as *u8;
  let n: i32 = 0;
