...
export extern "C" function getsockname(fd: i32, addr: *u8, addrlen: *u32): i32;

#[cfg(not(target_os = "windows"))]
export extern "C" function getpeername(fd: i32, addr: *u8, addrlen: *u32): i32;

#[cfg(target_os = "windows")]
export extern "C" function getsockname(fd: i32, addr: *u8, addrlen: *i32): i32;

#[cfg(target_os = "windows")]
export extern "C" function getpeername(fd: i32, addr: *u8, addrlen: *i32): i32;
