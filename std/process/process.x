...
function process_args_count_c(): i32 { let _rc: i32 = 0; unsafe { _rc = process_shux_argc_get(); } return _rc; }

/** 热路径：返回第 i 个参数 C 字符串；越界或未初始化返回 0。 */
function process_arg_c(i: i32): *u8 { let _rc: *u8 = 0; unsafe { _rc = process_shux_argv_get(i); } return _rc; }
