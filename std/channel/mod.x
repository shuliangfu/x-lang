...
/** 关闭无界 channel。 */
function unbounded_close(ch: *u8): void {
  unsafe {
    channel_i32_close_c(ch);
  }
}
...
function select_max(): i32 {
  return 8;
}

/** 将 channel 句柄写入 i64 槽（64 位 LE，与 C void* 布局兼容）。 */
function select_chs_set(slots: *i64, idx: i32, ch: *u8): void {
  unsafe {
...
function select_dirs_set(dirs: *i32, idx: i32, dir: i32): void {
  unsafe {
